...
JD-TC-GetNotificationSettings_of_ConsumerByUser-1
    ...
    ${iscorp_subdomains}=  get_iscorp_subdomains  1
     ...
     ${MUSERNAME_E1}=  Evaluate  ${MUSERNAME}+9910199
    ...
    ${resp}=  Create User  ${firstname1}  ${lastname1}  ${dob1}  ${Genderlist[0]}  ${P_Email}${PUSERNAME_U1}.ynwtest@netvarth.com   ${userType[0]}  ${pin1}  ${countryCodes[0]}  ${PUSERNAME_U1}  ${dep_id}  ${sub_domain_id}  ${bool[1]}  ${NULL}  ${NULL}  ${NULL}  ${NULL} 
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-GetNotificationSettings_of_ConsumerByUser-UH6
    ...
    ${iscorp_subdomains}=  get_iscorp_subdomains  1
     ...
     ${lastname_A}=  FakerLibrary.last_name
     Set Suite Variable  ${lastname_A}
     ${MUSERNAME_E2}=  Evaluate  ${PUSERNAME}+8910198
     ${highest_package}=  get_highest_license_pkg
    ...
    ${resp}=  Create User  ${firstname1}  ${lastname1}  ${dob1}  ${Genderlist[0]}  ${P_Email}${PUSERNAME_U2}.ynwtest@netvarth.com   ${userType[0]}  ${pin2}  ${countryCodes[0]}  ${PUSERNAME_U2}  ${dep_id}  ${sub_domain_id}  ${bool[1]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
