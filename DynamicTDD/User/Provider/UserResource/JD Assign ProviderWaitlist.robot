...
JD-TC-AssignproviderWaitlist-1
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME4}+1000440000
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME4}+336245
    ${tlgnum}=  Evaluate  ${HLMUSERNAME4}+336345

    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${countryCode[1]}  ${whpnum}  ${countryCode[1]}  ${tlgnum}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME4}+1000440001
    clear_users  ${ph2}
    ...
    ${resp}=  Create User  ${firstname1}  ${lastname1}  ${dob1}  ${Genderlist[0]}  ${P_Email}${ph2}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph2}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${ph3}=  Evaluate  ${HLMUSERNAME4}+1000440003
    clear_users  ${ph3}
    ...
    ${resp}=  Create User  ${firstname2}  ${lastname2}  ${dob2}  ${Genderlist[0]}  ${P_Email}${ph3}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph3}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  ProviderLogin  ${ph1}  ${P_PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AssignproviderWaitlist-2
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440004
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
    
    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id1}  ${resp.json()}
    ${resp}=  Get User
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440005
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode

    ${resp}=  Create User  ${firstname2}  ${lastname2}  ${dob2}  ${Genderlist[0]}  ${P_Email}${ph2}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph2}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id2}  ${resp.json()}
...
JD-TC-AssignproviderWaitlist-3
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440006
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-4
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440011
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440012
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-5
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440013
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440014
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-6
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440016
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440017
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-7
    ...
    clear_queue      ${HLMUSERNAME11}
    clear_service    ${HLMUSERNAME11}
    clear_customer   ${HLMUSERNAME11}
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME11}+1000440000
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    # ${pin}=  get_pincode
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME11}+336945
    ${tlgnum}=  Evaluate  ${HLMUSERNAME11}+336845

    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id3}  ${sud_domain_id3}  ${bool[0]}  ${countryCode[1]}  ${whpnum}  ${countryCode[1]}  ${tlgnum}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id1}  ${resp.json()}
    ${resp}=  Get User
...
JD-TC-AssignproviderWaitlist-8
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME11}+1000450000
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    # ${pin}=  get_pincode
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME11}+336745
    ${tlgnum}=  Evaluate  ${HLMUSERNAME11}+336645

    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[1]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id3}  ${sud_domain_id3}  ${bool[0]}  ${countryCode[1]}  ${whpnum}  ${countryCode[1]}  ${tlgnum}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id1}  ${resp.json()}
    ${resp}=  Get User
...
JD-TC-AssignproviderWaitlist-9
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME11}+1000470000
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    # ${pin}=  get_pincode
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME11}+336245
    ${tlgnum}=  Evaluate  ${HLMUSERNAME11}+336345
...
JD-TC-AssignproviderWaitlist-10
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME11}+1000650000
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    # ${pin}=  get_pincode
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME11}+335745
    ${tlgnum}=  Evaluate  ${HLMUSERNAME11}+335645

    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[2]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id3}  ${sud_domain_id3}  ${bool[0]}  ${countryCode[1]}  ${whpnum}  ${countryCode[1]}  ${tlgnum}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id1}  ${resp.json()}
    ${resp}=  Get User
...
JD-TC-AssignproviderWaitlist-UH1
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000410011
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${pin}=  get_pincode
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000410013
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-UH3
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000441019
    clear_users  ${ph2}
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
...
JD-TC-AssignproviderWaitlist-UH4
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440118
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-UH5 
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME10}+1000440130
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${pin}=  get_pincode
    ${dob}=  FakerLibrary.Date
   
    ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCode[1]}  ${ph1}  ${dep_id1}  ${sud_domain_id1}  ${bool[0]}  ${NULL}  ${NULL}  ${NULL}  ${NULL}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440120
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
...
JD-TC-AssignproviderWaitlist-UH6
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440221
    clear_users  ${ph2}
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
...
JD-TC-AssignproviderWaitlist-UH7
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440022
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
...
JD-TC-AssignproviderWaitlist-UH9
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME11}+1000460000
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    # ${pin}=  get_pincode
    ...
    ${whpnum}=  Evaluate  ${HLMUSERNAME11}+336545
    ${tlgnum}=  Evaluate  ${HLMUSERNAME11}+336445
...
JD-TC-CreateUser -0
    ...
    clear_queue      ${MUSERNAME58}
    clear_service    ${MUSERNAME58}
    clear_customer   ${MUSERNAME58}
    ...
    FOR   ${a}  IN RANGE   10
        ...
        ${cons_num}    Random Int  min=123456   max=999999
        ${ph1}=  Evaluate  ${HLMUSERNAME2}+${cons_num}
        ...
        ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${ph1${a}}.ynwtest@netvarth.com   ${userType[0]}  ${pin}  ${countryCodes[0]}  ${ph1${a}}  ${dep_id}  ${sub_domain_id}  ${bool[0]}  ${countryCodes[0]}  ${ph1${a}}  ${countryCodes[0]}  ${ph1${a}}
        Log   ${resp.json()}
        Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-CreateUser -01
    ...
    ${resp}=  Provider Login  ${MUSERNAME66}  ${PASSWORD}
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    clear_queue      ${MUSERNAME66}
    clear_service    ${MUSERNAME66}
    clear_customer   ${MUSERNAME66}

    ${pid}=  get_acc_id  ${MUSERNAME66}
...
JD-TC-AssignproviderWaitlist-4
    ...
    ${ph1}=  Evaluate  ${HLMUSERNAME2}+1000440007
    ${firstname}=  FakerLibrary.name
    ${lastname}=  FakerLibrary.last_name
    ${address}=  get_address
    ${dob}=  FakerLibrary.Date
    ...
    ${resp}=  Create User  ${firstname}  ${lastname}  ${address}  ${ph1}  ${dob}    ${Genderlist[0]}  ${userType[0]}  ${P_Email}${ph1}.ynwtest@netvarth.com  ${location}  ${state}  ${dep_id}  ${sub_domain_id}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id1}  ${resp.json()}
    ${resp}=  Get User
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000440008
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ...
    ${resp}=  Create User  ${firstname2}  ${lastname2}  ${address2}  ${ph2}  ${dob2}  ${Genderlist[0]}  ${userType[0]}  ${P_Email}${ph2}.ynwtest@netvarth.com  ${location2}  ${state2}  ${dep_id}  ${sub_domain_id}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${u_id2}  ${resp.json()}
...
JD-TC-AssignproviderWaitlist-UH2
    ...
    ${ph2}=  Evaluate  ${HLMUSERNAME2}+1000410020
    ${firstname2}=  FakerLibrary.name
    ${lastname2}=  FakerLibrary.last_name
    ${dob2}=  FakerLibrary.Date
    ${pin}=  get_pincode
