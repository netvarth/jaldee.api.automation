...
JD-TC-AddOrderRating-1
    ...
    ${eTime3}=  add_timezone_time  ${tz}  6  00     
...
JD-TC-AddOrderRating-3
    ...
    ${resp}=   Create Order For HomeDelivery   ${cookie}   ${accId}    ${cidfor}    ${CatalogId1}   ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${CUSERNAME19}    ${email}  ${countryCodes[0]}   ${EMPTY_List}   ${item_id1}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
