...
JD-TC-GetOrderCountByCriteria-1
    ...
    Set Suite Variable  ${email_id}  ${firstname}${PUSERNAME162}.${test_mail}
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email}  ${firstname}${CUSERNAME24}.${test_mail}
...
JD-TC-GetOrderCountByCriteria-2
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME163}.${test_mail}
    ...
    ${item_quantity1}=  FakerLibrary.Random Int  min=${minQuantity}   max=${maxQuantity}
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERNAME24}.${test_mail}
