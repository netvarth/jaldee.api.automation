...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-1
    [Documentation]  Consumer get Service By LocationId and ServiceId

    ${PUSERPH0}=  Evaluate  ${PUSERNAME}+190091
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-2
    ...
    ${resp}=  Get Appmt Schedule By ServiceId and LocationId   ${accId}   ${p1_l2}  ${p1_s2}  
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response List   ${resp}   0  id=${sch_id2}   name=${schedule_name2}  apptState=${Qstate[0]}


JD-TC-Get Appmt Schedule By ServiceId and LocationId-3
    [Documentation]  Consumer get Service By LocationId, When Services are disabled
    ${resp}=  Encrypted Provider Login  ${PUSERPH0}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Appmt Schedule By ServiceId and LocationId   ${accId}   ${p1_l1}  ${p1_s3}  
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response List  ${resp}   0  id=${sch_id1}   name=${schedule_name1}  apptState=${Qstate[0]}
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-4
    [Documentation]  Consumer get Service By LocationId, When Services are disabled
    ${resp}=  Encrypted Provider Login  ${PUSERPH0}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-5
    [Documentation]  Consumer get Service By LocationId, When Services are disabled
    ${resp}=  Encrypted Provider Login  ${PUSERPH0}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Appmt Schedule By ServiceId and LocationId   ${accId}   ${p1_l2}  ${p1_s3}  
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response List  ${resp}   0  id=${sch_id2}   name=${schedule_name2}  apptState=${Qstate[0]}
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-UH1
    [Documentation]  Trying to Consumer get Service By LocationId, using invalid location id 
    ${resp}=  Encrypted Provider Login  ${PUSERPH0}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Appmt Schedule By ServiceId and LocationId   ${accId}    0   ${p1_s1}  
    Log  ${resp.json()}
    Should Be Equal As Strings   ${resp.status_code}   404
    Should Be Equal As Strings  "${resp.json()}"       "${LOCATION_NOT_FOUND}"
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-UH2
    [Documentation]  Trying to Consumer get Service By LocationId, When Location are disabled 
    ${resp}=  Encrypted Provider Login  ${PUSERPH0}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Get Appmt Schedule By ServiceId and LocationId-UH3
    [Documentation]  Without Login, Trying to Consumer get Service By LocationId
...
# JD-TC-Get Appmt Schedule By ServiceId and LocationId-UH4
#     [Documentation]  Trying to Consumer get Service By LocationId,(Invalid provider id) 
...
#     ${resp}=  Get Appmt Schedule By ServiceId and LocationId   ${INVALID_Consumer_ID}   ${p1_l2}  ${p1_s2}  
#     Log  ${resp.json()}
#     Should Be Equal As Strings   ${resp.status_code}   404
