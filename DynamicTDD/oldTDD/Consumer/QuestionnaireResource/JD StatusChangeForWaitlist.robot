...
JD-TC-StatusChangeForServiceOptionWaitlist-1
    [Documentation]  Status Change for service options for wailtlist
    ...
    ${resp}=   Change Status Of Service Option Waitlist  ${account_id}  ${wid1}  @{files_data}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
...
JD-TC-StatusChangeForServiceOptionWaitlist-2
    [Documentation]  Status Change for service options for wailtlist taken from provider side
...
JD-TC-StatusChangeForServiceOptionWaitlist-3
    [Documentation]  Status Change for service options for wailtlist after starting waitlist
...
JD-TC-StatusChangeForServiceOptionWaitlist-4
    [Documentation]  Status Change for service options for wailtlist after completing waitlist
...
JD-TC-StatusChangeForServiceOptionWaitlist-UH1
    [Documentation]  Status Change for service options for wailtlist for cancelled appointment
