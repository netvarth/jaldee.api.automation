...
JD-TC-GetQuestionnaireByUuidForLead-1
    [Documentation]  Get questionnaire by uuid for Lead.
...
# *** Comments ***
    ...
    FOR  ${i}  IN RANGE   ${cat_len}
        IF  '${resp.json()[${i}]['name']}'=='${unique_lnames[0]}'
            Set Test Variable  ${category_id1}    ${resp.json()[${i}]['id']}
            Set Test Variable  ${category_name1}  ${resp.json()[${i}]['name']}
        END
    END
...
JD-TC-GetQuestionnaireByUuidForLead-UH1
...
JD-TC-GetQuestionnaireByUuidForLead-UH2
