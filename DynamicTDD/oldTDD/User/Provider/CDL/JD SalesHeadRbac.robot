...
# ....User  :Sales Head...
    ...
    ${user_scope}=  Create Dictionary   businessLocations=${location_id}    
...
# .... Create Branch1....
    ...
    ${resp}=  SendProviderResetMail   ${SHUSERNAME1}
    Should Be Equal As Strings  ${resp.status_code}  200

    @{resp}=  ResetProviderPassword  ${SHUSERNAME1}  ${PASSWORD}  ${OtpPurpose['ProviderResetPassword']}
    Should Be Equal As Strings  ${resp[0].status_code}  200
    Should Be Equal As Strings  ${resp[1].status_code}  200

    ${resp}=  Encrypted Provider Login  ${SHUSERNAME1}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SalesHeadWithRBAC-2
    ...
    ${resp}=    Update BranchMaster    ${branchid1}     ${branchCode2}    ${branchName2}    ${locId1}    ${status[0]}   
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SalesHeadWithRBAC-4
    ...
    [Documentation]               Update location Using Sales Head Role with RBAC
...
# ...... Update sales officer and credit officer for dealer1 by branch operation head....
...
JD-TC-SalesHeadWithRBAC-6
    ...
    [Documentation]               enablePartner Using Sales Head Role with RBAC

# ...............activate dealer1 by Sales head................
...
JD-TC-SalesHeadWithRBAC-7
    ...
    [Documentation]               Sales head - disablePartner
...
JD-TC-SalesHeadWithRBAC-8
                                  
    [Documentation]               Sales head - viewPartner
...
JD-TC-SalesHeadWithRBAC-9
                                  
    [Documentation]               Sales head - viewLoanApplication
...
JD-TC-SalesHeadWithRBAC-UH1
    ...
    [Documentation]               Sales head - Create LoanApplication.
...
JD-TC-SalesHeadWithRBAC-UH2
    ...
    [Documentation]               Sales head -  create Dealer.
...
JD-TC-SalesHeadWithRBAC-UH3
    ...
    [Documentation]               Sales head -  Update Dealer.
