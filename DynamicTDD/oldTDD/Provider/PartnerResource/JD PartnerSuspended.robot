...
JD-TC-partner_Suspended-1
    ...
    ${resp}=    Suspended Partner       ${note}  ${Puid1}  
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
...
JD-TC-partner_Suspended-UH1
    ...
    Should Be Equal As Strings     ${resp.json()}    ${UNABLE_TO_SUSPEND}


JD-TC-partner_Suspended-UH2
                                  
    [Documentation]              partner suspended without login
...
JD-TC-partner_Suspended-UH3
   ...
   ${resp}=  partnercategorytype   ${account_id}
    ...
    ${resp}    Update Partner Bank    ${bankAccountNo}    ${bankIfsc}    ${bankName}    ${Puid2}    ${LoanAction[0]}    ${Pid1}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 

    ${resp}    Verify Partner Bank    ${Pid1}    ${Puid2}    ${bankAccountNo}    ${bankIfsc}    bankName=${bankName}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${resp}    Update Partner Aadhar    ${aadhaar}    ${Puid2}    ${LoanAction[0]}    ${Pid1}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${resp}    Update Partner Pan    ${pan}    ${Puid2}    ${LoanAction[0]}    ${Pid1}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 
    ...
    ${resp}=    Suspended Partner       ${note}  ${empty}  
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${INVALID_PARTNER_ID}


JD-TC-partner_Suspended-UH4
    ...
    ${resp}=    Suspended Partner       ${note}  ${invuid}  
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${INVALID_PARTNER_ID}


JD-TC-partner_Suspended-UH5
    ...
    ${resp}=    Suspended Partner       ${note}  ${Puid2}  
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
