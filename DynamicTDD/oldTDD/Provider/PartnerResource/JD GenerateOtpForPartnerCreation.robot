...
JD-TC-Generate_Otp_For_Partner-1
...
JD-TC-Generate_Otp_For_Partner-UH1
    ...
    ${resp}=  Generate Phone Partner Creation    ${inv_phone}    ${countryCodes[0]}    partnerName=${dealername}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${INVALID_MOBILE_NO}


JD-TC-Generate_Otp_For_Partner-UH2
    ...
    ${resp}=  Generate Phone Partner Creation    ${empty}    ${countryCodes[0]}    partnerName=${dealername}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${MOBILE_NO_REQUIRED}


JD-TC-Generate_Otp_For_Partner-UH3
    ...
    ${cc}    FakerLibrary.Random Number

    ${resp}=  Generate Phone Partner Creation    ${P_phone}    ${cc}    partnerName=${dealername}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200


JD-TC-Generate_Otp_For_Partner-UH4
    ...
    ${resp}=  Generate Phone Partner Creation    ${P_phone}    ${empty}    partnerName=${dealername}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200


JD-TC-Generate_Otp_For_Partner-UH5
    ...
    ${resp}=  Generate Phone Partner Creation    ${P_phone}    ${countryCodes[0]}    partnerName=${empty}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${PARTNER_NAME_REQUIRED}


JD-TC-Generate_Otp_For_Partner-UH6
    ...
    ${resp}=  Generate Phone Partner Creation    ${P_phone}    ${countryCodes[0]}    partnerName=${dealername}   partnerUserFirstName=${empty}  partnerUserLastName=${dealerlname}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${PARTNER_FNAME_REQUIRED}

JD-TC-Generate_Otp_For_Partner-UH7
    ...
    ${resp}=  Generate Phone Partner Creation    ${P_phone}    ${countryCodes[0]}    partnerName=${dealername}   partnerUserFirstName=${dealerfname}  partnerUserLastName=${empty}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${PARTNER_LNAME_REQUIRED}