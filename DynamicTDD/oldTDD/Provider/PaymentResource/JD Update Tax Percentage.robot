...
JD-TC-Update Tax Percentage -3
       ...
       Verify Response  ${resp}  uuid=${wid}  netTotal=${amount}  billStatus=New  billViewStatus=Notshow  netRate=${due}  billPaymentStatus=NotPaid  totalAmountPaid=0.0  amountDue=${due} 
