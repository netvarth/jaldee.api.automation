...
JD-TC-ResubmitServiceOptionsForAppointment-1
    ...
    ${cookie}  ${resp}=  Imageupload.spLogin  ${PUSERNAME47}   ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings   ${resp.status_code}    200
...
JD-TC-ResubmitServiceOptionsForAppointment-2
    [Documentation]  Resubmit Service Options  for appointment after starting appointment
    ...
    ${fudata}=  db.fileUploadDT   ${resp.json()}  ${FileAction[0]}  ${jpgfile} 
    Log  ${fudata}
...
JD-TC-ResubmitServiceOptionsForAppointment-3
    [Documentation]  Resubmit Service Options  for appointment after completing appointment
...
JD-TC-ResubmitServiceOptionsForAppointment-UH1
    [Documentation]  Resubmit Service Options  for appointment after canceled appointment
