...
JD-TC-GetAuditLog -6
    ...
    Append To File  ${EXECDIR}/TDD/numbers.txt  ${PUSERNAME_K}${\n}   
    ${pkg_id}=   get_highest_license_pkg
...
JD-TC-GetAuditLog -20
    ...
    Should Be Equal As Strings  ${resp.json()[2]['text']}               Created a location
...
JD-TC-GetAuditLog -36
    ...
    Append To File  ${EXECDIR}/TDD/numbers.txt  ${PUSERPH27}${\n}
