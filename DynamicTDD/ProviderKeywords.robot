...
Configure Sample User
    ...
    ${key} =   db.Verify Accnt   ${P_User}    ${OtpPurpose['ProviderResetPassword']}  ${jsessionynw_value}
...
Get Item Type By Filter
    ...
    Check Deprication  ${resp}  Get Item Type By Filter
    RETURN  ${resp}
...
Update Report Criteria
    ...
    Check Deprication  ${resp}  Update Report Criteria
    RETURN  ${resp}
...
Get Report Criteria
    ...
    Check Deprication  ${resp}  Get Report Criteria
    RETURN  ${resp}
...
JaldeeId Format  
    ...
    Check Deprication  ${resp}  JaldeeId Format
    RETURN  ${resp}
...
Account Settings
    ...
    ${jdata}=  json.dumps  ${data}
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/account/settings  data=${jdata}  expected_status=any
    Check Deprication  ${resp}  Account Settings
    RETURN  ${resp}
...
Update Accountsettings 
    ...
    ${jdata}=  json.dumps  ${data}
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/account/settings  data=${jdata}  expected_status=any
    Check Deprication  ${resp}  Update Accountsettings
    RETURN  ${resp}
...
Get Next Available Appointment Slot
    ...
    Check Deprication  ${resp}  Get Next Available Appointment Slot
    RETURN  ${resp}
...
Get Next Available Appointment Schedule
    ...
    Check Deprication  ${resp}  Get Next Available Appointment Schedule
    RETURN  ${resp}
...
Update Individual Schedule
    ...
    ${data}=  json.dumps  ${data}
    ${resp}=  PUT On Session  ynw  /provider/appointment/schedule  data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Individual Schedule
    RETURN  ${resp}
...
Create StatusBoardnew
    ...
    Check Deprication  ${resp}  Create StatusBoardnew
    RETURN  ${resp}
...
DonationFundRaising flag
    ...
    Check Deprication  ${resp}  DonationFundRaising flag
    RETURN  ${resp}
...
Create Donation Service
    ...
    Check And Create YNW Session  
    ${resp}=  POST On Session  ynw  /provider/services  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Donation Service
    RETURN  ${resp}
...
Get Donation By Id
    ...
    Check Deprication  ${resp}  Get Donation By Id
    RETURN  ${resp}
...
Get Donations
    ...
    Check Deprication  ${resp}  Get Donations
    RETURN  ${resp}
...
Get Donation Count
    ...
    Check Deprication  ${resp}  Get Donation Count
    RETURN  ${resp}
...
Get Waitlist EncodedId
    ...
    Check Deprication  ${resp}  Get Waitlist EncodedId
    RETURN  ${resp}
...
Get Waitlist By EncodedID
    ...
    Check Deprication  ${resp}  Get Waitlist By EncodedID
    RETURN  ${resp}
...
Get Appointment EncodedID
    ...
    Check Deprication  ${resp}  Get Appointment EncodedID
    RETURN  ${resp}
...
Appointment Action for Batch
    ...
    Check Deprication  ${resp}  Appointment Action for Batch
    RETURN  ${resp}
...
Remove Appointment Label
    ...
    Check Deprication  ${resp}  Remove Appointment Label
    RETURN  ${resp}
...
Add Label for Multiple Waitlist
    ...
    Check Deprication  ${resp}  Add Label for Multiple Waitlist
    RETURN  ${resp}
...
Remove Label from Multiple Waitlist
    ...
    Check Deprication  ${resp}  Remove Label from Multiple Waitlist
    RETURN  ${resp}
...
Add Note to Appointment
    ...
    Check Deprication  ${resp}  Add Note to Appointment
    RETURN  ${resp}
...
Get Future Appointments
    ...
    Check Deprication  ${resp}  Get Future Appointments
    RETURN  ${resp}
...
Get Future Appointment Count
    ...
    Check Deprication  ${resp}  Get Future Appointment Count
    RETURN  ${resp}
...
Get Today Appointment Count
    ...
    Check Deprication  ${resp}  Get Today Appointment Count
    RETURN  ${resp}
...
Get Appointments History
    ...
    Check Deprication  ${resp}  Get Appointments History
    RETURN  ${resp}
...
Get Appointment History Count
    ...
    Check Deprication  ${resp}  Get Appointment History Count
    RETURN  ${resp}
...
Create Waitlist Meeting Request
    ...
    Check Deprication  ${resp}  Create Waitlist Meeting Request
    RETURN  ${resp}
...
Get Waitlist Meeting Request
    ...
    Check Deprication  ${resp}  Get Waitlist Meeting Request
    RETURN  ${resp}
...
Create Appointment Meeting Request
    ...
    Check Deprication  ${resp}  Create Appointment Meeting Request
    RETURN  ${resp}
...
Get Appointment Meeting Request
    ...
    Check Deprication  ${resp}  Get Appointment Meeting Request
    RETURN  ${resp}
...
Rate Appointment
    ...
    Check Deprication  ${resp}  Rate Appointment
    RETURN  ${resp}
...
Provider Update Appointment Rating
    ...
    Check Deprication  ${resp}  Provider Update Appointment Rating
    RETURN  ${resp}
...
Enable Batch For Appointment
    ...
    Check Deprication  ${resp}  Enable Batch For Appointment
    RETURN  ${resp}
...
Disable Batch For Appointment
    ...
    Check Deprication  ${resp}  Disable Batch For Appointment
    RETURN  ${resp}
...
Add Appmt Batch Name
    ...
    Check Deprication  ${resp}  Add Appmt Batch Name
    RETURN  ${resp}
...
Change multiple Appmt Status
    ...
    Log  ${resp}
    Check Deprication  ${resp}  Change multiple Appmt Status
    RETURN  ${resp}
...
Waitlist Action multiple account
    ...
    Log  ${resp}
    Check Deprication  ${resp}  Waitlist Action multiple account
    RETURN  ${resp}
...
Get Appmt Schedule AvailableNow
    ...
    Check Deprication  ${resp}  Get Appmt Schedule AvailableNow
    RETURN  ${resp}    
...
Consumer Mass Communication for Appt
    ...
    Check Deprication  ${resp}  Consumer Mass Communication for Appt
    RETURN  ${resp}
...
Get Appmt Schedule AvailableNow By ProviderId   
    ...
    Check Deprication  ${resp}  Get Appmt Schedule AvailableNow By ProviderId
    RETURN  ${resp}          
...
Get AppmtSchedule NextAvailableTime By ScheduleId
    ...
    Check Deprication  ${resp}  Get AppmtSchedule NextAvailableTime By ScheduleId
    RETURN  ${resp}
...
Get NextAvailableSchedule By Provider Location
    ...
    Check Deprication  ${resp}  Get NextAvailableSchedule By Provider Location
    RETURN  ${resp}
...
Get NextAvailableSchedule By Provider Location and User
    ...
    Check Deprication  ${resp}  Get NextAvailableSchedule By Provider Location and User
    RETURN  ${resp}
...
Get NextAvailableSchedule By multi Provider Location and User
    ...
    Check Deprication  ${resp}  Get NextAvailableSchedule By multi Provider Location and User
    RETURN  ${resp}
...
Update FamilymemberByprovidercustomer
    ...
    Check Deprication  ${resp}  Update FamilymemberByprovidercustomer
    RETURN  ${resp}
...
DeleteFamilymemberByprovidercustomer
    ...
    Check Deprication  ${resp}  DeleteFamilymemberByprovidercustomer
    RETURN  ${resp}
...
Add Appointment Schedule Delay
    ...
    Check Deprication  ${resp}  Add Appointment Schedule Delay
    RETURN  ${resp}
...
Get Appointment Schedule Delay
    ...
    Check Deprication  ${resp}  Get Appointment Schedule Delay
    RETURN  ${resp}
...
Update Account contact information
    ...
    Check Deprication  ${resp}  Update Account contact information
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Availability Of Queue By Provider
#     RETURN  ${resp}
...
Get License UsageInfo
    ...
    Check Deprication  ${resp}  Get License UsageInfo
    RETURN  ${resp}
...
Get Monthly Schedule Availability by Location and Service
    ...
    Check Deprication  ${resp}  Get Monthly Schedule Availability by Location and Service
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Create MR With uuid
#     RETURN  ${resp}
...
Get MR By Id
    ...
    Check Deprication  ${resp}  Get MR By Id
    RETURN  ${resp}
...
Reschedule Consumer Appointment
    ...
    Check Deprication  ${resp}  Reschedule Consumer Appointment
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Create MR prescription by mr id
#     RETURN  ${resp}
...
Get MR prescription 
    ...
    Check Deprication  ${resp}  Get MR prescription
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Update MR prescription
#     RETURN  ${resp}
...
Get PC Case By ToothNo
    ...
    Check Deprication  ${resp}  Get PC Case By ToothNo
    RETURN  ${resp}
...
Reschedule Consumer Checkin
    ...
    Check Deprication  ${resp}  Reschedule Consumer Checkin
    RETURN  ${resp}
...
Get bsconf Messages
    Check And Create YNW Session
    ${resp}=    GET On Session    ynw  /provider/ynwConf/messages  expected_status=any
    Check Deprication  ${resp}  Get bsconf Messages
    RETURN  ${resp}
...
Enable Disable Token Id
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/settings/waitlistMgr   data=${data}  expected_status=any
    Check Deprication  ${resp}  Enable Disable Token Id
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Create MR clinical notes by mr id
#     RETURN  ${resp}
...
Get MR clinical notes
    ...
    Check Deprication  ${resp}  Get MR clinical notes
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Update MR clinical notes
#     RETURN  ${resp}
...
Share Prescription
    ...
    Check Deprication  ${resp}  Share Prescription
    RETURN  ${resp}
...
uploadDigitalSign
    ...
    Check Deprication  ${resp}  uploadDigitalSign
    RETURN  ${resp}       
...
Get digital sign
    ...
    Check Deprication  ${resp}  Get digital sign
    RETURN  ${resp}
...
uploadPrescriptionImage
    ...
    Check Deprication  ${resp}  uploadPrescriptionImage
    RETURN  ${resp}
...
uploadClinicalnotesImage
    ...
    Check Deprication  ${resp}  uploadClinicalnotesImage
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Create MR with patientId
#     RETURN  ${resp}
...
Get Patient Previous Visit
    ...
    Check Deprication  ${resp}  Get Patient Previous Visit
    RETURN  ${resp}
...
Get Patient Previous Visit Count
    ...
    Check Deprication  ${resp}  Get Patient Previous Visit Count
    RETURN  ${resp}
...
Get MR Auditlogs by MR Id
    ...
    Check Deprication  ${resp}  Get MR Auditlogs by MR Id
    RETURN  ${resp}
...
Create Order Settings
    ...
    Check Deprication  ${resp}  Create Order Settings
    RETURN  ${resp}
...
Update Order Settings
    ...
    Check Deprication  ${resp}  Update Order Settings
    RETURN  ${resp} 
...
Get Order Settings Status
    ...
    Check Deprication  ${resp}  Get Order Settings Status
    RETURN  ${resp}
...
Get Order Settings Contact info
    ...
    Check Deprication  ${resp}  Get Order Settings Contact info
    RETURN  ${resp}
...
Update Store Contact info
    ...
    Check Deprication  ${resp}  Update Store Contact info
    RETURN  ${resp}
...
Create Order Item
   ...
   Check Deprication  ${resp}  Create Order Item
    RETURN  ${resp}
...
Create Virtual Order Item
   ...
   Check And Create YNW Session 
   ${resp}=    POST On Session    ynw  /provider/items   data=${data}  expected_status=any
   Check Deprication  ${resp}  Create Virtual Order Item
    RETURN  ${resp}
...
Update Order Item
   ...
   Check Deprication  ${resp}  Update Order Item
    RETURN  ${resp}
...
Update Virtual Order Item
   ...
   Check And Create YNW Session 
   ${resp}=    PUT On Session    ynw  /provider/items   data=${data}  expected_status=any
   Check Deprication  ${resp}  Update Virtual Order Item
    RETURN  ${resp}
...
Get Item By Criteria
    ...
    Check Deprication  ${resp}  Get Item By Criteria
    RETURN  ${resp}
...
Add Item Label
    ...
    Check Deprication  ${resp}  Add Item Label
    RETURN  ${resp}
...
Remove Item Label
    ...
    Check Deprication  ${resp}  Remove Item Label
    RETURN  ${resp}
...
Create Order By Provider For Pickup
    ...
    Check Deprication  ${resp}  Create Order By Provider For Pickup
    RETURN  ${resp}
...
Create Order By Provider For HomeDelivery
    ...
    Log  ${order} 
    ${resp}=  OrderItemByProvider   ${Cookie}   ${order}
    Check Deprication  ${resp}  Create Order By Provider For HomeDelivery
    RETURN  ${resp}
...
Create Order By Provider For Electronic Delivery
    ...
    ${resp}=  OrderItemByProvider   ${Cookie}   ${order}
    Check Deprication  ${resp}  Create Order By Provider For Electronic Delivery
    RETURN  ${resp}
...
Upload ShoppingList By Provider for Pickup
    ...
    Check Deprication  ${resp}  Upload ShoppingList By Provider for Pickup
    RETURN  ${resp} 
...
Upload ShoppingList By Provider for HomeDelivery
    ...
    ${resp}=  OrderImageUploadByProvider   ${Cookie}   ${caption}   ${order}
    Check Deprication  ${resp}  Upload ShoppingList By Provider for HomeDelivery
    RETURN  ${resp} 
...
Create Catalog For ShoppingCart
    ...
    Check Deprication  ${resp}  Create Catalog For ShoppingCart
    RETURN  ${resp}
...
Update Catalog For ShoppingCart
    ...
    Check Deprication  ${resp}  Update Catalog For ShoppingCart
    RETURN  ${resp}
...
Create Catalog For ShoppingList
    ...
    Check And Create YNW Session 
    ${resp}=  POST On Session  ynw  /provider/catalog  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Catalog For ShoppingList
    RETURN  ${resp}
...
Update Catalog For ShoppingList
    ...
    Check And Create YNW Session 
    ${resp}=  PUT On Session  ynw  /provider/catalog  data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Catalog For ShoppingList
    RETURN  ${resp}
...
Order Mass Communication
    ...
    Check Deprication  ${resp}  Order Mass Communication
    RETURN  ${resp}
...
Get Order Catalog
    ...
    Check Deprication  ${resp}  Get Order Catalog
    RETURN  ${resp}
...
Change Catalog Status
    ...
    Check Deprication  ${resp}  Change Catalog Status
    RETURN  ${resp}
...
Add Items To Catalog
    ...
    Check Deprication  ${resp}  Add Items To Catalog
    RETURN  ${resp}
...
Get Item From Catalog
    ...
    Check Deprication  ${resp}  Get Item From Catalog
    RETURN  ${resp}
...
Update Single Catalog Item
   ...
   Check Deprication  ${resp}  Update Single Catalog Item
    RETURN  ${resp}
...
Update Multiple Catalog Items
   ...
   Check Deprication  ${resp}  Update Multiple Catalog Items
    RETURN  ${resp}
...
Remove Multiple Items From Catalog
    ...
    Check Deprication  ${resp}  Remove Multiple Items From Catalog
    RETURN  ${resp}
...
Remove Single Item From Catalog
    ...
    Check Deprication  ${resp}  Remove Single Item From Catalog
    RETURN  ${resp}
...
Create MR 
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/mr/${uuid}   data=${data}  expected_status=any
    Check Deprication  ${resp}  Create MR 
    RETURN  ${resp}
...
Share Prescription Thirdparty
    ...
    Check Deprication  ${resp}  Share Prescription Thirdparty
    RETURN  ${resp}
...
Confirm Blocked Appointment
    ...
    Check Deprication  ${resp}  Confirm Blocked Appointment
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Update MR by mr id
#     RETURN  ${resp}
...
#     Check Deprication  ${resp}  Add Label for Customer
#     RETURN  ${resp}
...
Add Labels for Customers
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/customers/label   data=${data}  expected_status=any
    Check Deprication  ${resp}  Add Labels for Customers
    RETURN  ${resp}
...
Remove Labels from Customers
    ...
    Check Deprication  ${resp}  Remove Labels from Customers
    RETURN  ${resp}
...
Remove Customer Label
    ...
    Check Deprication  ${resp}  Remove Customer Label
    RETURN  ${resp}
...
Update Order For HomeDelivery
    ...
    Check Deprication  ${resp}  Update Order For HomeDelivery
    RETURN  ${resp}
...
Update Order For Pickup
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw   /provider/orders  data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Order For Pickup
    RETURN  ${resp}
...
Update Order For Electronic Delivery
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw   /provider/orders  data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Order For Electronic Delivery
    RETURN  ${resp}
...
Update Order Items By Provider
    ...
    Check Deprication  ${resp}  Update Order Items By Provider
    RETURN  ${resp}
...
Get Order by uid
    ...
    Check Deprication  ${resp}  Get Order by uid
    RETURN  ${resp}
...
Change Order Status 
    ...
    Check Deprication  ${resp}  Change Order Status
    RETURN  ${resp}
...
Get Order Status Changes by uid 
    ...
    Check Deprication  ${resp}  Get Order Status Changes by uid 
    RETURN  ${resp}
...
Get Order By Criterias
    ...
    Check Deprication  ${resp}  Get Order By Criterias
    RETURN  ${resp}
...
Get Order count by Criterias
    ...
    Check Deprication  ${resp}  Get Order count by Criterias
    RETURN  ${resp}
...
Get Order By enclosed ID 
    ...
    Check Deprication  ${resp}  Get Order By enclosed ID
    RETURN  ${resp}
...
Get Future Order By Criterias
    ...
    Check Deprication  ${resp}  Get Future Order By Criterias
    RETURN  ${resp}
...
Get Future Order count by Criterias
    ...
    Check Deprication  ${resp}  Get Future Order count by Criterias
    RETURN  ${resp}
...
Update Delivery charge 
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session   ynw  /provider/bill/${action}/${uuid}  data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Delivery charge
    RETURN  ${resp}
...
Get Order History By Criterias
    ...
    Check Deprication  ${resp}  Get Order History By Criterias
    RETURN  ${resp}
...
Get Order History count by Criterias
    ...
    Check Deprication  ${resp}  Get Order History count by Criterias
    RETURN  ${resp}
...
Add Label for Order
    ...
    Check Deprication  ${resp}  Add Label for Order
    RETURN  ${resp}  
...
Remove Label for Order
    ...
    Check Deprication  ${resp}  Remove Label for Order
    RETURN  ${resp} 
...
Add Label for Multiple Order
    ...
    Check Deprication  ${resp}  Add Label for Multiple Order
    RETURN  ${resp}
...
Update Delivery Address
    ...
    Check Deprication  ${resp}  Update Delivery Address
    RETURN  ${resp}
...
Get Delivery Address
    ...
    Check Deprication  ${resp}  Get Delivery Address
    RETURN  ${resp}
...
Create Customer Group
    ...
    ${data}=  json.dumps  ${data}
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/customers/group  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Customer Group
    RETURN  ${resp}
...
Get Customer Groups
    ...
    Check And Create YNW Session
    ${resp}=  GET On Session  ynw  /provider/customers/group  expected_status=any
    Check Deprication  ${resp}  Create Customer Group
    RETURN  ${resp}
...
Get Customer Group by id
    [Arguments]  ${groupId}
    Check And Create YNW Session
    ${resp}=  GET On Session  ynw  /provider/customers/group/${groupId}  expected_status=any
    Check Deprication  ${resp}  Create Customer Group
    RETURN  ${resp}
...
Update Customer Group
    ...
    ${data}=  json.dumps  ${data}
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/customers/group/  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Customer Group
    RETURN  ${resp}
...
Enable Customer Group
    [Arguments]  ${groupId}
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/customers/group/${groupId}/ENABLE    expected_status=any
    Check Deprication  ${resp}  Enable Customer Group
    RETURN  ${resp}
...
Disable Customer Group
    [Arguments]  ${groupId}
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/customers/group/${groupId}/DISABLE    expected_status=any
    Check Deprication  ${resp}  Disable Customer Group
    RETURN  ${resp}
...
#     Check And Create YNW Session
#     ${resp}=    POST On Session   ynw    /provider/customers/group/${groupName}   data=${data}  expected_status=any
#     Check Deprication  ${resp}  Add Customers to Group
#     RETURN  ${resp}
...
Add Customers to Group
    ...
    ${data}=   json.dumps    ${data}
    Check And Create YNW Session
    ${resp}=    POST On Session   ynw    /provider/customers/group/addGroup   data=${data}  expected_status=any
    Check Deprication  ${resp}  Add Customers to Group
    RETURN  ${resp}
...
Add MemberId for a consumer in group 
    ...
    Check And Create YNW Session
    ${resp}=    POST On Session   ynw    /provider/customers/groupMemId/${groupName}/${proConId}/${memberId}    expected_status=any
    Check Deprication  ${resp}  Add MemberId for a consumer in group
    RETURN  ${resp}
...
Get Member Id of a consumer in a group 
    ...
    [Arguments]  ${groupName}   ${proConId}  
    Check And Create YNW Session
    ${resp}=    GET On Session   ynw    provider/customers/groupMemId/${groupName}/${proConId}    expected_status=any
    Check Deprication  ${resp}  Get Member Id of a consumer in a group
    RETURN  ${resp}
...
Update Member Id for a consumer in a group 
    ...
    Check And Create YNW Session
    ${resp}=    PUT On Session   ynw    provider/customers/groupMemId/${groupName}/${proConId}/${memId}   expected_status=any
    Check Deprication  ${resp}  Get Member Id of a consumer in a group
    RETURN  ${resp}
...
Remove Customer from Group
    [Arguments]  ${groupName}   ${proConId}
    Check And Create YNW Session
    ${resp}=    DELETE On Session   ynw    /provider/customers/${proConId}/group/${groupName}   expected_status=any  
    Check Deprication  ${resp}  Remove Customer from Group
    RETURN  ${resp}
...
Remove Multiple Customer from Group
    ...
    ${data}=   json.dumps    ${proConId}
    Check And Create YNW Session
    ${resp}=    DELETE On Session   ynw    /provider/customers/group/${groupName}   data=${data}  expected_status=any
    Check Deprication  ${resp}  Remove Multiple Customer from Group
    RETURN  ${resp}
...
Get Customer Count in Group
   [Arguments]  ${groupId}
   Check And Create YNW Session
   ${resp}=  GET On Session  ynw  /provider/customers/group/count/${groupId}  expected_status=any
   Check Deprication  ${resp}  Get Customer Count in Group
   RETURN  ${resp}
...
Get Holiday By Id
    ...
    Check Deprication  ${resp}  Get Holiday By Id
    RETURN  ${resp}
...
Update Holiday
    ...
    Check Deprication  ${resp}  Update Holiday
    RETURN  ${resp}
...
Get Next Availability
    ...
    Check Deprication  ${resp}  Get Next Availability
    RETURN  ${resp}
...
Get Provider Waitlist Attachment
    ...
    Check Deprication  ${resp}  Get Provider Waitlist Attachment
    RETURN  ${resp}
...
Get Provider Appointment Attachment
   ...
   Check Deprication  ${resp}  Get Provider Appointment Attachment
    RETURN  ${resp}
...
Get Provider Consumer Orders
   ...
   Check Deprication  ${resp}  Get Provider Consumer Orders
    RETURN  ${resp}
...
Create Vacation 
    ...
    Check Deprication  ${resp}  Create Vacation
    RETURN  ${resp}
...
Activate Vacation
    ...
    Check Deprication  ${resp}  Activate Vacation
    RETURN  ${resp}
...
Update Vacation 
    ...
    Check Deprication  ${resp}  Update Vacation
    RETURN  ${resp}
...
Get Vacation By Id
    ...
    Check Deprication  ${resp}  Get Vacation By Id
    RETURN  ${resp}  
...
Get Vacation
	...
	Check Deprication  ${resp}  Get Vacation
    RETURN  ${resp}  
...
Delete Vacation
    ...
    Check Deprication  ${resp}  Delete Vacation
    RETURN  ${resp}
...
Get Vacation Next Availability 
    ...
    Check Deprication  ${resp}  Get Vacation Next Availability
    RETURN  ${resp}
...
Create Provider Coupon 
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/bill/coupons   data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Provider Coupon
    RETURN  ${resp}
...
Update Provider Coupon 
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/bill/coupons   data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Provider Coupon
    RETURN  ${resp}
...
Publish Provider Coupon
    ...
    Check Deprication  ${resp}  Publish Provider Coupon
    RETURN  ${resp}
...
Add Multiple Labels for Order
    ...
    Check Deprication  ${resp}  Add Multiple Labels for Order
    RETURN  ${resp}
...
Remove Multiple Labels from Order
    ...
    Check Deprication  ${resp}  Remove Multiple Labels from Order
    RETURN  ${resp}
...
Get waitlist Service By Location   
    ...
    Check Deprication  ${resp}  Get waitlist Service By Location
    RETURN  ${resp} 
...
Get Questionnaire List By Provider      
    ...
    Check Deprication  ${resp}  Get Questionnaire List By Provider
    RETURN  ${resp}
...
Get Provider Questionnaire By Id    
    ...
    Check Deprication  ${resp}  Get Provider Questionnaire By Id
    RETURN  ${resp}
...
Get Questionnaire for Consumer     
    ...
    Check Deprication  ${resp}  Get Questionnaire for Consumer
    RETURN  ${resp}
...
Get Consumer Questionnaire By Channel and ServiceID    
    ...
    Check Deprication  ${resp}  Get Consumer Questionnaire By Channel and ServiceID
    RETURN  ${resp}
...
Provider Change Questionnaire Status    
    ...
    Check Deprication  ${resp}  Provider Change Questionnaire Status
    RETURN  ${resp}
...
Run JCash Expiry Agent
    ...
    Check Deprication  ${resp}  Run JCash Expiry Agent
    RETURN  ${resp}
...
Get LocByPincode
    ...
    Check Deprication  ${resp}  Get LocByPincode
    RETURN  ${resp}
...
Get LocationsByPincode
    ...
    Check Deprication  ${resp}  Get LocationsByPincode
    RETURN  ${resp}
...
Assign provider Waitlist
    ...
    Check Deprication  ${resp}  Assign provider Waitlist
    RETURN  ${resp}
...
Assign provider Appointment 
    ...
    Check Deprication  ${resp}  Assign provider Appointment
    RETURN  ${resp}
...
Terminate Availability Queue
    ...
    Check Deprication  ${resp}  Terminate Availability Queue
    RETURN  ${resp}
...
Un Assign provider Appointment 
    ...
    Check Deprication  ${resp}  Un Assign provider Appointment 
    RETURN  ${resp}
...
Delete Gallery Image
    ...
    Check Deprication  ${resp}  Delete Gallery Image
    RETURN  ${resp}
...
Provider Validate Questionnaire
    ...
    Check Deprication  ${resp}  Provider Validate Questionnaire
    RETURN  ${resp}
...
Provider Change Answer Status for Waitlist
    ...
    Check Deprication  ${resp}  Provider Change Answer Status for Waitlist
    RETURN  ${resp}    
...
Assign Team To Checkin
    ...
    Check Deprication  ${resp}  Assign Team To Checkin
    RETURN  ${resp}
...
Assign Team To Appointment
    ...
    Check Deprication  ${resp}  Assign Team To Appointment
    RETURN  ${resp}
...
Provider Revalidate Questionnaire
    ...
    Check Deprication  ${resp}  Provider Revalidate Questionnaire
    RETURN  ${resp}
...
Get Questionnaire By uuid For Waitlist
    ...
    Check Deprication  ${resp}  Get Questionnaire By uuid For Waitlist
    RETURN  ${resp}
...
Provider Change Questionnaire release Status For waitlist
    ...
    Check Deprication  ${resp}  Provider Change Questionnaire release Status For waitlist
    RETURN  ${resp}
...
Provider Change Questionnaire release Status For Appmt
    ...
    Check Deprication  ${resp}  Provider Change Questionnaire release Status For Appmt
    RETURN  ${resp}
...
Get Questionnaire By uuid For Appmt
    ...
    Check Deprication  ${resp}  Get Questionnaire By uuid For Appmt
    RETURN  ${resp}
...
Set Price Variation Per Schedule
    ...
    Check Deprication  ${resp}  Set Price Variation Per Schedule
    RETURN  ${resp}
...
Get Price Variation Per Schedule
    ...
    Check Deprication  ${resp}  Get Price Variation Per Schedule
    RETURN  ${resp}
...
Get Account Level Analytics
    ...
    Check Deprication  ${resp}  Get Account Level Analytics
    RETURN  ${resp}
...
Get Account Level Analytics Acc To config
    ...
    Check Deprication  ${resp}  Get Account Level Analytics Acc To config
    RETURN  ${resp}
...
Get UserLevel Analytics
    ...
    Check Deprication  ${resp}  Get UserLevel Analytics
    RETURN  ${resp}
...
Flush Analytics Data to DB
    ...
    Check Deprication  ${resp}  Flush Analytics Data to DB
    RETURN  ${resp}
...
Provider Add To WL With Virtual Service For User
    ...
    Check Deprication  ${resp}  Provider Add To WL With Virtual Service For User
    RETURN  ${resp}
...
Create virtual Service with dept
    ...
    Check And Create YNW Session  
    ${resp}=  POST On Session  ynw  /provider/services  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create virtual Service with dept
    RETURN  ${resp}
...
Create Bank Details
    ...
    Check Deprication  ${resp}  Create Bank Details
    RETURN  ${resp}
...
Get Bank Details
    ...
    Check Deprication  ${resp}  Get Bank Details
    RETURN  ${resp}
...
Get Bank Details By Id
    ...
    Check Deprication  ${resp}  Get Bank Details By Id
    RETURN  ${resp}
...
Update Bank Details
    ...
    Check Deprication  ${resp}  Update Bank Details
    RETURN  ${resp}
...
Update Destination Bank
    ...
    Check Deprication  ${resp}  Update Destination Bank
    RETURN  ${resp}
...
Get payment profiles
    ...
    Check Deprication  ${resp}  Get payment profiles
    RETURN  ${resp}
...
Get payment profile By Id
    ...
    Check Deprication  ${resp}  Get payment profile By Id
    RETURN  ${resp}
...
Assign Profile To Service
   ...
   Check Deprication  ${resp}  Assign Profile To Service
    RETURN  ${resp}
...
Enable Disable Online Payment
   ...
   Check Deprication  ${resp}  Enable Disable Online Payment
    RETURN  ${resp}
...
Get Filter Comm
    ...
    Check Deprication  ${resp}  Get Filter Comm
    RETURN  ${resp}
...
Get NextAvailableSchedule appt Provider
    ...
    Check Deprication  ${resp}  Get NextAvailableSchedule appt Provider
    RETURN  ${resp}
...
Get Questionnaire By uuid For Order
    ...
    Check Deprication  ${resp}  Get Questionnaire By uuid For Order
    RETURN  ${resp}
...
Provider Change Questionnaire release Status For Order
    ...
    Check Deprication  ${resp}  Provider Change Questionnaire release Status For Order
    RETURN  ${resp}
...
Provider Change Answer Status for order
    ...
    Check Deprication  ${resp}  Provider Change Answer Status for order
    RETURN  ${resp}
...
Get Consumer Questionnaire By Channel and OrderID    
    ...
    Check Deprication  ${resp}  Get Consumer Questionnaire By Channel and OrderID
    RETURN  ${resp}
...
Get Appointment Details with apptid  
    ...
    Check Deprication  ${resp}  Get Appointment Details with apptid 
    RETURN  ${resp}
...
Get Service Options By Serviceid and Channel
    ...
    Check Deprication  ${resp}  Get Service Options By Serviceid and Channel
    RETURN  ${resp}
...
Get Service Options for Donation By Serviceid
    ...
    Check Deprication  ${resp}  Get Service Options for Donation By Serviceid
    RETURN  ${resp}
...
Provider Upload Status for Appnt
    ...
    Check Deprication  ${resp}  Provider Upload Status for Appnt
    RETURN  ${resp}
...
Get Service Options For Order By Catalogueid and Channel
    ...
    Check Deprication  ${resp}  Get Service Options For Order By Catalogueid and Channel
    RETURN  ${resp}
...
Get Report Status By Token Id
    ...
    Check Deprication  ${resp}  Get Report Status By Token Id
    RETURN  ${resp}
...
Get Report By Status
    ...
    Check Deprication  ${resp}  Get Report By Status
    RETURN  ${resp}
...
Create Task
   ...
   Check Deprication  ${resp}  Create Task
    RETURN  ${resp}
...
Update Task
   ...
   Check Deprication  ${resp}  Update Task
    RETURN  ${resp}
...
Create Lead
    ...
    Check Deprication  ${resp}  Create Lead
    RETURN  ${resp}
...
Get Lead By Id
    ...
    Check Deprication  ${resp}  Get Lead By Id
    RETURN  ${resp}  
...
Get Leads
    ...
    Check Deprication  ${resp}  Get Leads
    RETURN  ${resp}
...
Enable Disable CRM
    ...
    Check Deprication  ${resp}  Enable Disable CRM
    RETURN  ${resp}
...
Get Lead Category Type
    ...
    Check Deprication  ${resp}  Get Lead Category Type
    RETURN  ${resp}

Get Task Status
    Check And Create YNW Session
    ${resp}=  GET On Session  ynw  provider/task/status  expected_status=any
    Check Deprication  ${resp}  Get Task Status
    RETURN  ${resp}
...
Get Task Priority
    ...
    Check Deprication  ${resp}  Get Task Priority
    RETURN  ${resp}
...
Get Task Category Type
    ...
    Check Deprication  ${resp}  Get Task Category Type
    RETURN  ${resp}
...
Get Task Type
    ...
    Check Deprication  ${resp}  Get Task Type
    RETURN  ${resp}
...
Get Consumer Tasks
    ...
    Check Deprication  ${resp}  Get Consumer Tasks
    RETURN  ${resp}
...
Get Provider Tasks
    ...
    Check Deprication  ${resp}  Get Provider Tasks
    RETURN  ${resp}
...
Get Task By Id
    ...
    Check Deprication  ${resp}  Get Task By Id
    RETURN  ${resp}
...
Add Notes To Task
    ...
    Check Deprication  ${resp}  Add Notes To Task
    RETURN  ${resp}
...
Create Task Appt Details
    ...
    Check Deprication  ${resp}  Create Task Appt Details
    RETURN  ${resp}
...
Change Task Status
   ...
   Check Deprication  ${resp}  Change Task Status
    RETURN  ${resp}
...
Change Task Priority
    ...
    Check Deprication  ${resp}  Change Task Priority
    RETURN  ${resp}
...
Change Assignee
    ...
    Check Deprication  ${resp}  Change Assignee
    RETURN  ${resp}
...
Add Task Progress For User
    ...
    Check Deprication  ${resp}  Add Task Progress For User
    RETURN  ${resp}
...
Change User Task Status
    ...
    Check Deprication  ${resp}  Change User Task Status
    RETURN  ${resp}
...
Change User Task Closing Details
    ...
    Check Deprication  ${resp}  Change User Task Closing Details
    RETURN  ${resp}
...
Change User Task Status Closed
    ...
    Check Deprication  ${resp}  Change User Task Status Closed
    RETURN  ${resp}
...
Get Task Audit Logs
    ...
    Check Deprication  ${resp}  Get Task Audit Logs
    RETURN  ${resp}
...
Enable Disable Task
    ...
    Check Deprication  ${resp}  Enable Disable Task
    RETURN  ${resp}
...
Enable Disable Lead
    ...
    Check Deprication  ${resp}  Enable Disable Lead
    RETURN  ${resp}
...
Create SubTask
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/task/  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create SubTask
    RETURN  ${resp}
...
Get Task Progress
    ...
    Check Deprication  ${resp}  Get Task Progress
    RETURN  ${resp}
...
Remove Task Assignee
    ...
    Check Deprication  ${resp}  Remove Task Assignee
    RETURN  ${resp}
...
Get Leads With Filter
    ...
    Check Deprication  ${resp}  Get Leads With Filter
    RETURN  ${resp}
...
Get Lead Count
    ...
    Check Deprication  ${resp}  Get Lead Count
    RETURN  ${resp}
...
Create Task Master
    ...
    Check Deprication  ${resp}  Create Task Master
    RETURN  ${resp}
...
Get Task Master By Id
    ...
    Check Deprication  ${resp}  Get Task Master By Id
    RETURN  ${resp}
...
Add Lead Notes
    ...
    Check Deprication  ${resp}  Add Lead Notes
    RETURN  ${resp}
...
Get Task Master With Filter
    ...
    Check Deprication  ${resp}  Get Task Master With Filter
    RETURN  ${resp}
...
Change Lead Assignee
    ...
    Check Deprication  ${resp}  Change Lead Assignee
    RETURN  ${resp}
...
Change Lead Manager
    ...
    Check Deprication  ${resp}  Change Lead Manager
    RETURN  ${resp}
...
Change Lead Priority
    ...
    Check Deprication  ${resp}  Change Lead Priority
    RETURN  ${resp}
...
Change Lead Status
    ...
    Check Deprication  ${resp}  Change Lead Status
    RETURN  ${resp}
...
Remove Lead Manager
    ...
    Check Deprication  ${resp}  Remove Lead Manager
    RETURN  ${resp}
...
Remove Lead Assignee
    ...
    Check Deprication  ${resp}  Remove Lead Assignee
    RETURN  ${resp}
...
Get Lead Notes
    ...
    Check Deprication  ${resp}  Get Lead Notes
    RETURN  ${resp}
...
Transfer Lead Location
    ...
    Check Deprication  ${resp}  Transfer Lead Location
    RETURN  ${resp}
...
Update Lead
    ...
    Check Deprication  ${resp}  Update Lead
    RETURN  ${resp}
...
Change Task Manager
    ...
    Check Deprication  ${resp}  Change Task Manager
    RETURN  ${resp}
...
Create Task With Multiple Assignee
    ...
    Check Deprication  ${resp}  Create Task With Multiple Assignee
    RETURN  ${resp}
...
Add Lead Token
    ...
    Check Deprication  ${resp}  Add Lead Token
    RETURN  ${resp}
...
Get Lead Tokens
    ...
    Check Deprication  ${resp}  Get Lead Tokens
    RETURN  ${resp}
...
Get Lead Activity Log
    ...
    Check Deprication  ${resp}  Get Lead Activity Log
    RETURN  ${resp}
...
Get Questionnaire By uuid For Lead
    ...
    Check Deprication  ${resp}  Get Questionnaire By uuid For Lead
    RETURN  ${resp}
...
Provider Change Answer Status for Lead
    ...
    Check Deprication  ${resp}  Provider Change Answer Status for Lead
    RETURN  ${resp}
...
Provider Change Questionnaire release Status For Lead
    ...
    Check Deprication  ${resp}  Provider Change Questionnaire release Status For Lead
    RETURN  ${resp}
...
Update Order Notification
    ...
    Check Deprication  ${resp}  Update Order Notification
    RETURN  ${resp}
...
Get Single Token Status
    ...
    Check Deprication  ${resp}  Get Single Token Status
    RETURN  ${resp}
...
Get List Of Shared 0wners 
    ...
    Check Deprication  ${resp}  Get List Of Shared 0wners
    RETURN  ${resp}
...
Get by Criteria
    ...
    Check Deprication  ${resp}  Get by Criteria
    RETURN  ${resp}
...
Delete Jaldeedrive File
    ...
    Check Deprication  ${resp}  Delete Jaldeedrive File
    RETURN  ${resp}
...
Get Count of Files in a filter 
    ...
    Check Deprication  ${resp}  Get Count of Files in a filter
    RETURN  ${resp}
...
Get Count File In a filter By provider 
    ...
    Check Deprication  ${resp}  Get Count File In a filter By provider
    RETURN  ${resp}
...
Get total Storage usage
    ...
    Check Deprication  ${resp}  Get total Storage usage
    RETURN  ${resp}
...
Remove Share files 
    ...
    Check Deprication  ${resp}  Remove Share files
    RETURN  ${resp}
...
Encoded Short Url
    ...
    Check Deprication  ${resp}  Encoded Short Url
    RETURN  ${resp}
...
Get a File Using Short Url
    ...
    Check Deprication  ${resp}  Get a File Using Short Url
    RETURN  ${resp}
...
Share files 
   ...
   # ${sharedto}=  Create List   ${sharedto}
    ...
    Check Deprication  ${resp}  Share files
    RETURN  ${resp}
...
Upload To Private Folder
    ...
    Check Deprication  ${resp}  Upload To Private Folder
    RETURN  ${resp}
...
Change Upload Status
    ...
    Check Deprication  ${resp}  Change Upload Status
    RETURN  ${resp}
...
Get Provider service options for an item
    ...
    Check Deprication  ${resp}  Get Provider service options for an item
    RETURN  ${resp}
...
Change Provider Status Of Service Option Item
    ...
    Check Deprication  ${resp}  Change Provider Status Of Service Option Item
    RETURN  ${resp} 
...
Change Provider Status Of Service Option Waitlist
    ...
    Check Deprication  ${resp}  Change Provider Status Of Service Option Waitlist
    RETURN  ${resp} 
...
Change Provider Status Of Service Option Appointment
    ...
    Check Deprication  ${resp}  Change Provider Status Of Service Option Appointment
    RETURN  ${resp} 
...
Change Provider Status Of Service Option Order
    ...
    Check Deprication  ${resp}  Change Provider Status Of Service Option Order
    RETURN  ${resp} 
...
Get Provider Enquiry Category
    ...
    Check Deprication  ${resp}  Get Provider Enquiry Category
    RETURN  ${resp}
...
Get Provider Enquiry Type
    ...
    Check Deprication  ${resp}  Get Provider Enquiry Type
    RETURN  ${resp}
...
Get Provider Enquiry Status
    ...
    Check Deprication  ${resp}  Get Provider Enquiry Status
    RETURN  ${resp}
...
Get Provider Enquiry Priority
    ...
    Check Deprication  ${resp}  Get Provider Enquiry Priority
    RETURN  ${resp}
...
Get Enquiry Template
    ...
    Check Deprication  ${resp}  Get Enquiry Template
    RETURN  ${resp}
...
Create Enquiry
    ...
    Check Deprication  ${resp}  Create Enquiry
    RETURN  ${resp}
...
Get Enquiry with filter
    ...
    Check Deprication  ${resp}  Get Enquiry with filter
    RETURN  ${resp}
...
Get Enquiry count with filter
    ...
    Check Deprication  ${resp}  Get Enquiry count with filter
    RETURN  ${resp}
...
Get Enquiry by Uuid
    ...
    Check Deprication  ${resp}  Get Enquiry by Uuid
    RETURN  ${resp}
...
Update Enquiry
    ...
    Check Deprication  ${resp}  Update Enquiry
    RETURN  ${resp}
...
Change Enquiry Status
    ...
    Check Deprication  ${resp}  Change Enquiry Status
    RETURN  ${resp}
...
Get Service Options By Catalogueid and Channel
    ...
    Check Deprication  ${resp}  Get Service Options By Catalogueid and Channel
    RETURN  ${resp}
...
Get Lead Templates
    ...
    Check Deprication  ${resp}  Get Lead Templates
    RETURN  ${resp}
...
Change Task Status to Complete
    ...
    Check Deprication  ${resp}  Change Task Status to Complete
    RETURN  ${resp}
...
Create KYC
    ...
    Check Deprication  ${resp}  Create KYC
    RETURN  ${resp}
...
Get KYC
    ...
    Check Deprication  ${resp}  Get KYC
    RETURN  ${resp}
...
Update KYC 
    ...
    Check Deprication  ${resp}  Update KYC
    RETURN  ${resp}
...
Change KYC Status
    ...
    Check Deprication  ${resp}  Change KYC Status
    RETURN  ${resp}
...
Process CRIF Inquiry
    ...
    Check Deprication  ${resp}  Process CRIF Inquiry
    RETURN  ${resp}
...
Get CRIF Inquiry
    ...
    Check Deprication  ${resp}  Get CRIF Inquiry
    RETURN  ${resp}
...
Get States
    ...
    Check Deprication  ${resp}  Get States
    RETURN  ${resp}
...
Status change crif
    ...
    Check Deprication  ${resp}  Status change crif
    RETURN  ${resp}
...
Process CRIF Inquiry with kyc
    ...
    ${data}=  json.dumps  ${data}
    ${resp}=    POST On Session    ynw  /provider/crif/processinquiry      data=${data}     expected_status=any 
    Check Deprication  ${resp}  Process CRIF Inquiry with kyc
    RETURN  ${resp}
...
Get CRIF Inquiry with kyc
    ...
    Check Deprication  ${resp}  Get CRIF Inquiry with kyc
    RETURN  ${resp}
...
Get Qnr for login status
    ...
    Check Deprication  ${resp}  Get Qnr for login status
    RETURN  ${resp}
...
Change Status Lead
    ...
    Check Deprication  ${resp}  Change Status Lead
    RETURN  ${resp}
...
Redirect lead 
    ...
    Check Deprication  ${resp}  Redirect lead
    RETURN  ${resp}
...
Rejected lead
    ...
    Check Deprication  ${resp}  Rejected lead
    RETURN  ${resp}
...
Get JaldeeBank Statement By Provider
    ...
    Check Deprication  ${resp}  Get JaldeeBank Statement By Provider
    RETURN  ${resp}
...
Change Task Status to Proceed
    ...
    Check Deprication  ${resp}  Change Task Status to Proceed
    RETURN  ${resp}
...
Change Task Status to Closed
    ...
    Check Deprication  ${resp}  Change Task Status to Closed
    RETURN  ${resp}
...
Change Task Status to Rejected
    ...
    Check Deprication  ${resp}  Change Task Status to Rejected
    RETURN  ${resp}
...
Change Task Status to Pending
    ...
    Check Deprication  ${resp}  Change Task Status to Pending
    RETURN  ${resp}
...
Create Order With Service Options
    ...
    # Log  ${order} 
    ${resp}=  OrderItemByProvider   ${Cookie}   ${order}
    Check Deprication  ${resp}  Create Order With Service Options
    RETURN  ${resp}
...
Release Appmt Qnr For Consumer
    ...
    Check Deprication  ${resp}  Release Appmt Qnr For Consumer
    RETURN  ${resp}

Get Enquiry Internal Status
    Check And Create YNW Session
    ${resp}=   GET On Session  ynw   /provider/enquire/internalstatus    expected_status=any
    Check Deprication  ${resp}  Get Enquiry Internal Status
    RETURN  ${resp}
...
Update and Proceed Enquiry to Status
    ...
    Check Deprication  ${resp}  Update and Proceed Enquiry to Status
    RETURN  ${resp}
...
Reject Enquiry
    ...
    Check Deprication  ${resp}  Reject Enquiry
    RETURN  ${resp}  
...
AppmtEnableEditToConsumer
    ...
    Check Deprication  ${resp}  AppmtEnableEditToConsumer
    RETURN  ${resp}
...
Release Order Qnr For Consumer
    ...
    Check Deprication  ${resp}  Release Order Qnr For Consumer
    RETURN  ${resp}
...
OrderEnableEditToConsumer
    ...
    Check Deprication  ${resp}  OrderEnableEditToConsumer
    RETURN  ${resp}
...
Release Wl Qnr For Consumer
    ...
    Check Deprication  ${resp}  Release Wl Qnr For Consumer
    RETURN  ${resp}
...
WlEnableEditToConsumer
    ...
    Check Deprication  ${resp}  WlEnableEditToConsumer
    RETURN  ${resp}
...
Licensable Metrices
    ...
    Check Deprication  ${resp}  Licensable Metrices
    RETURN  ${resp}
...
Create Prescription Template
    ...
    Check Deprication  ${resp}  Create Prescription Template
    RETURN  ${resp}
...
Get Prescription Template
    ...
    Check Deprication  ${resp}  Get Prescription Template
    RETURN  ${resp}
...
Get Prescription Template By Id 
    ...
    Check Deprication  ${resp}  Get Prescription Template By Id 
    RETURN  ${resp}
...
Remove Template
    ...
    Check Deprication  ${resp}  Remove Template
    RETURN  ${resp}
...
Update Prescription Template
    ...
    Check Deprication  ${resp}  Update Prescription Template
    RETURN  ${resp}
...
Get Loan Application Category
    ...
    Check Deprication  ${resp}  Get Loan Application Category
    RETURN  ${resp}
...
Get Loan Application Type
    ...
    Check Deprication  ${resp}  Get Loan Application Type
    RETURN  ${resp}
...
Get Loan Application Status
    ...
    Check Deprication  ${resp}  Get Loan Application Status
    RETURN  ${resp}
...
Get Loan Application Sub-Status
    ...
    Check Deprication  ${resp}  Get Loan Application Sub-Status
    RETURN  ${resp}
...
Get Loan Application Product
    ...
    Check Deprication  ${resp}  Get Loan Application Product
    RETURN  ${resp}
...
Get Loan Application Scheme
    ...
    Check Deprication  ${resp}  Get Loan Application Scheme
    RETURN  ${resp}
...
Get Loan Application SP Internal Status
    ...
    Check Deprication  ${resp}  Get Loan Application SP Internal Status
    RETURN  ${resp}
...
Create Loan Application
    ...
    Check Deprication  ${resp}  Create Loan Application
    RETURN  ${resp}
...
Update Loan Application
    ...
    Check Deprication  ${resp}  Update Loan Application
    RETURN  ${resp}
...
Get Loan Application With Filter
    ...
    Check Deprication  ${resp}  Get Loan Application With Filter
    RETURN  ${resp}
...
Get Loan Application Count with filter
    ...
    Check Deprication  ${resp}  Get Loan Application Count with filter
    RETURN  ${resp}
...
Get Loan Application by loanApplicationRefNo
    ...
    Check Deprication  ${resp}  Get Loan Application by loanApplicationRefNo
    RETURN  ${resp}
...
Approval Loan Application
    ...
    Check Deprication  ${resp}  Approval Loan Application
    RETURN  ${resp}
...
Reject Loan Application
    ...
    Check Deprication  ${resp}  Reject Loan Application
    RETURN  ${resp}
...
Change Loan Application Status
    ...
    Check Deprication  ${resp}  Change Loan Application Status
    RETURN  ${resp}
...
Change Loan Application Sub-Status
    ...
    Check Deprication  ${resp}  Change Loan Application Sub-Status
    RETURN  ${resp}
...
Change Loan Application Status with sp
    ...
    Check Deprication  ${resp}  Change Loan Application Status with sp
    RETURN  ${resp}
...
Create Partner
    ...
    Check Deprication  ${resp}  Create Partner
    RETURN  ${resp}
...
Get Partner Category
    ...
    Check Deprication  ${resp}  Get Partner Category
    RETURN  ${resp}
...
Get Partner Type
    ...
    Check Deprication  ${resp}  Get Partner Type
    RETURN  ${resp}
...
Draft a Partner
    ...
    Check Deprication  ${resp}  Draft a Partner
    RETURN  ${resp}
...
Update Partner
    ...
    Check Deprication  ${resp}  Update Partner
    RETURN  ${resp}
...
Get Partner by UID
    ...
    Check Deprication  ${resp}  Get Partner by UID
    RETURN  ${resp}
...
Get Partner-With Filter
    ...
    Check Deprication  ${resp}  Get Partner-With Filter
    RETURN  ${resp}
...
Get Partner Count-With Filter 
    ...
    Check Deprication  ${resp}  Get Partner Count-With Filter 
    RETURN  ${resp}
...
Approved Partner
    ...
    Check Deprication  ${resp}  Approved Partner
    RETURN  ${resp}
...
Suspended Partner
    ...
    Check Deprication  ${resp}  Suspended Partner
    RETURN  ${resp}
...
Reject Partner
    ...
    Check Deprication  ${resp}  Reject Partner
    RETURN  ${resp}
...
Remove Assignee
    ...
    Check Deprication  ${resp}  Remove Assignee
    RETURN  ${resp}
...
Change Loan Assignee
    ...
    Check Deprication  ${resp}  Change Loan Assignee
    RETURN  ${resp}
...
Loan Application Approval
    ...
    Check Deprication  ${resp}  Loan Application Approval
    RETURN  ${resp}
...
Create Partner User
    ...
    Check Deprication  ${resp}  Create Partner User
    RETURN  ${resp}
...
Update Partner User
    ...
    Check Deprication  ${resp}  Update Partner User
    RETURN  ${resp}
...
Get Partner User
    ...
    Check Deprication  ${resp}  Get Partner User
    RETURN  ${resp}
...
Generate Loan Application Otp for Phone Number
    ...
    Check Deprication  ${resp}  Generate Loan Application Otp for Phone Number
    RETURN  ${resp}
...
Verify Phone Otp and Create Loan Application
    ...
    Check Deprication  ${resp}  Verify Phone Otp and Create Loan Application
    RETURN  ${resp}
...
Verify Phone and Create Loan Application with customer details
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/loanapplication/verify/${otp}/phone  data=${loan}  expected_status=any
    Check Deprication  ${resp}  Verify Phone and Create Loan Application with customer details
    RETURN  ${resp}
...
Generate Loan Application Otp for Email
    ...
    Check Deprication  ${resp}  Generate Loan Application Otp for Email
    RETURN  ${resp}
...
Verify Email Otp and Create Loan Application
    ...
    Check Deprication  ${resp}  Verify Email Otp and Create Loan Application
    RETURN  ${resp}
...
Requst For Aadhar Validation
    ...
    Check Deprication  ${resp}  Requst For Aadhar Validation
    RETURN  ${resp}
...
Requst For Pan Validation
    ...
    Check Deprication  ${resp}  Requst For Pan Validation
    RETURN  ${resp}
...
Add loan Bank Details
    ...
    Check Deprication  ${resp}  Add loan Bank Details
    RETURN  ${resp}
...
Update loan Bank Details
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/loanapplication/bank  data=${loan}  expected_status=any
    Check Deprication  ${resp}  Update loan Bank Details
    RETURN  ${resp}
...
Verify loan Bank
    ...
    Check Deprication  ${resp}  Verify loan Bank
    RETURN  ${resp}
...
Verify loan Details
    ...
    Check Deprication  ${resp}  Verify loan Details
    RETURN  ${resp}
...
Get loan Bank
    ...
    Check Deprication  ${resp}  Get loan Bank
    RETURN  ${resp}
...
Get loan Bank Details
    ...
    Check Deprication  ${resp}  Get loan Bank Details
    RETURN  ${resp}
...
Otp for Consumer Acceptance Phone
    ...
    Check Deprication  ${resp}  Otp for Consumer Acceptance Phone
    RETURN  ${resp}
...
Otp for Consumer Loan Acceptance Phone
    ...
    Check Deprication  ${resp}  Otp for Consumer Loan Acceptance Phone
    RETURN  ${resp}
...
Otp for Consumer Acceptance Email
    ...
    Check Deprication  ${resp}  Otp for Consumer Acceptance Email
    RETURN  ${resp}
...
Verify Otp for Consumer Acceptance Email
    ...
    Check Deprication  ${resp}  Verify Otp for Consumer Acceptance Email
    RETURN  ${resp}
...
Refresh loan Bank Details Aadhaar
    ...
    Check Deprication  ${resp}  Refresh loan Bank Details Aadhaar
    RETURN  ${resp}
...
Loan Application Action Required
    ...
    Check Deprication  ${resp}  Loan Application Action Required
    RETURN  ${resp}
...
Loan Application Action Completed
    ...
    Check Deprication  ${resp}  Loan Application Action Completed
    RETURN  ${resp}
...
Update loan Application Kyc Details
    ...
    Check Deprication  ${resp}  Update loan Application Kyc Details
    RETURN  ${resp}
...
Loan Application Manual Approval
    ...
    Check Deprication  ${resp}  Loan Application Manual Approval
    RETURN  ${resp}
...
Loan Approval
    ...
    Check Deprication  ${resp}  Loan Approval
    RETURN  ${resp}
...
Delete Loan Attachment
    ...
    Check Deprication  ${resp}  Delete Loan Attachment
    RETURN  ${resp}
...
Get User Available
    ...
    Check Deprication  ${resp}  Get User Available
    RETURN  ${resp}
...
Create Reminder
    ...
    Check Deprication  ${resp}  Create Reminder
    RETURN  ${resp}
...
Update Reminder
    ...
    Check Deprication  ${resp}  Update Reminder
    RETURN  ${resp}
...
Get Reminders
    ...
    Check Deprication  ${resp}  Get Reminders
    RETURN  ${resp}
...
Get Reminders With Filter
    ...
    Check Deprication  ${resp}  Get Reminders With Filter
    RETURN  ${resp}
...
Delete Reminder
   ...
   Check Deprication  ${resp}  Delete Reminder
    RETURN  ${resp}
...
LoanApplication Remark
    ...
    Check Deprication  ${resp}  LoanApplication Remark
    RETURN  ${resp}
...
Add General Notes
    ...
    Check Deprication  ${resp}  Add General Notes
    RETURN  ${resp}
...
Provider Get Appt Service Request
    ...
    Check Deprication  ${resp}  Provider Get Appt Service Request
    RETURN  ${resp}
...
Partner Approval Request
    ...
    Check Deprication  ${resp}  Partner Approval Request
    RETURN  ${resp}
...
Partner Approved
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/partner/${partnerUid}/approved    data=${data}  expected_status=any
    Check Deprication  ${resp}  Partner Approved
    RETURN  ${resp}
...
Create Scheme
    ...
    Check Deprication  ${resp}  Create Scheme
    RETURN  ${resp}
...
Update Scheme
    ...
    Check Deprication  ${resp}  Update Scheme
    RETURN  ${resp}
...
Get Loan Application By uid
    ...
    Check Deprication  ${resp}  Get Loan Application By uid
    RETURN  ${resp}
...
Update Sales Officer
    ...
    Check Deprication  ${resp}  Update Sales Officer
    RETURN  ${resp}
...
Update Credit Officer
    ...
    Check Deprication  ${resp}  Update Credit Officer
    RETURN  ${resp}
...
Activate Partner
    ...
    Check Deprication  ${resp}  Activate Partner
    RETURN  ${resp}
...
Get Default Capabilities
    ...
    Check Deprication  ${resp}  Get Default Capabilities
    RETURN  ${resp}
...
Get Default Roles With Capabilities
    ...
    Check Deprication  ${resp}  Get Default Roles With Capabilities
    RETURN  ${resp}
...
Update User With Roles And Scope
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/user/${id}   data=${data}  expected_status=any
    Check Deprication  ${resp}  Update User With Roles And Scope
    RETURN  ${resp}
...
Update Managers To user
    ...
    Check Deprication  ${resp}  Update Managers To user
    RETURN  ${resp}
...
Get Manager List of User
    ...
    Check Deprication  ${resp}  Get Manager List of User
    RETURN  ${resp}
...
Get User Scope By Id
    ...
    Check Deprication  ${resp}  Get User Scope By Id
    RETURN  ${resp}
...
Append User Scope
    ...
    Check Deprication  ${resp}  Append User Scope
    RETURN  ${resp}
...
Replace User Scope
    ...
    Check Deprication  ${resp}  Replace User Scope
    RETURN  ${resp}
...
Get Team Scope By Id
    ...
    Check Deprication  ${resp}  Get Team Scope By Id
    RETURN  ${resp}
...
Append Team Scope
    ...
    Check Deprication  ${resp}  Append Team Scope
    RETURN  ${resp}
...
Replace Team Scope
    ...
    Check Deprication  ${resp}  Replace Team Scope
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Enable Disable RBAC
#     RETURN  ${resp}
...
Get roles by id
    ...
    Check Deprication  ${resp}  Get roles by id
    RETURN  ${resp}
...
Update Role
    ...
    Check Deprication  ${resp}  Update Role
    RETURN  ${resp}
...
Restore role by id
    ...
    Check Deprication  ${resp}  Restore role by id
    RETURN  ${resp}
...
Enable Disable CDL RBAC
    ...
    Check Deprication  ${resp}  Enable Disable CDL RBAC
    RETURN  ${resp}
...
Enable Disable Main RBAC
    ...
    Check Deprication  ${resp}  Enable Disable Main RBAC
    RETURN  ${resp}
...
Create and Update Account level cdl setting
    ...
    Check Deprication  ${resp}  Create and Update Account level cdl setting
    RETURN  ${resp}
...
Get account level cdl setting
    ...
    Check Deprication  ${resp}  Get account level cdl setting
    RETURN  ${resp}
...
Get List of CDL Settings by filter
    ...
    Check Deprication  ${resp}  Get List of CDL Settings by filter
    RETURN  ${resp}
...
Get Count of CDL Settings by filter
    ...
    Check Deprication  ${resp}  Get Count of CDL Settings by filter
    RETURN  ${resp}
...
Create BranchMaster
    ...
    Check Deprication  ${resp}  Create BranchMaster
    RETURN  ${resp}
...
Update BranchMaster
    ...
    Check Deprication  ${resp}  Update BranchMaster
    RETURN  ${resp}
...
Get BranchMaster
    ...
    Check Deprication  ${resp}  Get BranchMaster
    RETURN  ${resp}
...
Get BranchMaster Count
    ...
    Check Deprication  ${resp}  Get BranchMaster Count
    RETURN  ${resp}
...
Get Branch By Id
    ...
    Check Deprication  ${resp}  Get Branch By Id
    RETURN  ${resp}
...
Change Branch Status
    ...
    Check Deprication  ${resp}  Change Branch Status
    RETURN  ${resp}
...
Enable Disable Branch
    ...
    Check Deprication  ${resp}  Enable Disable Branch
    RETURN  ${resp}
...
Enable Disable CDL
    ...
    Check Deprication  ${resp}  Enable Disable CDL
    RETURN  ${resp}
...
Get Draft LoanApplication
    ...
    Check Deprication  ${resp}  Get Draft LoanApplication
    RETURN  ${resp}
...
sales officer verification
    ...
    Check Deprication  ${resp}  sales officer verification
    RETURN  ${resp}
...
Partner Loan Application Action Required
    ...
    Check Deprication  ${resp}  Partner Loan Application Action Required
    RETURN  ${resp}
...
Get Loan Application ProductCategory
    ...
    Check Deprication  ${resp}  Get Loan Application ProductCategory
    RETURN  ${resp}
...
Get Loan Application ProductSubCategory
    ...
    Check Deprication  ${resp}  Get Loan Application ProductSubCategory
    RETURN  ${resp}
...
Loan Application Operational Approval
    ...
    Check Deprication  ${resp}  Loan Application Operational Approval
    RETURN  ${resp}
...
Generate Otp for Guarantor Phone
    ...
    Check Deprication  ${resp}  Generate Otp for Guarantor Phone
    RETURN  ${resp}
...
Verify Otp for Guarantor Phone
    ...
    Check Deprication  ${resp}  Verify Otp for Guarantor Phone
    RETURN  ${resp}
...
salesofficer Approval
    ...
    Check Deprication  ${resp}  salesofficer Approval
    RETURN  ${resp}
...
Partner Accepted
    ...
    Check Deprication  ${resp}  Partner Accepted
    RETURN  ${resp}
...
Get Avaliable Tenures
    ...
    Check Deprication  ${resp}  Get Avaliable Tenures
    RETURN  ${resp}
...
Get Avaliable Scheme
    ...
    Check Deprication  ${resp}  Get Avaliable Scheme
    RETURN  ${resp}
...
Assigning Branches to Users
    ...
    Check Deprication  ${resp}  Assigning Branches to Users
    RETURN  ${resp}
...
Get Loan EMI Details
    ...
    Check Deprication  ${resp}  Get Loan EMI Details
    RETURN  ${resp}
...
Get Address Relation Type
    ...
    Check Deprication  ${resp}  Get Address Relation Type
    RETURN  ${resp}
...
Account Aggregation
    ...
    Check Deprication  ${resp}  Account Aggregation
    RETURN  ${resp}
...
Get Account Aggregation
    ...
    Check Deprication  ${resp}  Get Account Aggregation
    RETURN  ${resp}
...
Generate CDL Dropdowns
    ...
    Check Deprication  ${resp}  Generate CDL Dropdowns
    RETURN  ${resp}
...
Cancel Loan Application
    ...
    Check Deprication  ${resp}  Cancel Loan Application
    RETURN  ${resp}
...
Generate Credit Score-MAFIL Score
    ...
    Check Deprication  ${resp}  Generate Credit Score-MAFIL Score
    RETURN  ${resp}
...
Add General Notes/Remarks
    ...
    Check Deprication  ${resp}  Add General Notes/Remarks
    RETURN  ${resp}
...
Send Message
    ...
    Check Deprication  ${resp}  Send Message
    RETURN  ${resp}
...
Get Communication Between Two UserTypes
    ...
    Check Deprication  ${resp}  Get Communication Between Two UserTypes
    RETURN  ${resp}
...
Get Full Communication Of User
    ...
    Check Deprication  ${resp}  Get Full Communication Of User
    RETURN  ${resp}
...
Change Read Status
    ...
    Check Deprication  ${resp}  Change Read Status
    RETURN  ${resp}
...
Enable Disable Item Group  
   ...
   Check Deprication  ${resp}  Enable Disable Item Group
    RETURN  ${resp}  
...
Create Item Group
    ...
    Check Deprication  ${resp}  Create Item Group
    RETURN  ${resp}
...
Update Item Group
    ...
    Check Deprication  ${resp}  Update Item Group
    RETURN  ${resp}
...
Get Item Group
    ...
    Check Deprication  ${resp}  Get Item Group
    RETURN  ${resp}
...
Get Item Group By Id
    ...
    Check Deprication  ${resp}  Get Item Group By Id
    RETURN  ${resp}
...
Delete Item Group By Id
    ...
    Check Deprication  ${resp}  Delete Item Group By Id
    RETURN  ${resp}
...
Delete Item Group Image 
    ...
    Check Deprication  ${resp}  Delete Item Group Image
    RETURN  ${resp}
...
Add Items To Item Group
    ...
    Check Deprication  ${resp}  Add Items To Item Group
    RETURN  ${resp}
...
Delete Items From Item Group
    ...
    Check Deprication  ${resp}  Delete Items From Item Group
    RETURN  ${resp}
...
Add Items To Multiple Item Group
    ...
    Check Deprication  ${resp}  Add Items To Multiple Item Group
    RETURN  ${resp}
...
Delete Items From Multiple Item Group
    ...
    Check Deprication  ${resp}  Delete Items From Multiple Item Group
    RETURN  ${resp}
...
Loan Application Branchapproval
    ...
    Check Deprication  ${resp}  Loan Application Branchapproval
    RETURN  ${resp}
...
Add Department Icon
    ...
    Check Deprication  ${resp}  Add Department Icon
    RETURN  ${resp}
...
Remove Department Icon
    ...
    Check Deprication  ${resp}  Remove Department Icon
    RETURN  ${resp}
...
Get Department Icon
    ...
    Check Deprication  ${resp}  Get Department Icon
    RETURN  ${resp}
...
Upload Cover Picture
    ...
    Check Deprication  ${resp}  Upload Cover Picture
    RETURN  ${resp}
...
Get Cover Picture
    ...
    Check Deprication  ${resp}  Get Cover Picture
    RETURN  ${resp}
...
Multi Factor Authentication
    ...
    Check Deprication  ${resp}  Multi Factor Authentication
    RETURN  ${resp}
...
Multi Factor Authentication ProviderLogin
    ...
    Check Deprication  ${resp}  Multi Factor Authentication ProviderLogin
    RETURN  ${resp}
...
Get Video Call Minutes 
    ...
    Check Deprication  ${resp}  Get Video Call Minutes
    RETURN  ${resp}
...
Create video Call Meeting Link
    ...
    Log  ${resp.content}
    Check Deprication  ${resp}  Create video Call Meeting Link
    RETURN  ${resp}
...
Get video Link Status 
    ...
    Log  ${resp.content}
    Check Deprication  ${resp}  Get video Link Status
    RETURN  ${resp}
...
Get video Status 
    ...
    Log  ${resp.content}
    Check Deprication  ${resp}  Get video Status
    RETURN  ${resp}
...
Update Virtual Calling Modes
    ...
    ${resp}=  PUT On Session  ynw  /provider/account/settings/virtualCallingModes   data=${data}  expected_status=any
    Log  ${resp.content}
    Check Deprication  ${resp}  Update Virtual Calling Modes
    RETURN  ${resp}
...
Provider Video Call ready
    ...
    Log  ${resp.content}
    Check Deprication  ${resp}  Provider Video Call ready
    RETURN  ${resp}
...
Apply Labels To Service
    ...
    Log  ${resp.content}
    Check Deprication  ${resp}  Apply Labels To Service
    RETURN  ${resp}
...
EmployeeLogin
    ...
    Check Deprication  ${resp}  EmployeeLogin
    RETURN  ${resp}
...
Create_IVR_Settings
    ...
    Check Deprication  ${resp}  Create_IVR_Settings
    RETURN  ${resp}
...
enable and disable IVR
    ...
    Check Deprication  ${resp}  enable and disable IVR
    RETURN  ${resp}
...
Incall IVR
    ...
    Check Deprication  ${resp}  Incall IVR
    RETURN  ${resp}
...
innode IVR 
    ...
    Check Deprication  ${resp}  innode IVR
    RETURN  ${resp}
...
Aftercall IVR
    ...
    Check Deprication  ${resp}  Aftercall IVR
    RETURN  ${resp}
...
Get Ivr Details By Filter
    ...
    Check Deprication  ${resp}  Get Ivr Details By Filter
    RETURN  ${resp}
...
create a call back
    ...
    Check Deprication  ${resp}  create a call back
    RETURN  ${resp}
...
Get Ivr By Uid
    ...
    Check Deprication  ${resp}  Get Ivr By Uid
    RETURN  ${resp}
...
Get IVR Count
    ...
    Check Deprication  ${resp}  Get IVR Count
    RETURN  ${resp}
...
Assign IVR User
    ...
    Check Deprication  ${resp}  Assign IVR User
    RETURN  ${resp}
...
Get Ivr By reference id
    ...
    Check Deprication  ${resp}  Get Ivr By reference id
    RETURN  ${resp}
...
Unassign IVR User
    ...
    Check Deprication  ${resp}  Unassign IVR User
    RETURN  ${resp}
...
Update User Availability
    ...
    Check Deprication  ${resp}  Update User Availability
    RETURN  ${resp}
...
Get IVR Setting
    ...
    Check Deprication  ${resp}  Get IVR Setting
    RETURN  ${resp}
...
Update IVR Settings
    ...
    Check Deprication  ${resp}  Update IVR Settings
    RETURN  ${resp}
...
IVR Request Call Back Token
    ...
    Check Deprication  ${resp}  IVR Request Call Back Token
    RETURN  ${resp}
...
IVR Remove Call Back Request
    ...
    Check Deprication  ${resp}  IVR Remove Call Back Request
    RETURN  ${resp}
...
Update IVR Call Status
    ...
    Check Deprication  ${resp}  Update IVR Call Status
    RETURN  ${resp}
...
Get IVR Graph Details
    ...
    Check Deprication  ${resp}  Get IVR Graph Details
    RETURN  ${resp}
...
Delete All IVR Records
    ...
    Check Deprication  ${resp}  Delete All IVR Records
    RETURN  ${resp}
...
Get IVR Users
    ...
    Check Deprication  ${resp}  Get IVR Users
    RETURN  ${resp}
...
Get IVR Before The Questionnaire
    ...
    Check Deprication  ${resp}  Get IVR Before The Questionnaire
    RETURN  ${resp}
...
Add Notes To IVR
    ...
    Check Deprication  ${resp}  Add Notes To IVR
    RETURN  ${resp}
...
Upload QNR File to Temp Location
    ...
    Check Deprication  ${resp}  Upload QNR File to Temp Location
    RETURN  ${resp}
...
Get IVR User Details
    ...
    Check Deprication  ${resp}  Get IVR User Details
    RETURN  ${resp}
...
Delete User Details
    ...
    Check Deprication  ${resp}  Delete User Details
    RETURN  ${resp}
...
Get All IVR User Details
    ...
    Check Deprication  ${resp}  Get All IVR User Details
    RETURN  ${resp}
...
Get IVR User Avaliability
    ...
    Check Deprication  ${resp}  Get IVR User Avaliability
    RETURN  ${resp}
...
Submit IVR Qnr
    ...
    Check Deprication  ${resp}  Submit IVR Qnr
    RETURN  ${resp}
...
Get All IVR Qnr
    ...
    Check Deprication  ${resp}  Get All IVR Qnr
    RETURN  ${resp}
...
IVR Change Release Status Of Questionnaire
    ...
    Check Deprication  ${resp}  IVR Change Release Status Of Questionnaire
    RETURN  ${resp}
...
Resubmit IVR Qnr
    ...
    Check Deprication  ${resp}  Resubmit IVR Qnr
    RETURN  ${resp}
...
Create Provider Schedule
    ...
    Check Deprication  ${resp}  Create Provider Schedule
    RETURN  ${resp}
...
Get all schedules of an account 
    ...
    Check Deprication  ${resp}  Get all schedules of an account
    RETURN  ${resp}
...
Update Provider Schedule
    ...
    Check Deprication  ${resp}  Update Provider Schedule
    RETURN  ${resp}
...
Get Scheduled Using Id
    ...
    Check Deprication  ${resp}  Get Scheduled Using Id
    RETURN  ${resp}
...
Enable And Disable A Schedule
    ...
    Check Deprication  ${resp}  Enable And Disable A Schedule
    RETURN  ${resp}
...
Get User-Specific Schedules 
    ...
    Check Deprication  ${resp}  Get User-Specific Schedules
    RETURN  ${resp}
...
IVR Update User Language
    ...
    Check Deprication  ${resp}  IVR Update User Language
    RETURN  ${resp}
...
Get Available Providers In A Time Range
    ...
    Check Deprication  ${resp}  Get Available Providers In A Time Range
    RETURN  ${resp}
...
Update Membership Service 
    ...
    Check Deprication  ${resp}  Update Membership Service
    RETURN  ${resp}
...
Enable Disable Membership service 
    ...
    Check Deprication  ${resp}  Enable Disable Membership service
    RETURN  ${resp}
...
Get Membership By Id
    ...
    Check Deprication  ${resp}  Get Membership By Id
    RETURN  ${resp}
...
Enable Disable Member Service 
    ...
    Check Deprication  ${resp}  Enable Disable Member Service
    RETURN  ${resp}
...
Get Membership Service Count
    ...
    Check Deprication  ${resp}  Get Membership Service Count
    RETURN  ${resp}
...
Get Member
    ...
    Check Deprication  ${resp}  Get Member
    RETURN  ${resp}
...
Approve Member 
    ...
    Check Deprication  ${resp}  Approve Member
    RETURN  ${resp}
...
Get Before Questionnaire Membership
    ...
    Check Deprication  ${resp}  Get Before Questionnaire Membership
    RETURN  ${resp}
...
Submit Member Qnr
    ...
    Check Deprication  ${resp}  Submit Member Qnr
    RETURN  ${resp}
...
Get All Member Questionnaire
    ...
    Check Deprication  ${resp}  Get All Member Questionnaire
    RETURN  ${resp}
...
Change Release Status Of Member Questionnaire
    ...
    Check Deprication  ${resp}  Change Release Status Of Member Questionnaire
    RETURN  ${resp}
...
Resubmit Member Questionnaire
    ...
    Check Deprication  ${resp}  Resubmit Member Questionnaire
    RETURN  ${resp}
...
Update Membership 
    ...
    Check Deprication  ${resp}  Update Membership
    RETURN  ${resp}
...
Get MemberService by Consumer
    ...
    Check Deprication  ${resp}  Get MemberService by Consumer
    RETURN  ${resp}
...
Member Creation From Provider Dashboard
    ...
    Check Deprication  ${resp}  Member Creation From Provider Dashboard
    RETURN  ${resp}
...
Submit Provider Member Qnr
    ...
    Check Deprication  ${resp}  Submit Provider Member Qnr
    RETURN  ${resp}
...
Resubmit Provider Member Qnr
    ...
    Check Deprication  ${resp}  Resubmit Provider Member Qnr
    RETURN  ${resp}
...
Get Provider Member Qnr
    ...
    Check Deprication  ${resp}  Get Provider Member Qnr
    RETURN  ${resp}
...
Enable Disable Jaldee Finance 
    ...
    Check Deprication  ${resp}  Enable Disable Jaldee Finance
    RETURN  ${resp}
...
Update Category
    ...
    Check Deprication  ${resp}  Update Category
    RETURN  ${resp}
...
Update Category Status
    ...
    Check Deprication  ${resp}  Update Category Status
    RETURN  ${resp}
...
Get Category By Id
    ...
    Check Deprication  ${resp}  Get Category By Id
    RETURN  ${resp}
...
Get Category With Filter
    ...
    Check Deprication  ${resp}  Get Category With Filter
    RETURN  ${resp}
...
Get Default Category By Type
    ...
    Check Deprication  ${resp}  Get Default Category By Type
    RETURN  ${resp}
...
Update default category by type
    ...
    Check Deprication  ${resp}  Update default category by type
    RETURN  ${resp}
...
Get Category By CategoryType
    ...
    Check Deprication  ${resp}  Get Category By CategoryType
    RETURN  ${resp}
...
Upload Finance Attachment
   ...
   Check Deprication  ${resp}  Upload Finance Attachment
    RETURN  ${resp}
...
Create Finance Status
    ...
    Check Deprication  ${resp}  Create Finance Status
    RETURN  ${resp}
...
Update Finance Status
    ...
    Check Deprication  ${resp}  Update Finance Status
    RETURN  ${resp}
...
Enable Disable Jaldee Finance Status
    ...
    Check Deprication  ${resp}  Enable Disable Jaldee Finance Status
    RETURN  ${resp}
...
Get Finance Status By Id
    ...
    Check Deprication  ${resp}  Get Finance Status By Id
    RETURN  ${resp}
...
Get Default Status
    ...
    Check Deprication  ${resp}  Get Default Status
    RETURN  ${resp}
...
Set default status
    ...
    Check Deprication  ${resp}  Set default status
    RETURN  ${resp}
...
Create Expense
    ...
    Check Deprication  ${resp}  Create Expense
    RETURN  ${resp}
...
Update Expense
    ...
    Check Deprication  ${resp}  Update Expense
    RETURN  ${resp}
...
Get Expense By Id
    ...
    Check Deprication  ${resp}  Get Expense By Id
    RETURN  ${resp}
...
Get Expense With Filter
    ...
    Check Deprication  ${resp}  Get Expense With Filter
    RETURN  ${resp}
...
Update Expense Status
    ...
    Check Deprication  ${resp}  Update Expense Status
    RETURN  ${resp}
...
Get Expense Count With Filter
    ...
    Check Deprication  ${resp}  Get Expense Count With Filter
    RETURN  ${resp}

Get Expense Without Filter 
    Check And Create YNW Session
    ${resp}=  GET On Session  ynw  /provider/jp/finance/expense        expected_status=any
    Check Deprication  ${resp}  Get Expense Without Filter
    RETURN  ${resp}
...
Upload Finance Expense Attachment
    ...
    Check Deprication  ${resp}  Upload Finance Expense Attachment
    RETURN  ${resp}
...
Create Invoice
    ...
    Check Deprication  ${resp}  Create Invoice
    RETURN  ${resp}
...
Update Invoice
    ...
    Check Deprication  ${resp}  Update Invoice
    RETURN  ${resp}
...
Get Invoice By Id
    ...
    Check Deprication  ${resp}  Get Invoice By Id
    RETURN  ${resp}
...
Get Date Time by Timezone
    ...
    Check Deprication  ${resp}  Get Date Time by Timezone
    RETURN  ${resp}
...
Get Invoice Count With Filter
    ...
    Check Deprication  ${resp}  Get Invoice Count With Filter
    RETURN  ${resp}
...
Assign User
    ...
    Check Deprication  ${resp}  Assign User
    RETURN  ${resp}
...
UnAssign User
    ...
    Check Deprication  ${resp}  UnAssign User
    RETURN  ${resp}
...
Upload Finance Invoice Attachment
   ...
   Check Deprication  ${resp}  Upload Finance Invoice Attachment
    RETURN  ${resp}
...
Create PaymentsOut
    ...
    Check Deprication  ${resp}  Create PaymentsOut
    RETURN  ${resp}
...
Create PaymentsOut With Expense
    ...
    Check And Create YNW Session
    ${resp}=    POST On Session    ynw    /provider/jp/finance/paymentsOut    data=${data}  expected_status=any    headers=${headers}
    Check Deprication  ${resp}  Create PaymentsOut With Expense
    RETURN  ${resp}
...
Get PaymentsOut By Id
    ...
    Check Deprication  ${resp}  Get PaymentsOut By Id
    RETURN  ${resp}
...
Get PaymentsOut With Filter
    ...
    Check Deprication  ${resp}  Get PaymentsOut With Filter
    RETURN  ${resp}
...
Get PaymentsOut Count With Filter
    ...
    Check Deprication  ${resp}  Get PaymentsOut Count With Filter
    RETURN  ${resp}
...
Upload Finance PaymentsOut Attachment
   ...
   Check Deprication  ${resp}  Upload Finance PaymentsOut Attachment
    RETURN  ${resp}
...
Update PaymentsOut Status
    ...
    Check Deprication  ${resp}  Update PaymentsOut Status
    RETURN  ${resp}
...
Create CDL Enquiry
    ...
    Check Deprication  ${resp}  Create CDL Enquiry
    RETURN  ${resp}
...
Draft Loan Application
    ...
    Check Deprication  ${resp}  Draft Loan Application
    RETURN  ${resp}
...
Save Customer Details 
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw   /provider/loanapplication/${loanuid}   data=${data}  expected_status=any
    Check Deprication  ${resp}  Save Customer Details
    RETURN  ${resp}  
...
Equifax Report 
    ...
    Check Deprication  ${resp}  Equifax Report
    RETURN  ${resp}  
...
MAFIL Score
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw   /provider/loanapplication/csms/generatescore   data=${data}  expected_status=any
    Check Deprication  ${resp}  MAFIL Score
    RETURN  ${resp}
...
Cibil Score
    ...
    Check Deprication  ${resp}  Cibil Score
    RETURN  ${resp}

Retain Rejected Loan Application
    ...
    Check Deprication  ${resp}  Retain Rejected Loan Application
    RETURN  ${resp}
...
Perfios Score
    ...
    Check Deprication  ${resp}  Perfios Score
    RETURN  ${resp} 
...
Get status count
    ...
    Check Deprication  ${resp}  Get status count
    RETURN  ${resp}
...
Get status list filter
    ...
    Check Deprication  ${resp}  Get status list filter
    RETURN  ${resp}
...
Update default status
    ...
    Check Deprication  ${resp}  Update default status
    RETURN  ${resp}
# -------------- Patient Records-----------
...
Add Patient Medical History
    ...
    Check Deprication  ${resp}  Add Patient Medical History
    RETURN  ${resp}
...
Update Patient Medical History
    ...
    Check Deprication  ${resp}  Update Patient Medical History
    RETURN  ${resp}
...
Delete Patient Medical History
    ...
    Check Deprication  ${resp}  Delete Patient Medical History
    RETURN  ${resp}
...
Get Patient Medical History
    ...
    Check Deprication  ${resp}  Get Patient Medical History
    RETURN  ${resp}
...
Provider Consumer Add Notes
    ...
    Check Deprication  ${resp}  Provider Consumer Add Notes
    RETURN  ${resp}
...
Update Provider Consumer Notes
    ...
    Check Deprication  ${resp}  Update Provider Consumer Notes
    RETURN  ${resp}
...
Delete Provider Consumer Notes
    ...
    Check Deprication  ${resp}  Delete Provider Consumer Notes
    RETURN  ${resp}
...
Get Provider Consumer Notes
    ...
    Check Deprication  ${resp}  Get Provider Consumer Notes
    RETURN  ${resp}  
...
Update DentalRecord
    ...
    Check Deprication  ${resp}  Update DentalRecord
    RETURN  ${resp}
...
Update DentalRecord Status
    ...
    Check Deprication  ${resp}  Update DentalRecord Status
    RETURN  ${resp}
...
Get DentalRecord ByProviderConsumerId
    ...
    Check Deprication  ${resp}  Get DentalRecord ByProviderConsumerId
    RETURN  ${resp}
...
Get DentalRecord ByCaseId
    ...
    Check Deprication  ${resp}  Get DentalRecord ByCaseId
    RETURN  ${resp}
...
Create Case Category
    ...
    Check Deprication  ${resp}  Create Case Category
    RETURN  ${resp}
...
Get Case Category
    ...
    Check Deprication  ${resp}  Get Case Category
    RETURN  ${resp}
...
Create Case Type
    ...
    Check Deprication  ${resp}  Create Case Type
    RETURN  ${resp}
...
Get Case Type
    ...
    Check Deprication  ${resp}  Get Case Type
    RETURN  ${resp}
...
Update MR Case
    ...
    Check Deprication  ${resp}  Update MR Case
    RETURN  ${resp}
...
Get Case Filter
    ...
    Check Deprication  ${resp}  Get Case Filter
    RETURN  ${resp}
...
Change Case Status
    ...
    Check Deprication  ${resp}  Change Case Status
    RETURN  ${resp}
...
Get Case Count Filter
    ...
    Check And Create YNW Session
    ${resp}=    GET On Session    ynw   /provider/medicalrecord/case     params=${kwargs}   expected_status=any
    Check Deprication  ${resp}  Get Case Count Filter
    RETURN  ${resp}
...
Update Treatment Plan
    ...
    Check Deprication  ${resp}  Update Treatment Plan
    RETURN  ${resp}
...
Update Treatment Plan Work status
    ...
    Check Deprication  ${resp}  Update Treatment Plan Work status
    RETURN  ${resp}
...
Update Work list in Treatment Plan
    ...
    Check Deprication  ${resp}  Update Work list in Treatment Plan
    RETURN  ${resp}
...
Get Treatment Plan By Id
    ...
    Check Deprication  ${resp}  Get Treatment Plan By Id
    RETURN  ${resp}
...
Delete Treatment Plan Work By id
    ...
    Check Deprication  ${resp}  Delete Treatment Plan Work By id
    RETURN  ${resp}
...
Get Prescription Template By Account Id
    ...
    Check Deprication  ${resp}  Get Prescription Template By Account Id
    RETURN  ${resp}
...
Update Prescription 
    ...
    Check Deprication  ${resp}  Update Prescription 
    RETURN  ${resp}
...
Get Prescription By Filter
    ...
    Check Deprication  ${resp}  Get Prescription By Filter
    RETURN  ${resp}
...
Update MR Sections
    ...
    Check Deprication  ${resp}  Update MR Sections
    RETURN  ${resp}
...
Get Sections Filter
    ...
    Check Deprication  ${resp}  Get Sections Filter
    RETURN  ${resp}
...
Get Treatment Plan By ProviderConsumer Id
    ...
    Check Deprication  ${resp}  Get Treatment Plan By ProviderConsumer Id
    RETURN  ${resp}
...
Get Treatment Plan By Dental Id
    ...
    Check Deprication  ${resp}  Get Treatment Plan By Dental Id
    RETURN  ${resp}
...
Auto Invoice Generation For Catalog
    ...
    Check Deprication  ${resp}  Auto Invoice Generation For Catalog
    RETURN  ${resp}
...
Auto Invoice Generation For Service
    ...
    Check Deprication  ${resp}  Auto Invoice Generation For Service
    RETURN  ${resp}
...
Create PaymentsIn
    ...
    Check Deprication  ${resp}  Create PaymentsIn
    RETURN  ${resp}
...
Update PaymentsIn
    ...
    Check Deprication  ${resp}  Update PaymentsIn
    RETURN  ${resp}
...
Get PaymentsIn By Id
    ...
    Check Deprication  ${resp}  Get PaymentsIn By Id
    RETURN  ${resp}
...
Get PaymentsIn With Filter
    ...
    Check Deprication  ${resp}  Get PaymentsIn With Filter
    RETURN  ${resp}
...
Get PaymentsIn Count With Filter
    ...
    Check Deprication  ${resp}  Get PaymentsIn Count With Filter
    RETURN  ${resp}
...
Update PaymentsIn Status
    ...
    Check Deprication  ${resp}  Update PaymentsIn Status
    RETURN  ${resp}
...
Get PaymentsOut Log List UId
    ...
    Check Deprication  ${resp}  Get PaymentsOut Log List UId
    RETURN  ${resp}
...
Get PaymentsIn Log List UId
    ...
    Check Deprication  ${resp}  Get PaymentsIn Log List UId
    RETURN  ${resp}
...
Upload Finance PaymentsIn Attachment
   ...
   Check Deprication  ${resp}  Upload Finance PaymentsIn Attachment
    RETURN  ${resp}
...
Generate Link For Invoice
    ...
    Check Deprication  ${resp}  Generate Link For Invoice
    RETURN  ${resp}
...
Apply Discount
    ...
    Check Deprication  ${resp}  Apply Discount
    RETURN  ${resp}
...
Apply Provider Coupon
    ...
    Check Deprication  ${resp}  Apply Provider Coupon
    RETURN  ${resp}
...
Apply Service Level Discount
    ...
    Check Deprication  ${resp}  Apply Service Level Discount
    RETURN  ${resp}
...
Remove Discount
    ...
    Check Deprication  ${resp}  Remove Discount
    RETURN  ${resp}
...
Remove Provider Coupon
    ...
    Check Deprication  ${resp}  Remove Provider Coupon
    RETURN  ${resp}
...
Update Invoice Service
    ...
    Check Deprication  ${resp}  Update Invoice Service
    RETURN  ${resp}
...
Remove Service Level Discount
    ...
    Check Deprication  ${resp}  Remove Service Level Discount
    RETURN  ${resp}
...
Update Invoice Items
    ...
    Check Deprication  ${resp}  Update Invoice Items
    RETURN  ${resp}
...
Apply Item Level Discount
    ...
    Check Deprication  ${resp}  Apply Item Level Discount
    RETURN  ${resp}
...
Remove Item Level Discount
    ...
    Check Deprication  ${resp}  Remove Item Level Discount
    RETURN  ${resp}
...
Update Bill Status
    ...
    Check Deprication  ${resp}  Update Bill Status
    RETURN  ${resp}
...
Apply Provider Coupon for waitlist
    ...
    Check Deprication  ${resp}  Apply Provider Coupon for waitlist
    RETURN  ${resp}
...
Remove Provider Coupon for waitlist
    ...
    Check Deprication  ${resp}  Remove Provider Coupon for waitlist
    RETURN  ${resp}
...
Apply Service Level Discount for waitlist
    ...
    Check Deprication  ${resp}  Apply Service Level Discount for waitlist
    RETURN  ${resp}
...
Remove Service Level Discount for waitlist
    ...
    Check Deprication  ${resp}  Remove Service Level Discount for waitlist
    RETURN  ${resp}
...
Get Invoice Log List UId
    ...
    Check Deprication  ${resp}  Get Invoice Log List UId
    RETURN  ${resp}
...
Update bill view status
    ...
    Check Deprication  ${resp}  Update bill view status
    RETURN  ${resp}
...
Share invoice as pdf 
    ...
    Check Deprication  ${resp}  Share invoice as pdf
    RETURN  ${resp}
...
Apply Jaldee Coupon for waitlist
    ...
    Check Deprication  ${resp}  Apply Jaldee Coupon for waitlist
    RETURN  ${resp}
...
Remove Jaldee Coupon for waitlist
    ...
    Check Deprication  ${resp}  Remove Jaldee Coupon for waitlist
    RETURN  ${resp}
...
Get Waitlist level Bill Details
    ...
    Check Deprication  ${resp}  Get Waitlist level Bill Details
    RETURN  ${resp}
...
Apply Jaldee Coupon for Appointment
    ...
    Check Deprication  ${resp}  Apply Jaldee Coupon for Appointment
    RETURN  ${resp}
...
Remove Jaldee Coupon for Appointment
    ...
    Check Deprication  ${resp}  Remove Jaldee Coupon for Appointment
    RETURN  ${resp}
...
Apply Provider Coupon for Appointment
    ...
    Check Deprication  ${resp}  Apply Provider Coupon for Appointment
    RETURN  ${resp}
...
Remove Provider Coupon for Appointment
    ...
    Check Deprication  ${resp}  Remove Provider Coupon for Appointment
    RETURN  ${resp}
...
Apply Service Level Discount for Appointment
    ...
    Check Deprication  ${resp}  Apply Service Level Discount for Appointment
    RETURN  ${resp}
...
Remove Service Level Discount for Appointment
    ...
    Check Deprication  ${resp}  Remove Service Level Discount for Appointment
    RETURN  ${resp}
...
Get Category List Configuration
    ...
    Check Deprication  ${resp}  Get Category List Configuration
    RETURN  ${resp}
...
Copy Category Status List Configuration
    ...
    Check Deprication  ${resp}  Copy Category Status List Configuration
    RETURN  ${resp}
...
Get Status List Configuration
    ...
    Check Deprication  ${resp}  Get Status List Configuration
    RETURN  ${resp}
...
Get finance Config
    ...
    Check Deprication  ${resp}  Get finance Config
    RETURN  ${resp}
...
Get default finance category Config
    ...
    Check Deprication  ${resp}  Get default finance category Config
    RETURN  ${resp}
...
Apply Discount for Order
    ...
    Check Deprication  ${resp}  Apply Discount for Order
    RETURN  ${resp}
...
Remove Discount for Order
    ...
    Check Deprication  ${resp}  Remove Discount for Order
    RETURN  ${resp}
...
Apply Jaldee Coupon for Order
    ...
    Check Deprication  ${resp}  Apply Jaldee Coupon for Order
    RETURN  ${resp}
...
Remove Jaldee Coupon for Order
    ...
    Check Deprication  ${resp}  Remove Jaldee Coupon for Order
    RETURN  ${resp}
...
Apply Provider Coupon for Order
    ...
    Check Deprication  ${resp}  Apply Provider Coupon for Order
    RETURN  ${resp}
...
Remove Provider Coupon for Order
    ...
    Check Deprication  ${resp}  Remove Provider Coupon for Order
    RETURN  ${resp}
...
Get Order level Bill Details
    ...
    Check Deprication  ${resp}  Get Order level Bill Details
    RETURN  ${resp}
...
Make Payment By Cash 
    ...
    Check Deprication  ${resp}  Make Payment By Cash 
    RETURN  ${resp}
...
Make Payment By Cash For Invoice
    ...
    Check Deprication  ${resp}  Make Payment By Cash For Invoice
    RETURN  ${resp}
...
Update Invoice Status
    ...
    Check Deprication  ${resp}  Update Invoice Status
    RETURN  ${resp}
...
Get next invoice Id
    ...
    Check Deprication  ${resp}  Get next invoice Id
    RETURN  ${resp}
...
Validate phone number
    ...
    Check Deprication  ${resp}  Validate phone number
    RETURN  ${resp}    
...
Create Invoice for Booking
    ...
    Check Deprication  ${resp}  Create Invoice for Booking
    RETURN  ${resp}    
...
Update cash payment- finance invoice level
    ...
    Check Deprication  ${resp}  Update cash payment- finance invoice level
    RETURN  ${resp}
...
Update cash payment- booking level
    ...
    Check Deprication  ${resp}  Update cash payment- booking level
    RETURN  ${resp}
...
Create Lead Status LOS
    ...
    Check Deprication  ${resp}  Create Lead Status LOS
    RETURN  ${resp}
...
Get Lead Status by id LOS
    ...
    Check Deprication  ${resp}  Get Lead Status by id LOS
    RETURN  ${resp}
...
Update Lead Status LOS
    ...
    Check Deprication  ${resp}  Update Lead Status LOS
    RETURN  ${resp}
...
Get Lead Status LOS
    ...
    Check Deprication  ${resp}  Get Lead Status LOS
    RETURN  ${resp}
...
Create Lead Progress LOS
    ...
    Check Deprication  ${resp}  Create Lead Progress LOS
    RETURN  ${resp}
...
Get Lead Progress by id LOS
    ...
    Check Deprication  ${resp}  Get Lead Progress by id LOS
    RETURN  ${resp}
...
Update Lead Progress LOS
    ...
    Check Deprication  ${resp}  Update Lead Progress LOS
    RETURN  ${resp}
...
Get Lead Progress LOS
    ...
    Check Deprication  ${resp}  Get Lead Progress LOS
    RETURN  ${resp}
...
Create Lead Credit Status LOS 
    ...
    Check Deprication  ${resp}  Create Lead Credit Status LOS 
    RETURN  ${resp}
...
Get Lead Credit Status by id LOS
    ...
    Check Deprication  ${resp}  Get Lead Credit Status by id LOS
    RETURN  ${resp}
...
Update Lead Credit Status LOS
    ...
    Check Deprication  ${resp}  Update Lead Credit Status LOS
    RETURN  ${resp}
...
Get Lead Credit Status LOS
    ...
    Check Deprication  ${resp}  Get Lead Credit Status LOS
    RETURN  ${resp}
...
#     Check Deprication  ${resp}  Create Lead LOS
#     RETURN  ${resp}
...
Get Lead LOS 
    ...
    Check Deprication  ${resp}  Get Lead LOS 
    RETURN  ${resp}
...
Updtae Lead LOS    
    ...
    Check Deprication  ${resp}  Updtae Lead LOS 
    RETURN  ${resp}
...
Get Lead By Filter LOS
    ...
    Check Deprication  ${resp}  Get Lead By Filter LOS
    RETURN  ${resp}
...
Get Lead Count By Filter LOS
    ...
    Check Deprication  ${resp}  Get Lead Count By Filter LOS
    RETURN  ${resp}
...
Change Lead Status LOS
    ...
    Check Deprication  ${resp}  Change Lead Status LOS
    RETURN  ${resp}
...
Change Lead Credit Status LOS
    ...
    Check Deprication  ${resp}  Change Lead Credit Status LOS
    RETURN  ${resp}
...
Change Lead Progress LOS
    ...
    Check Deprication  ${resp}  Change Lead Progress LOS
    RETURN  ${resp}
...
update lead assignees LOS    
    ...
    Check Deprication  ${resp}  update lead assignees LOS
    RETURN  ${resp}
...
Generate CIBIL LOS   
    ...
    Check Deprication  ${resp}  Generate CIBIL LOS
    RETURN  ${resp}
...
Generate EQUIFAX LOS
    ...
    Check Deprication  ${resp}  Generate EQUIFAX LOS
    RETURN  ${resp}
...
Generate Loan Application LOS
    ...
    Check Deprication  ${resp}  Generate Loan Application LOS
    RETURN  ${resp}
...
AddItemToInvoice
   ...
   Check Deprication  ${resp}  AddItemToInvoice
    RETURN  ${resp} 
...
AddServiceToInvoice
   ...
   Check Deprication  ${resp}  AddServiceToInvoice
    RETURN  ${resp} 
...
RemoveServiceFromInvoice
   ...
   Check Deprication  ${resp}  RemoveServiceFromInvoice
    RETURN  ${resp} 
...
RemoveItemFromInvoice
   ...
   Check Deprication  ${resp}  RemoveItemFromInvoice
    RETURN  ${resp} 
...
GetFollowUpDetailsofwl
    ...
    Check Deprication  ${resp}  GetFollowUpDetailsofwl
    RETURN  ${resp}
...
Send Attachment From Waitlist 
    ...
    Check Deprication  ${resp}  Send Attachment From Waitlist
    RETURN  ${resp}
...
Get Attachments In Waitlist
    ...
    Check Deprication  ${resp}  Get Attachments In Waitlist
    RETURN  ${resp}
...
Get Attachments In Appointment
    ...
    Check Deprication  ${resp}  Get Attachments In Appointment
    RETURN  ${resp}
...
Get Donation Attachments
    ...
    Check Deprication  ${resp}  Get Donation Attachments
    RETURN  ${resp}
...
Get Order Attachments
    ...
    Check Deprication  ${resp}  Get Order Attachments
    RETURN  ${resp}
...
Send Message With Waitlist
    ...
    Check Deprication  ${resp}  Send Message With Waitlist
    RETURN  ${resp}
...
Send Message With Order
    ...
    Check Deprication  ${resp}  Send Message With Order
    RETURN  ${resp}
...
Send Message With Donation
    ...
    Check Deprication  ${resp}  Send Message With Donation
    RETURN  ${resp}
...
Broadcast Message to customers
    ...
    Check Deprication  ${resp}  Broadcast Message to customers
    RETURN  ${resp}
...
Send Message to Multiple Customers
    ...
    Check Deprication  ${resp}  Send Message to Multiple Customers
    RETURN  ${resp}
...
Send Message By Chat
    ...
    Check Deprication  ${resp}  Send Message By Chat
    RETURN  ${resp}
...
GET Queue Availability By Location AND Service
    ...
    Check Deprication  ${resp}  GET Queue Availability By Location AND Service
    RETURN  ${resp}
...
GET Queue Availability By Location, Service and Date
    ...
    Check Deprication  ${resp}  GET Queue Availability By Location, Service and Date
    RETURN  ${resp}
...
Enable Disable Notification 
    ...
    Check Deprication  ${resp}  Enable Disable Notification
    RETURN  ${resp}
...
Enable Disable whatsApp 
    ...
    Check Deprication  ${resp}  Enable Disable whatsApp
    RETURN  ${resp}
...
Get Bill Settings
    ...
    Check Deprication  ${resp}  Get Bill Settings
    RETURN  ${resp}
...
Enable Disable bill
    ...
    Check Deprication  ${resp}  Enable Disable bill
    RETURN  ${resp}
...
AddOrUpdate UserStyle
    ...
    Check Deprication  ${resp}  AddOrUpdate UserStyle
    RETURN  ${resp}
...
AddOrUpdate DashboardStyle
    ...
    Check Deprication  ${resp}  AddOrUpdate DashboardStyle
    RETURN  ${resp}
...
Get StyleConfig
    ...
    Check Deprication  ${resp}  Get StyleConfig
    RETURN  ${resp}
...
Get LastManualIdOfcustomer
    ...
    Check Deprication  ${resp}  Get LastManualIdOfcustomer
    RETURN  ${resp}
...
Create Template Config
    ...
    Check Deprication  ${resp}  Create Template Config
    RETURN  ${resp}
...
Update Template Config
    ...
    Check Deprication  ${resp}  Update Template Config
    RETURN  ${resp}
...
Get Template By Uid
    ...
    Check Deprication  ${resp}  Get Template By Uid
    RETURN  ${resp}
...
Get Templates By Account
    ...
    Check Deprication  ${resp}  Get Templates By Account
    RETURN  ${resp}
...
Get default domain templates
    ...
    Check Deprication  ${resp}  Get default domain templates
    RETURN  ${resp}
...
Get Account default template for the Type specified 
    ...
    Check Deprication  ${resp}  Get Account default template for the Type specified 
    RETURN  ${resp}
...
Remove Template By Uid
    ...
    Check Deprication  ${resp}  Remove Template By Uid
    RETURN  ${resp}
...
Enable Disable Provider Consent Form 
    ...
    Check Deprication  ${resp}  Enable Disable Provider Consent Form 
    RETURN  ${resp}
...
Create Provider Consent Form Settings 
    ...
    Check Deprication  ${resp}  Create Provider Consent Form Settings 
    RETURN  ${resp}
...
Update Provider Consent Form Settings
    ...
    Check Deprication  ${resp}  Update Provider Consent Form Settings
    RETURN  ${resp}
...
Get Provider Consent Form Settings
    ...
    Check Deprication  ${resp}  Get Provider Consent Form Settings
    RETURN  ${resp}
...
Get Provider Consent Form Settings By Id
    ...
    Check Deprication  ${resp}  Get Provider Consent Form Settings By Id
    RETURN  ${resp}
...
Update Provider Consent Form Settings Status
    ...
    Check Deprication  ${resp}  Update Provider Consent Form Settings Status
    RETURN  ${resp}
...
Share Consent Form     
    ...
    Check Deprication  ${resp}  Share Consent Form
    RETURN  ${resp}
...
Get Consent Form By Uid  
    ...
    Check Deprication  ${resp}  Get Consent Form By Uid
    RETURN  ${resp}
...
Get Consent Form By Provider Consumer Id
    ...
    Check Deprication  ${resp}  Get Consent Form By Provider Consumer Id
    RETURN  ${resp}
...
Get Verify Status of consent form by uid
    ...
    Check Deprication  ${resp}  Get Verify Status of consent form by uid
    RETURN  ${resp}
...
Consent Form Send Otp 
    ...
    Check Deprication  ${resp}  Consent Form Send Otp
    RETURN  ${resp}
...
Consent Form Verify Otp
    ...
    Check Deprication  ${resp}  Consent Form Verify Otp
    RETURN  ${resp}
...
Consent Form Verify Sign  
    ...
    Check Deprication  ${resp}  Consent Form Verify Sign
    RETURN  ${resp}
...
Provider Consent Form Submit Qnr
    ...
    Check Deprication  ${resp}  Provider Consent Form Submit Qnr
    RETURN  ${resp}
...
Provider Consent Form Resubmit Qnr
    ...
    Check Deprication  ${resp}  Provider Consent Form Resubmit Qnr
    RETURN  ${resp}
...
Provider Consent Form Get released questionnaire by uuid
    ...
    Check Deprication  ${resp}  Provider Consent Form Get released questionnaire by uuid
    RETURN  ${resp}
...
Get Item Category
    ...
    Check Deprication  ${resp}  Get Item Category
    RETURN  ${resp}
...
Update Item Category
    ...
    Check Deprication  ${resp}  Update Item Category
    RETURN  ${resp}  
...
Update Item Category Status
    ...
    Check Deprication  ${resp}  Update Item Category Status
    RETURN  ${resp}  
...
Get Item Type
    ...
    Check Deprication  ${resp}  Get Item Type
    RETURN  ${resp}
...
Update Item Type
    ...
    Check Deprication  ${resp}  Update Item Type
    RETURN  ${resp}  
...
Update Item Type Status
    ...
    Check Deprication  ${resp}  Update Item Type Status
    RETURN  ${resp}  
...
Get store Count
    ...
    Check Deprication  ${resp}  Get store Count
    RETURN  ${resp}
...
Get Item Manufacture By Id
    ...
    Check Deprication  ${resp}  Get Item Manufacture By Id
    RETURN  ${resp}
...
Update Item Manufacture
    ...
    Check Deprication  ${resp}  Update Item Manufacture
    RETURN  ${resp} 
...
Update Item Manufacture Status
    ...
    Check Deprication  ${resp}  Update Item Manufacture Status
    RETURN  ${resp}
...
Get Item Manufacture Count Filter
    ...
    Check Deprication  ${resp}  Get Item Manufacture Count Filter
    RETURN  ${resp}
...
Create Item Tax
    ...
    Check Deprication  ${resp}  Create Item Tax
    RETURN  ${resp} 
...
Get Item Tax by id
    ...
    Check Deprication  ${resp}  Get Item Tax by id
    RETURN  ${resp}
...
Update Item Tax
    ...
    Check Deprication  ${resp}  Update Item Tax
    RETURN  ${resp} 
...
Update Item Tax Status
    ...
    Check Deprication  ${resp}  Update Item Tax Status
    RETURN  ${resp}
...
Get Item Tax Count Filter
    ...
    Check Deprication  ${resp}  Get Item Tax Count Filter
    RETURN  ${resp}
...
Get Item Unit by id
    ...
    Check Deprication  ${resp}  Get Item Unit by id
    RETURN  ${resp}
...
Update Item Unit
    ...
    Check Deprication  ${resp}  Update Item Unit
    RETURN  ${resp} 
...
Update Item Unit Status
    ...
    Check Deprication  ${resp}  Update Item Unit Status
    RETURN  ${resp}
...
Get Item Composition by id
    ...
    Check Deprication  ${resp}  Get Item Composition by id
    RETURN  ${resp}
...
Update Item Composition
    ...
    Check Deprication  ${resp}  Update Item Composition
    RETURN  ${resp} 
...
Update Item Composition Status
    ...
    Check Deprication  ${resp}  Update Item Composition Status
    RETURN  ${resp}
...
Get Item hns by id
    ...
    Check Deprication  ${resp}  Get Item hns by id
    RETURN  ${resp}
...
Update Item hns
    ...
    Check Deprication  ${resp}  Update Item hns
    RETURN  ${resp} 
...
Update Item hns Status
    ...
    Check Deprication  ${resp}  Update Item hns Status
    RETURN  ${resp}
...
Get Item hns Count Filter
    ...
    Check Deprication  ${resp}  Get Item hns Count Filter
    RETURN  ${resp}
...
Get Item group by id Provider
    ...
    Check Deprication  ${resp}  Get Item group by id Provider
    RETURN  ${resp}
...
Update Item group Provider
    ...
    Check Deprication  ${resp}  Update Item group Provider
    RETURN  ${resp} 
...
Get Item group Filter
    ...
    Check Deprication  ${resp}  Get Item group Filter
    RETURN  ${resp}
...
Update Item group Status
    ...
    Check Deprication  ${resp}  Update Item group Status
    RETURN  ${resp}
...
Get Item group Count Filter
    ...
    Check Deprication  ${resp}  Get Item group Count Filter
    RETURN  ${resp}
...
Update Item Inventory
    ...
    Check Deprication  ${resp}  Update Item Inventory
    RETURN  ${resp}
...
Get Item inv Filter
    ...
    Check Deprication  ${resp}  Get Item inv Filter
    RETURN  ${resp}
...
Update Item Inv Status
    ...
    Check Deprication  ${resp}  Update Item Inv Status
    RETURN  ${resp}
...
Get Item inv Count Filter
    ...
    Check Deprication  ${resp}  Get Item inv Count Filter
    RETURN  ${resp}
...
Update Vendor Category
    ...
    Check Deprication  ${resp}  Update Vendor Category
    RETURN  ${resp}
...
Update VendorCategoryStatus
    ...
    Check Deprication  ${resp}  Update VendorCategoryStatus
    RETURN  ${resp}
...
Set category as default
    ...
    Check Deprication  ${resp}  Set category as default
    RETURN  ${resp}
...
Get by encId
    ...
    Check Deprication  ${resp}  Get by encId
    RETURN  ${resp}
...
Get VendorCategory With CountFilter
    ...
    Check Deprication  ${resp}  Get VendorCategory With CountFilter
    RETURN  ${resp}

Get default vendorcategory
    Check And Create YNW Session
    ${resp}=  GET On Session  ynw  /provider/vendor/category/default     expected_status=any
    Check Deprication  ${resp}  Get default vendorcategory
    RETURN  ${resp}
...
Update StatusVendor 
    ...
    Check Deprication  ${resp}  Update StatusVendor
    RETURN  ${resp}
...
Update Statusofvendor
    ...
    Check Deprication  ${resp}  Update Statusofvendor
    RETURN  ${resp}
...
Set status as default
    ...
    Check Deprication  ${resp}  Set status as default
    RETURN  ${resp}
...
Get by encIdof vendorstatus
    ...
    Check Deprication  ${resp}  Get by encIdof vendorstatus
    RETURN  ${resp}
...
Get VendorStatus With CountFilter
    ...
    Check Deprication  ${resp}  Get VendorStatus With CountFilter
    RETURN  ${resp}
...
Get default vendorstatus
    ...
    Check Deprication  ${resp}  Get default vendorstatus
    RETURN  ${resp}
...
Update Vendor
    ...
    Check Deprication  ${resp}  Update Vendor
    RETURN  ${resp}
...
Update Vendor Status
    ...
    Check Deprication  ${resp}  Update Vendor Status
    RETURN  ${resp}
...
Update vendor user defined status
    ...
    Check Deprication  ${resp}  Update vendor user defined status
    RETURN  ${resp}
...
Populate Url For Vendor
    ...
    Check Deprication  ${resp}  Populate Url For Vendor
    RETURN  ${resp}
...
Upload Vendor Attachment
   ...
   Check Deprication  ${resp}  Upload Vendor Attachment
    RETURN  ${resp}
...
Update Inventory Catalog
    ...
    Check Deprication  ${resp}  Update Inventory Catalog
    RETURN  ${resp} 
...
Update Inventory Catalog status
    ...
    Check Deprication  ${resp}  Update Inventory Catalog status
    RETURN  ${resp} 
...
Get Inventory Catalog By account id
    ...
    Check Deprication  ${resp}  Get Inventory Catalog By account id
    RETURN  ${resp} 
...
Get Inventory catalog Filter
    ...
    Check Deprication  ${resp}  Get Inventory catalog Filter
    RETURN  ${resp}
...
Get Inventory catalog Filter Count
    ...
    Check Deprication  ${resp}  Get Inventory catalog Filter Count
    RETURN  ${resp}
...
Update Inventory Catalog Item
    ...
    Check Deprication  ${resp}  Update Inventory Catalog Item
    RETURN  ${resp} 
...
Update Inventory Catalog Item status
    ...
    Check Deprication  ${resp}  Update Inventory Catalog Item status
    RETURN  ${resp} 
...
Get Inventory Catalog item By EncId
    ...
    Check Deprication  ${resp}  Get Inventory Catalog item By EncId
    RETURN  ${resp} 
...
Get Inventory catalog item Filter
    ...
    Check Deprication  ${resp}  Get Inventory catalog item Filter
    RETURN  ${resp} 
...
Get Inventory catalog item filter count
    ...
    Check Deprication  ${resp}  Get Inventory catalog item filter count
    RETURN  ${resp} 
...
Get inventory catalog item by inventory catalog encoded id
    ...
    Check Deprication  ${resp}  Get inventory catalog item by inventory catalog encoded id
    RETURN  ${resp} 
...
Update SalesOrder Catalog
    ...
    Check Deprication  ${resp}  Update SalesOrder Catalog
    RETURN  ${resp} 
...
Update SalesOrder Catalog Status
    ...
    Check Deprication  ${resp}  Update SalesOrder Catalog Status
    RETURN  ${resp} 
...
Get SalesOrder Catalog Item By Encid
    ...
    Check Deprication  ${resp}  Get SalesOrder Catalog Item By Encid
    RETURN  ${resp} 
...
Update SalesOrder Catalog Item
    ...
    Check Deprication  ${resp}  Update SalesOrder Catalog Item
    RETURN  ${resp} 
...
Update Sales Order Catalog Item Status
    ...
    Check Deprication  ${resp}  Update Sales Order Catalog Item Status
    RETURN  ${resp} 
...
Get Item List By Catalog EncId
    ...
    Check Deprication  ${resp}  Get Item List By Catalog EncId
    RETURN  ${resp} 
...
Update SO Catalog Item Price
    ...
    Check Deprication  ${resp}  Update SO Catalog Item Price
    RETURN  ${resp} 
...
Create Catalog Item Batch-invMgmt False
    ...
    Check Deprication  ${resp}  Create Catalog Item Batch-invMgmt False
    RETURN  ${resp} 
...
Update Catalog Item Batch-invMgmt False
    ...
    Check Deprication  ${resp}  Update Catalog Item Batch-invMgmt False
    RETURN  ${resp} 
...
Create Catalog Item Batch-invMgmt True
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/so/catalog/item/${SO_Cata_Item_Encid}/batch      data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Catalog Item Batch-invMgmt True
    RETURN  ${resp} 
...
Update Catalog Item Batch-invMgmt True
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/so/catalog/item/batch/${SO_Cata_Item_Batch_Encid}      data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Catalog Item Batch-invMgmt True
    RETURN  ${resp} 
...
Update Catalog Item Batch Status
    ...
    Check Deprication  ${resp}  Update Catalog Item Batch Status
    RETURN  ${resp} 
...
Get Catalog Item Batch By Encid
    ...
    Check Deprication  ${resp}  Get Catalog Item Batch By Encid
    RETURN  ${resp} 
...
Get Catalog Item Batch List
    ...
    Check Deprication  ${resp}  Get Catalog Item Batch List
    RETURN  ${resp} 
...
Get Catalog Item Batch Count
    ...
    Check Deprication  ${resp}  Get Catalog Item Batch Count
    RETURN  ${resp} 
...
Update Purchase
    ...
    Check Deprication  ${resp}  Update Purchase
    RETURN  ${resp}
...
Get Purchase Filter
    ...
    Check Deprication  ${resp}  Get Purchase Filter
    RETURN  ${resp}
...
Get Purchase Filter Count
    ...
    Check Deprication  ${resp}  Get Purchase Filter Count
    RETURN  ${resp}
...
Get Purchase Item Filter
    ...
    Check Deprication  ${resp}  Get Purchase Item Filter
    RETURN  ${resp}
...
Get Purchase Item Filter Count
    ...
    Check Deprication  ${resp}  Get Purchase Item Filter Count
    RETURN  ${resp}
...
Add Purchase Attachment
    ...
    Check Deprication  ${resp}  Add Purchase Attachment
    RETURN  ${resp}
...
Create Item Remarks
    ...
    Check Deprication  ${resp}  Create Item Remarks
    RETURN  ${resp} 
...
Get Item Remark
    ...
    Check Deprication  ${resp}  Get Item Remark
    RETURN  ${resp} 
...
Update Item Remark
    ...
    Check Deprication  ${resp}  Update Item Remark
    RETURN  ${resp} 
...
Update Item Remark Status   
    ...
    Check Deprication  ${resp}  Update Item Remark Status
    RETURN  ${resp} 
...
Get Item Remark Filter
    ...
    Check Deprication  ${resp}  Get Item Remark Filter
    RETURN  ${resp}
...
Get Item Remark Count Filter
    ...
    Check Deprication  ${resp}  Get Item Remark Count Filter
    RETURN  ${resp}
...
Update Order Items
    ...
    Check Deprication  ${resp}  Update Order Items
    RETURN  ${resp} 
...
Get SalesOrder List
    ...
    Check Deprication  ${resp}  Get SalesOrder List
    RETURN  ${resp} 
...
Get SalesOrder Count
    ...
    Check Deprication  ${resp}  Get SalesOrder Count
    RETURN  ${resp} 
...
Assign User For Sales Order
    ...
    Check Deprication  ${resp}  Assign User For Sales Order
    RETURN  ${resp} 
...
UnAssign User For Sales Order
    ...
    Check Deprication  ${resp}  UnAssign User For Sales Order
    RETURN  ${resp} 
...
Update Sales Order Delivery Status
    ...
    Check Deprication  ${resp}  Update Sales Order Delivery Status
    RETURN  ${resp} 
...
Get Order Item List
    ...
    Check Deprication  ${resp}  Get Order Item List
    RETURN  ${resp} 
...
Get Order Item count By Filter
    ...
    Check Deprication  ${resp}  Get Order Item count By Filter
    RETURN  ${resp} 
...
Create Stock Adjustment
    ...
    Check Deprication  ${resp}  Create Stock Adjustment
    RETURN  ${resp} 
...
Update Stock Adjustment
    ...
    Check Deprication  ${resp}  Update Stock Adjustment
    RETURN  ${resp} 
...
Get Stock Adjustment By Id
    ...
    Check Deprication  ${resp}  Get Stock Adjustment By Id
    RETURN  ${resp} 
...
Get Item Stock adjust Filter
    ...
    Check Deprication  ${resp}  Get Item Stock adjust Filter
    RETURN  ${resp} 
...
Get Item Stock adjust Count Filter
    ...
    Check Deprication  ${resp}  Get Item Stock adjust Count Filter
    RETURN  ${resp} 
...
Get Item Stock adjust Details Filter
    ...
    Check Deprication  ${resp}  Get Item Stock adjust Details Filter
    RETURN  ${resp} 
...
Get Item Stock adjust Details Count Filter
    ...
    Check Deprication  ${resp}  Get Item Stock adjust Details Count Filter
    RETURN  ${resp} 
...
Create Sales Order Invoice
    ...
    Check Deprication  ${resp}  Create Sales Order Invoice
    RETURN  ${resp} 
...
Apply discount For SalesOrder
    ...
    Check Deprication  ${resp}  Apply discount For SalesOrder
    RETURN  ${resp} 
...
Remove SalesOrder discount 
    ...
    Check Deprication  ${resp}  Remove SalesOrder discount
    RETURN  ${resp} 
...
Update Sales Order Invoice Status
    ...
    Check Deprication  ${resp}  Update Sales Order Invoice Status
    RETURN  ${resp} 
...
Generate SO Payment Link
    ...
    Check Deprication  ${resp}  Generate SO Payment Link
    RETURN  ${resp} 
...
Share SO Invoice
    ...
    Check Deprication  ${resp}  Share SO Invoice
    RETURN  ${resp} 
...
Update Sales Order
    ...
    Check Deprication  ${resp}  Update Sales Order
    RETURN  ${resp} 
...
Add Details To Catalog
    ...
    Check Deprication  ${resp}  Add Details To Catalog
    RETURN  ${resp} 
...
Get Catalog Item Details
    ...
    Check Deprication  ${resp}  Get Catalog Item Details
    RETURN  ${resp}
...
Update Details In Catalog 
    ...
    Check Deprication  ${resp}  Update Details In Catalog
    RETURN  ${resp} 
...
Create Batch
    ...
    Check Deprication  ${resp}  Create Batch
    RETURN  ${resp} 
...
Get NonExpired Inventory Item 
    ...
    Check Deprication  ${resp}  Get NonExpired Inventory Item
    RETURN  ${resp} 
...
Get Item Batch By InvCatItem
    ...
    Check Deprication  ${resp}  Get Item Batch By InvCatItem
    RETURN  ${resp}
...
Update Frequency
    ...
    Check Deprication  ${resp}  Update Frequency
    RETURN  ${resp} 
...
Update Frequency Status
    ...
    Check Deprication  ${resp}  Update Frequency Status
    RETURN  ${resp}

RX Create Prescription

    [Arguments]  ${providerConsumerId}  ${doctorId}  ${medicineName}  ${duration}  ${quantity}  ${description}  ${spItemCode}  ${dosage}  ${frequency_id}  ${html}   &{kwargs}
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/medicalrecord/prescription   data=${data}  expected_status=any
    Check Deprication  ${resp}  RX Create Prescription
    RETURN  ${resp} 
...
Get RX Prescription By Id
    ...
    Check Deprication  ${resp}  Get RX Prescription By Id
    RETURN  ${resp}
...
RX Update Prescription
    ...
    Check Deprication  ${resp}  RX Update Prescription
    RETURN  ${resp} 
...
Enable/Disable Inventory Rx
    ...
    Check Deprication  ${resp}  Enable/Disable Inventory Rx
    RETURN  ${resp}
...
Enable/Disable SalesOrder
    ...
    Check Deprication  ${resp}  Enable/Disable SalesOrder
    RETURN  ${resp}
...
RX Push Prescription By EncId
    ...
    Check Deprication  ${resp}  RX Push Prescription By EncId
    RETURN  ${resp}
...
RX Create Prescription Item
    ...
    Check Deprication  ${resp}  RX Create Prescription Item
    RETURN  ${resp} 
...
Get RX Prescription Item By EncId
    ...
    Check Deprication  ${resp}  Get RX Prescription Item By EncId
    RETURN  ${resp}

RX Update Prescription Item

    [Arguments]  ${id}  ${medicineName}  ${duration}  ${quantity}  ${description}  ${spItemCode}  ${dosage}  ${frequency_id}  ${prescriptioinUid}   &{kwargs}
    ...
    Check Deprication  ${resp}  RX Update Prescription Item
    RETURN  ${resp} 
...
Get RX Prescription count
    ...
    Check Deprication  ${resp}  Get RX Prescription count
    RETURN  ${resp}
...
Get RX Prescription By filter
    ...
    Check Deprication  ${resp}  Get RX Prescription By filter
    RETURN  ${resp} 
...
Get RX Prescription Item Qnty By EncId
    ...
    Check Deprication  ${resp}  Get RX Prescription Item Qnty By EncId
    RETURN  ${resp} 
...
Order Request
    ...
    Check Deprication  ${resp}  Order Request
    RETURN  ${resp}
...
Convert to order
    ...
    Check Deprication  ${resp}  Convert to order
    RETURN  ${resp}
...
Get Sorder By Filter
    ...
    Check Deprication  ${resp}  Get Sorder By Filter
    RETURN  ${resp} 
...
Get Sorder By Uid
    ...
    Check Deprication  ${resp}  Get Sorder By Uid
    RETURN  ${resp}
...
Get Sorder Count By Filter
    ...
    Check Deprication  ${resp}  Get Sorder Count By Filter
    RETURN  ${resp}
...
Add SubService To Appointment  
    ...
    Check Deprication  ${resp}  Add SubService To Appointment
    RETURN  ${resp}
...
Update SubService To Appointment  
    ...
    Check Deprication  ${resp}  Update SubService To Appointment
    RETURN  ${resp}
...
Remove SubService From Appointment  
    ...
    Check Deprication  ${resp}  Remove SubService From Appointment
    RETURN  ${resp}
...
Update cash payment- Sales Order
    ...
    Check Deprication  ${resp}  Update cash payment- Sales Order
    RETURN  ${resp}
...
Get Inventory Auditlog By Filter
    ...
    Check Deprication  ${resp}  Get Inventory Auditlog By Filter
    RETURN  ${resp}
...
Get Inventory Auditlog Count By Filter
    ...
    Check Deprication  ${resp}  Get Inventory Auditlog Count By Filter
    RETURN  ${resp}
...
Get Inventory Auditlog By Uid
    ...
    Check Deprication  ${resp}  Get Inventory Auditlog By Uid
    RETURN  ${resp}
...
Get Inventory Auditlog By id
    ...
    Check Deprication  ${resp}  Get Inventory Auditlog By id
    RETURN  ${resp}
...
Create Finance Invoice
    ...
    Check And Create YNW Session
    ${resp}=    POST On Session    ynw    /provider/jp/finance/invoice    data=${data}  expected_status=any    headers=${headers}
    Check Deprication  ${resp}  Create Finance Invoice
    RETURN  ${resp}
...
Create Custom Variable 
    ...
    Check Deprication  ${resp}  Create Custom Variable
    RETURN  ${resp}
...
Update Custom Variable 
    ...
    Check Deprication  ${resp}  Update Custom Variable
    RETURN  ${resp}
...
Get Custom Variable By Id
    ...
    Check Deprication  ${resp}  Get Custom Variable By Id
    RETURN  ${resp}
...
Get Custom Variable By Filter
    ...
    Check Deprication  ${resp}  Get Custom Variable By Filter
    RETURN  ${resp}
...
Get Custom Variable Count By Filter 
    ...
    Check Deprication  ${resp}  Get Custom Variable Count By Filter
    RETURN  ${resp}
...
Update Custom Variable Status 
    ...
    Check Deprication  ${resp}  Update Custom Variable Status
    RETURN  ${resp}
...
Create Template  
    ...
    Check Deprication  ${resp}  Create Template
    RETURN  ${resp} 
...
#     Check Deprication  ${resp}  Update Template 
#     RETURN  ${resp} 
...
Update Template Status
    ...
    Check Deprication  ${resp}  Update Template Status
    RETURN  ${resp} 
...
Get Template By Id
    ...
    Check Deprication  ${resp}  Get Template By Id
    RETURN  ${resp}
...
Get Template By Filter
    ...
    Check Deprication  ${resp}  Get Template By Filter
    RETURN  ${resp}
...
Get Template Count By Filter
    ...
    Check Deprication  ${resp}  Get Template Count By Filter
    RETURN  ${resp}
...
Get Dynamic Variable List By Context
    ...
    Check Deprication  ${resp}  Get Dynamic Variable List By Context
    RETURN  ${resp}
...
Get Dynamic Variable List
    ...
    Check Deprication  ${resp}  Get Dynamic Variable List
    RETURN  ${resp}
...
Get Dynamic Variable List By SendComm
    ...
    Check Deprication  ${resp}  Get Dynamic Variable List By SendComm
    RETURN  ${resp}
...
Create Template Settings
    ...
    Check Deprication  ${resp}  Create Template Settings
    RETURN  ${resp} 
...
Get Send Comm List
    ...
    Check Deprication  ${resp}  Get Send Comm List
    RETURN  ${resp}
...
Get Send Comm List By Context
    ...
    Check Deprication  ${resp}  Get Send Comm List By Context
    RETURN  ${resp}
...
Update Template Settings
    ...
    Check Deprication  ${resp}  Update Template Settings
    RETURN  ${resp} 
...
Get Global Variable List
    ...
    Check Deprication  ${resp}  Get Global Variable List
    RETURN  ${resp}
...
Get Default Template List by sendComm
    ...
    Check Deprication  ${resp}  Get Default Template List by sendComm
    RETURN  ${resp}
...
Get Template Settings By Id
    ...
    Check Deprication  ${resp}  Get Template Settings By Id
    RETURN  ${resp}
...
Update Template Settings Status
    ...
    Check Deprication  ${resp}  Update Template Settings Status
    RETURN  ${resp} 
...
Get All Settings By Filter
    ...
    Check Deprication  ${resp}  Get All Settings By Filter
    RETURN  ${resp}
...
Create Template Preview
    ...
    Check Deprication  ${resp}  Create Template Preview
    RETURN  ${resp} 
...
Get Custom Template Preview By Id
    ...
    Check Deprication  ${resp}  Get Custom Template Preview By Id
    RETURN  ${resp}
...
Get Default Template Preview 
    ...
    Check Deprication  ${resp}  Get Default Template Preview
    RETURN  ${resp}
...
Get Contexts
    ...
    Check Deprication  ${resp}  Get Contexts
    RETURN  ${resp}
...
Get Context List 
    ...
    Check Deprication  ${resp}  Get Context List
    RETURN  ${resp} 
...
Get CommTargets
    ...
    Check Deprication  ${resp}  Get CommTargets
    RETURN  ${resp}
...
Get Store Settings For OnlineOrder
    ...
    Check Deprication  ${resp}  Get Store Settings For OnlineOrder
    RETURN  ${resp}
...
Update Store Settings For OnlineOrder
    ...
    Check Deprication  ${resp}  Update Store Settings For OnlineOrder
    RETURN  ${resp} 
...
Enable Disable Booking RBAC
    ...
    Check Deprication  ${resp}  Enable Disable Booking RBAC
    RETURN  ${resp}
...
Enable Disable Medical Record RBAC
    ...
    Check Deprication  ${resp}  Enable Disable Medical Record RBAC
    RETURN  ${resp}
...
Get Capabilities By Feature 
    ...
    Check Deprication  ${resp}  Get Capabilities By Feature 
    RETURN  ${resp}
...
Get All Capabilities 
    ...
    Check Deprication  ${resp}  Get All Capabilities 
    RETURN  ${resp}
...
Enable Disable CRM Lead
    ...
    Check Deprication  ${resp}  Enable Disable CRM Lead
    RETURN  ${resp}
...
Create Lead Product
    ...
    Check Deprication  ${resp}  Create Lead Product
    RETURN  ${resp}
...
Get Lead Product By Uid     
    ...
    Check Deprication  ${resp}  Get Lead Product By Uid
    RETURN  ${resp}
...
Get Lead Product By Filter    
    ...
    Check Deprication  ${resp}  Get Lead Product By Filter
    RETURN  ${resp}
...
Get Lead Product Count By Filter    
    ...
    Check Deprication  ${resp}  Get Lead Product Count By Filter
    RETURN  ${resp}
...
Lead Product Status Change
    ...
    Check Deprication  ${resp}  Lead Product Status Change
    RETURN  ${resp}
...
Update Lead Product
    ...
    Check Deprication  ${resp}  Update Lead Product
    RETURN  ${resp}
...
Create Lead Channel
    ...
    Check Deprication  ${resp}  Create Lead Channel
    RETURN  ${resp}
...
Get Lead Channel By Uid     
    ...
    Check Deprication  ${resp}  Get Lead Channel By Uid
    RETURN  ${resp}
...
Update Lead Channel
    ...
    Check Deprication  ${resp}  Update Lead Channel
    RETURN  ${resp}
...
Lead Channel Status Change
    ...
    Check Deprication  ${resp}  Lead Channel Status Change
    RETURN  ${resp}
...
Get Lead Channel By Filter    
    ...
    Check Deprication  ${resp}  Get Lead Channel By Filter
    RETURN  ${resp}
...
Get Lead Channel Count By Filter    
    ...
    Check Deprication  ${resp}  Get Lead Channel Count By Filter
    RETURN  ${resp}
...
Create Lead Consumer
    ...
    Check Deprication  ${resp}  Create Lead Consumer
    RETURN  ${resp}
...
Get Lead Consumer
    ...
    Check Deprication  ${resp}  Get Lead Consumer
    RETURN  ${resp}
...
Get Lead Consumer By Filter
    ...
    Check Deprication  ${resp}  Get Lead Consumer By Filter
    RETURN  ${resp}
...
Get Lead Consumer Count By Filter
    ...
    Check Deprication  ${resp}  Get Lead Consumer Count By Filter
    RETURN  ${resp}
...
Update Lead Consumer
    ...
    Check Deprication  ${resp}  Update Lead Consumer
    RETURN  ${resp}
...
Consumer Lead Status Change
    ...
    Check Deprication  ${resp}  Consumer Lead Status Change
    RETURN  ${resp}
...
Create Crm Lead
    ...
    Check Deprication  ${resp}  Create Crm Lead
    RETURN  ${resp}
...
Get Crm Lead
    ...
    Check Deprication  ${resp}  Get Crm Lead
    RETURN  ${resp}
...
Get Crm Lead Count By Filter  
    ...
    Check Deprication  ${resp}  Get Crm Lead Count By Filter
    RETURN  ${resp}
...
Crm Lead Status Change To Reject
    ...
    Check Deprication  ${resp}  Crm Lead Status Change To Reject
    RETURN  ${resp}
...
Update Crm Lead  
    ...
    Check Deprication  ${resp}  Update Crm Lead
    RETURN  ${resp}
...
Crm Lead Update Assign
    ...
    Check Deprication  ${resp}  Crm Lead Update Assign
    RETURN  ${resp}
...
Crm Lead Update Unassign
    ...
    Check Deprication  ${resp}  Crm Lead Update Unassign
    RETURN  ${resp}
...
User Take Virtual Service Appointment For Consumer
    ...
    Check Deprication  ${resp}  User Take Virtual Service Appointment For Consumer
    RETURN  ${resp}
...
User Take Appointment with Appointment Mode 
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  data=${data}  expected_status=any
    Check Deprication  ${resp}  User Take Appointment with Appointment Mode
    RETURN  ${resp}
...
Take Appointment with Appointment Mode 
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  data=${data}  expected_status=any
    Check Deprication  ${resp}  Take Appointment with Appointment Mode
    RETURN  ${resp}
...
Take Virtual Service Appointment For Consumer with Mode
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  data=${data}  expected_status=any
    Check Deprication  ${resp}  Take Virtual Service Appointment For Consumer with Mode
    RETURN  ${resp}
...
Take Virtual Service Appointment For Consumer
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  data=${data}  expected_status=any
    Check Deprication  ${resp}  Take Virtual Service Appointment For Consumer
    RETURN  ${resp}
...
Take Appointment with Phone no
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  data=${data}  expected_status=any
    Check Deprication  ${resp}  Take Appointment with Phone no
    RETURN  ${resp}
...
User Take Appointment For Consumer 
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/appointment  params=${pro_params}  data=${data}  expected_status=any
    Check Deprication  ${resp}  User Take Appointment For Consumer 
    RETURN  ${resp}
...
Create Individual Schedule
    ...
    ${data}=  json.dumps  ${data}
    ${resp}=  POST On Session  ynw  /provider/appointment/schedule  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Individual Schedule
    RETURN  ${resp}
...
Create Appointment Schedule For User
    ...
    ${data}=  json.dumps  ${data}
    ${resp}=  POST On Session  ynw  /provider/appointment/schedule  data=${data}  expected_status=any
    Check Deprication  ${resp}  Create Appointment Schedule For User
    RETURN  ${resp}
...
Create User With Roles And Scope
    ...
    Check And Create YNW Session
    ${resp}=  POST On Session  ynw  /provider/user    data=${data}  expected_status=any
    Check Deprication  ${resp}  Create User With Roles And Scope
    RETURN  ${resp}
...
AddFamilyMemberByProviderWithPhoneNo
    ...
    ${data}=    json.dumps    ${data}
    ${resp}=  POST On Session   ynw   /provider/customers/familyMember   data=${data}  expected_status=any
    Check Deprication  ${resp}  AddFamilyMemberByProviderWithPhoneNo
    RETURN  ${resp}
...
Update Business Profile without schedule
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/bProfile   data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Business Profile without schedule
    RETURN  ${resp}
...
Update Business Profile without details
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/bProfile   data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Business Profile without details
    RETURN  ${resp}
...
Update Business Profile without phone and email
    ...
    Check And Create YNW Session
    ${resp}=  PUT On Session  ynw  /provider/bProfile   data=${data}  expected_status=any
    Check Deprication  ${resp}  Update Business Profile without phone and email
    RETURN  ${resp}
