...
# ..... Co-Applicant KYC .........
    ...
    ${resp}=    Get Financial Sub category Enum
    Log  ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}   200


JD-TC-GetFinancialSubCategoryEnum-UH2

    [Documentation]  Get Financial Sub category Enum - Where didnt created lead 

    ${resp}=   Encrypted Provider Login  ${HLPUSERNAME100}  ${PASSWORD} 
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-GetFinancialSubCategoryEnum-UH3

    [Documentation]  Get Financial Sub category Enum - Without login 
