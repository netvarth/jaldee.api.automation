...
JD-TC-GenerateOTPForLOSLeadConsumerKycPhoneNumber-1
...
JD-TC-GenerateOTPForLOSLeadConsumerKycPhoneNumber-2
...
JD-TC-GenerateOTPForLOSLeadConsumerKycPhoneNumber-UH1
    ...
    ${resp}=    Generate OTP For LOS Lead Consumer Kyc Phone Number  ${inv}  
    Log  ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}   422
    Should Be Equal As Strings      ${resp.json()}        ${INVALID_X_ID}
    

JD-TC-GenerateOTPForLOSLeadConsumerKycPhoneNumber-UH2

    [Documentation]  Generate OTP For LOS Lead Consumer Kyc Phone Number - without login
...
JD-TC-GenerateOTPForLOSLeadConsumerKycPhoneNumber-UH3

    [Documentation]  Generate OTP For LOS Lead Consumer Kyc Phone Number - with another login
