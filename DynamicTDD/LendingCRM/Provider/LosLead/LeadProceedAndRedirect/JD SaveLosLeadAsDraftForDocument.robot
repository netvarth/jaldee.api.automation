...
JD-TC-SaveLosLeadAsDraftForDocument-1

    [Documentation]  Save LOS Lead As Draft For Document
    ...
    ${resp}=    Create Los Lead Stage  ${losProduct[0]}  ${loanstageType[1]}  ${Sname11}  sortOrder=${sort_order[0]}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Create Los Lead Stage  ${losProduct[0]}  ${loanstageType[2]}  ${Sname22}  sortOrder=${sort_order[1]}  onRedirect=${stageuid11}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Create Los Lead Stage  ${losProduct[0]}  ${loanstageType[3]}  ${Sname33}  sortOrder=${sort_order[2]}  onRedirect=${stageuid22}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Create Los Lead Stage  ${losProduct[0]}  ${loanstageType[4]}  ${Sname44}  sortOrder=${sort_order[3]}  onRedirect=${stageuid33}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Create Los Lead Stage  ${losProduct[0]}  ${loanstageType[5]}  ${Sname55}  sortOrder=${sort_order[4]}  onRedirect=${stageuid44}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[0]}  ${stageuid11}  ${Sname11}  onProceed=${stageuid22}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[1]}  ${stageuid22}  ${Sname22}  onProceed=${stageuid33}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[2]}  ${stageuid33}  ${Sname33}  onProceed=${stageuid44}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[3]}  ${stageuid44}  ${Sname44}  onProceed=${stageuid55}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[4]}  ${stageuid55}  ${Sname55}  onProceed=${stageuid66}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    Update Los Lead Stage  ${losProduct[0]}  ${loanstageType[5]}  ${stageuid66}  ${Sname66}  onProceed=${stageuid77}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
