...
JD-TC-GetLOSLeadFinancialInfo-1

    [Documentation]  Get LOS Lead Financial Info
...
JD-TC-GetLOSLeadFinancialInfo-UH1

    [Documentation]  Get LOS Lead Financial Info - with another provider login 
...
JD-TC-GetLOSLeadFinancialInfo-UH2

    [Documentation]  Get LOS Lead Financial Info - without login 
...
JD-TC-GetLOSLeadFinancialInfo-UH3

    [Documentation]  Get LOS Lead Financial Info - where lead uid is invalid
    ...
    ${resp}=    Get LOS Lead Financial Info  ${inv}  ${Loanstageuid22} 
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200


JD-TC-GetLOSLeadFinancialInfo-UH4

    [Documentation]  Get LOS Lead Financial Info - where stage is invalid
    ...
    ${resp}=    Get LOS Lead Financial Info  ${lead_uid}  ${inv} 
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200