...
JD-TC-RequstForAadharValidation-1
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${fileSize223}  caption=${caption}  fileType=${fileType}  order=${order}
...
JD-TC-RequstForAadharValidation-2
                                  
    [Documentation]               requst for aadhar validation by already varified phone number
    ...
    # ${aadhaar}    Generate random string    10    1234${OtpPurpose['ConsumerVerifyEmail']}6789
    # ${aadhaar}    Convert To Integer  ${aadhaar}
    # Set Suite Variable    ${aadhaar}
...
JD-TC-RequstForAadharValidation-3

                                  
    [Documentation]               requst for aadhar validation by invalid customer id
    ...
    ${resp}=   Requst For Aadhar Validation    7857446908    ${loanuid}    ${phoneNo}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

JD-TC-RequstForAadharValidation-4
                                  
    [Documentation]               requst for aadhar validation by empty file name
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${empty}  fileSize=${fileSize223}  caption=${caption}  fileType=${fileType}  order=${order}
    Log  ${aadhaarAttachments}
...
JD-TC-RequstForAadharValidation-UH1
    ...
    [Documentation]               requst for aadhar validation by invalid loan uid
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    degshr5yue    ${phoneNo}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-RequstForAadharValidation-UH2
    ...
    [Documentation]               requst for aadhar validation by invalid phone num
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    ${loanuid}    sbbhgt5he    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings  ${resp.json()}  ${INVALID_LEAD_ID}
...
JD-TC-RequstForAadharValidation-Uh3
    ...
    [Documentation]               requst for aadhar validation by invalid aadhar num
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    ${loanuid}    ${phoneNo}    53rfvdz    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-RequstForAadharValidation-UH4
    ...
    [Documentation]               requst for aadhar validation with loan action remove
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[1]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${fileSize223}  caption=${caption}  fileType=${fileType}  order=${order}
    Log  ${aadhaarAttachments}
...
JD-TC-RequstForAadharValidation-UH5
    ...
    [Documentation]               requst for aadhar validation by loan action update
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[3]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${fileSize223}  caption=${caption}  fileType=${fileType}  order=${order}
    Log  ${aadhaarAttachments}
...
JD-TC-RequstForAadharValidation-UH6
    ...
    [Documentation]               requst for aadhar validation by loan action no change
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[2]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${fileSize223}  caption=${caption}  fileType=${fileType}  order=${order}
    Log  ${aadhaarAttachments}
...
JD-TC-RequstForAadharValidation-UH7
    ...
    [Documentation]               requst for aadhar validation by empty file size
    ${resp}=  Consumer Login  ${CUSERNAME32}  ${PASSWORD} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    Set Suite Variable  ${fname}   ${resp.json()['firstName']}
    ...
    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${empty}  caption=${caption}  fileType=${fileType}  order=${order}
    Log  ${aadhaarAttachments}
...
JD-TC-RequstForAadharValidation-UH8
    ...
    [Documentation]               requst for aadhar validation by empty aadhar num
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    ${loanuid}    ${phoneNo}    ${empty}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-RequstForAadharValidation-UH9
    ...
    [Documentation]               requst for aadhar validation by empty loan uid
    ...
    # ${resp}=    Verify Phone Otp and Create Loan Application   ${phone}   13   ${custid}    ${firstName}    ${lastName}    ${phone}    ${countryCodes[0]}    ${locId}    ${kyc_list1}
    ${resp}=  Verify Phone and Create Loan Application with customer details  ${phone}  ${OtpPurpose['ConsumerVerifyPhone']}  ${custid}  ${locId}    ${CustomerPhoto}  ${kyc_list1}  firstName=${firstName}  lastName=${lastName}  phoneNo=${phone}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    Set Suite VAriable  ${loanid}    ${resp.json()['id']}
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    ${empty}    ${phone}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings  ${resp.json()}  ${INVALID_LEAD_ID}

JD-TC-RequstForAadharValidation-5
                                  
    [Documentation]               requst for aadhar validation by after loan creation
    ...
    ${otherAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${jpgfile}  fileSize=${fileSize223}  caption=${caption1}  fileType=${fileType1}  order=${order}
    ${otherAttachmentsList}=    Create List  ${otherAttachments}

    ${panAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${pngfile}  fileSize=${fileSize223}  caption=${caption2}  fileType=${fileType2}  order=${order}
    ${panAttachments}=    Create List  ${panAttachments}

    ${aadhaarAttachments}=    Create Dictionary   action=${LoanAction[0]}  owner=${pcid14}  fileName=${pdffile}  fileSize=${fileSize223}  caption=${caption3}  fileType=${fileType3}  order=${order}
    ...
    Log  ${kyc_list1}
    ${resp}=  Create Loan Application    ${pcid14}  ${fname}  ${lname}  ${phone}  ${cc}  ${email}  ${categoryid}  ${typeid}  ${Productid}  ${locId}  ${place}  ${invoiceAmount}  ${downpaymentAmount}  ${requestedAmount}  ${remarks}  ${LoanAction[0]}  ${pcid14}  ${jpgfile}  ${fileSize223}  ${caption1}  ${fileType1}  ${order}  ${kyc_list1}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${resp}=   Requst For Aadhar Validation    ${pcid14}    ${uid}    ${phone}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
