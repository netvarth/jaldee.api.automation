...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+2467512
...
JD-TC-VerifyOtpforConsumerAcceptancePhone-UH1
                                  
    [Documentation]              Verify Otp for Consumer Acceptance Phone - Same again 
    ...
    Should Be Equal As Strings             ${resp.json()}  ${STATUS_IS_ALREADY_CONSUMERACCEPTED}

JD-TC-VerifyOtpforConsumerAcceptancePhone-UH2
                                  
    [Documentation]              Verify Otp for Consumer Acceptance Phone - PHONE NUMBER IS EMPTY
    ...
    ${resp}=                               Otp for Consumer Loan Acceptance Phone    ${empty}    ${OtpPurpose['Authentication']}    ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}  422
    Should Be Equal As Strings             ${resp.json()}  ${ENTER_VALID_OTP}


JD-TC-VerifyOtpforConsumerAcceptancePhone-UH3
                                  
    [Documentation]              Verify Otp for Consumer Acceptance Phone - number is invalid
    ...
    ${resp}=                               Otp for Consumer Loan Acceptance Phone    ${fake}    ${OtpPurpose['Authentication']}    ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}  422
    Should Be Equal As Strings             ${resp.json()}  ${ENTER_VALID_OTP}

JD-TC-VerifyOtpforConsumerAcceptancePhone-UH4
                                  
    [Documentation]              Verify Otp for Consumer Acceptance Phone - otp purpose is empty
    ...
    ${resp}=                               Otp for Consumer Loan Acceptance Phone    ${cust}    ${empty}    ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}  422
    Should Be Equal As Strings             ${resp.json()}  ${STATUS_IS_ALREADY_CONSUMERACCEPTED}

JD-TC-VerifyOtpforConsumerAcceptancePhone-UH5
                                  
    [Documentation]              Verify Otp for Consumer Acceptance Phone - without login
