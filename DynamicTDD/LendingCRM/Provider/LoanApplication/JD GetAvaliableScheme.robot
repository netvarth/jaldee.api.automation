...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+33333337
...
JD-TC-Get Avaliable Scheme-3
    ...
    [Documentation]               Create a loan And try to Get Avaliable Scheme after sales officer approval
...
JD-TC-Get Avaliable Scheme-4
    ...
    [Documentation]               Create a loan And try to Get Avaliable Scheme after Consumer Accepted
