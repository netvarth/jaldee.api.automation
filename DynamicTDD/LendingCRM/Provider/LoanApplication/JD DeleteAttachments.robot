...
JD-TC-DeleteAttachments-1
    ...
    [Documentation]               Delete Attachments (no change found)
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+3497518
...
# ....... Update KYC Details .......
    ...
    ${resp}=    Delete Loan Attachment        ${loanuid}    ${cust}    ${cust_id}    ${pdffile}    ${fileSize}    ${caption}    ${fileType}    ${LoanAction[1]}    photo    ${order}    uid=${loanuid}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
