...
JD-TC-VerifyOtpForPhone-UH1
    ...
    [Documentation]               Verify Phone Otp and Create Loan Application - same again 
...
JD-TC-VerifyOtpForPhone-UH2
    ...
    [Documentation]               Verify Phone Otp and Create Loan Application - number is empty 
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${empty}  ${OtpPurpose['ConsumerVerifyPhone']}  ${cust_id}  ${locId}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
...
JD-TC-VerifyOtpForPhone-UH3
    ...
    [Documentation]               Verify Phone Otp and Create Loan Application - number is invalid
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${fake}  ${OtpPurpose['ConsumerVerifyPhone']}  ${cust_id}  ${locId}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json( )}     ${ENTER_VALID_OTP}
...
JD-TC-VerifyOtpForPhone-UH4
    ...
    [Documentation]               Verify Phone Otp and Create Loan Application - otp purpose is empty 
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${cust}  ${empty}  ${cust_id}  ${locId}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422

JD-TC-VerifyOtpForPhone-UH5
                                  
    [Documentation]               Verify Phone Otp and Create Loan Application - customer id is invalid
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${cust}  ${OtpPurpose['ConsumerVerifyPhone']}  ${empty}  ${locId}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
...
JD-TC-VerifyOtpForPhone-UH6
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${cust}  ${OtpPurpose['ConsumerVerifyPhone']}  ${fake}  ${locId}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422

JD-TC-VerifyOtpForPhone-UH7
                                  
    [Documentation]               Verify Phone Otp and Create Loan Application - location id is empty
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${cust}  ${OtpPurpose['ConsumerVerifyPhone']}  ${cust_id}  ${empty}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422

JD-TC-VerifyOtpForPhone-UH8
                                  
    [Documentation]               Verify Phone Otp and Create Loan Application - location id is invalid
    ${resp}=  Encrypted Provider Login     ${SO_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}    200
    ...
    ${resp}=                               Verify Phone and Create Loan Application with customer details  ${cust}  ${OtpPurpose['ConsumerVerifyPhone']}  ${cust_id}  ${fake}   ${kyc_list1}  firstName=${fname}  lastName=${lname}  phoneNo=${cust}  countryCode=${countryCodes[0]}  gender=${gender}  dob=${dob}     
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422