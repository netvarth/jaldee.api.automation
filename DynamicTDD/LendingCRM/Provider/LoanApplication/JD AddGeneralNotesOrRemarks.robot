...
# .... Create Branch1....
    ...
    ${userids}=  Create List      ${provider_id1}    ${bch_id1}    ${so_id1}
    ...
    ${resp}    upload file to temporary location    ${file_action[0]}    ${provider_id1}    ${ownerType[0]}    ${firstName}    ${pdffile}    ${fileSize}    ${caption}    ${fileType}    ${EMPTY}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 
