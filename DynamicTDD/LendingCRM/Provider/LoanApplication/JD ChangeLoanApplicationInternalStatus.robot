...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+8748459
...
# ....... Manual Approval .......
    ...
    ${resp}=    Change Sp Internal Status       ${loanUid}    ${LoanApplicationSpInternalStatus[7]}   
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()[0]['spInternalStatus']}  ${LoanApplicationSpInternalStatus[7]}
