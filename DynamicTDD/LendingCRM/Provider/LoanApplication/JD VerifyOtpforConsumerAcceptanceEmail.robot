...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+2467512
...
# ....... Consumer Acceptance Phone .......
   ...
   ${resp}=    Verify Otp for Consumer Acceptance Email     ${email}   ${OtpPurpose['ConsumerAcceptance']}   ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

JD-TC-VerifyOtpforConsumerAcceptanceEmail-UH1
                                  
    [Documentation]               Verify Otp for Consumer Acceptance Email - same again 
...
JD-TC-VerifyOtpforConsumerAcceptanceEmail-UH2
                                  
    [Documentation]               Verify Otp for Consumer Acceptance Email - email is empty
    ...
    ${resp}=    Verify Otp for Consumer Acceptance Email     ${empty}   ${OtpPurpose['ConsumerAcceptance']}   ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${ENTER_VALID_OTP}


JD-TC-VerifyOtpforConsumerAcceptanceEmail-UH3
                                  
    [Documentation]               Verify Otp for Consumer Acceptance Email - otp purpose is empty
    ...
    ${resp}=    Verify Otp for Consumer Acceptance Email     ${email}   ${empty}   ${loanuid}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings     ${resp.json()}    ${ENTER_VALID_OTP}

JD-TC-VerifyOtpforConsumerAcceptanceEmail-UH4
