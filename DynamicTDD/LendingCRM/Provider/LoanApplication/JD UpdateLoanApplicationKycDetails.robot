...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+6472154
...
# ....... Update KYC Details .......
    ...
    Set Suite Variable      ${permanentRelationName}
    ...
    Set Suite Variable      ${currentRelationName}
...
JD-TC-Update loan Application Kyc Details-UH1
                                  
    [Documentation]               Update loan Application Kyc Details - same Again 
...
JD-TC-Update loan Application Kyc Details-UH2
                                  
    [Documentation]               Update loan Application Kyc Details - where id is empty

    ${resp}=  Encrypted Provider Login     ${SO_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}    200

    ${resp}=                               Update loan Application Kyc Details    ${empty}     ${loanuid}   ${cust}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200

JD-TC-Update loan Application Kyc Details-UH3
                                  
    [Documentation]               Update loan Application Kyc Details - id is invalid
    ...
    ${resp}=                               Update loan Application Kyc Details    ${fake}     ${loanuid}   ${cust}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200

JD-TC-Update loan Application Kyc Details-UH4
                                  
    [Documentation]               Update loan Application Kyc Details - uid is empty

    ${resp}=  Encrypted Provider Login     ${SO_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}    200

    ${resp}=                               Update loan Application Kyc Details    ${loanid}     ${empty}   ${cust}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}    ${INVALID_KYC_ID}

JD-TC-Update loan Application Kyc Details-UH5
                                  
    [Documentation]               Update loan Application Kyc Details - uid is invalid 
    ...
    ${resp}=                               Update loan Application Kyc Details    ${loanid}     ${fake}   ${cust}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}    ${INVALID_KYC_ID}

JD-TC-Update loan Application Kyc Details-UH6
                                  
    [Documentation]               Update loan Application Kyc Details - number is empty 

    ${resp}=  Encrypted Provider Login     ${SO_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}    200

    ${resp}=                               Update loan Application Kyc Details    ${loanid}     ${loanuid}   ${empty}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}    ${INVALID_KYC_ID}


JD-TC-Update loan Application Kyc Details-UH7
                                  
    [Documentation]               Update loan Application Kyc Details - number is invalid
    ...
    ${resp}=                               Update loan Application Kyc Details    ${loanid}     ${loanuid}   ${fake}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}    permanentCity=${city}   permanentPin=${pin}  permanentRelationName=${permanentRelationName}  permanentRelationType=${CDLRelationType[2]}   permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}    currentCity=${city}    currentPin=${pin}  currentRelationName=${currentRelationName}  currentRelationType=${CDLRelationType[2]}  currentState=${state}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}    ${INVALID_KYC_ID}


JD-TC-Update loan Application Kyc Details-UH8
                                  
    [Documentation]               Update loan Application Kyc Details - without login
