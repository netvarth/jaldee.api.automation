...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+6475154
...
JD-TC-VerifyOtpForEmail-UH1
    ...
    [Documentation]               varify otp for mail - same again
...
JD-TC-VerifyOtpForEmail-UH2
    ...
    [Documentation]               varify otp for mail - email id is empty
    ...
    ${resp}=    Verify Email Otp and Create Loan Application  ${empty}  ${OtpPurpose['ConsumerVerifyEmail']}  ${loanuid} 
    Log  ${resp.content}
...
JD-TC-VerifyOtpForEmail-UH3
    ...
    [Documentation]               varify otp for mail - invalid
    ...
    ${resp}=    Verify Email Otp and Create Loan Application  ${fake}  ${OtpPurpose['ConsumerVerifyEmail']}  ${loanuid} 
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}      ${ENTER_VALID_OTP}
...
JD-TC-VerifyOtpForEmail-UH4
    ...
    [Documentation]               varify otp for mail - otp purpose is empty
    ...
    ${resp}=    Verify Email Otp and Create Loan Application  ${cust_email}  ${empty}  ${loanuid} 
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}      ${ENTER_VALID_OTP}
