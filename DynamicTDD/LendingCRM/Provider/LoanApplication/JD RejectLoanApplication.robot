...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+9488460
...
JD-TC-RejectLoanApplication-UH1
    ...
    [Documentation]               Reject Loan Application  which is already rejected
    ...
    Should Be Equal As Strings     ${resp.json()}      ${ALREADY_APPROVAL_REQUESTED}

JD-TC-RejectLoanApplication-UH2
                                  
    [Documentation]               Reject Loan Application  where uid is empty
    ...
    ${resp}=  Reject Loan Application   ${empty}    ${note}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-RejectLoanApplication-UH3
    ...
    ${resp}=  Reject Loan Application   ${fake}    ${note}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-RejectLoanApplication-UH5
