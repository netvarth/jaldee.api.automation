...
JD-TC-Generate Credit Score-MAFIL Score-1
    ...
    [Documentation]               Create a loan And Generate MAFIL Score.
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+6472159
...
JD-TC-Generate Credit Score-MAFIL Score-2
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - loan application uid is empty 

    ${resp}=  Encrypted Provider Login     ${BCH_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}  200

    ${resp}=    MAFIL Score                ${empty}  ${kycid}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}   ${LOAN_APPLICATION_REF_REQ}

JD-TC-Generate Credit Score-MAFIL Score-3
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - loan application uid is invalid 
    ...
    ${resp}=    MAFIL Score                ${inv}  ${kycid}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    422
    Should Be Equal As Strings             ${resp.json()}   ${INVALID_LOAN_APPLICATION_ID}

JD-TC-Generate Credit Score-MAFIL Score-4
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - loan application kycid is empty

    ${resp}=  Encrypted Provider Login     ${BCH_USERNAME}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}  200

    ${resp}=    MAFIL Score                ${loanuid}  ${empty}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200

JD-TC-Generate Credit Score-MAFIL Score-5
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - loan application kyc id is invalid
    ...
    ${resp}=    MAFIL Score                ${loanuid}  ${inv}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200

JD-TC-Generate Credit Score-MAFIL Score-6
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - by sales officer login
...
JD-TC-Generate Credit Score-MAFIL Score-7
                                  
    [Documentation]               Create a loan And Generate MAFIL Score. - without login
