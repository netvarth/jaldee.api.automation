...
# ..... SignUp Business Head
    ...
    ${NBFCMUSERNAME1}=  Evaluate  ${MUSERNAME}+5794135
...
JD-TC-GetLoanApplicationCountwithFilter-2
    ...
    ${resp}=    Get Loan Application Count with filter    id-eq=${loanid}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}   ${len}
...
JD-TC-GetLoanApplicationCountwithFilter-4
    ...
    ${resp}=    Get Loan Application Count with filter    customer-eq=${cust_id}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}   ${len}
...
JD-TC-GetLoanApplicationCountwithFilter-6
    ...
    ${resp}=    Get Loan Application Count with filter    customerLastName-eq=${lname}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}   ${len}
...
JD-TC-GetLoanApplicationCountwithFilter-7
    ...
    ${resp}=    Get Loan Application Count with filter    location-eq=${locId}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}   ${len}
...
JD-TC-GetLoanApplicationCountwithFilter-8
    ...
    ${resp}=    Get Loan Application Count with filter    locationName-eq=${locname}
    Log    ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}   ${len}
