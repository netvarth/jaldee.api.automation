...
JD-TC-Approved Partner-UH2
    ...
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}    ${PARTNER_ALREADY_APPROVED}


JD-TC-Approved Partner-UH3
...
# <<<--------------------update partner ------------------------------------------------------->>>
    ...
    ${resp}    Update Partner Aadhar    ${aadhaar}    ${partuid2}    ${LoanAction[0]}    ${Pid2}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${resp}    Update Partner Pan    ${pan}    ${partuid2}    ${LoanAction[0]}    ${Pid2}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 
    ...
    ${resp}    Update Partner Bank    ${bankAccountNo}    ${bankIfsc}    ${bankName}    ${partuid2}    ${LoanAction[0]}    ${Pid2}    ${pdffile}    ${fileSize}    ${caption3}    ${fileType3}    ${order}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 
    ...
    ${resp}    Verify Partner Bank    ${Pid2}    ${partuid2}     ${bankAccountNo}    ${bankIfsc}     bankName=${bankName}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${resp}=    Partner Details    ${partuid2}    ${partnerName}    ${P_phone}    ${email}    ${description}     ${Ptypeid}    ${Pcategoryid}    ${address1}    ${address2}    ${pin}    ${partnerCity}    ${district}    ${state}    ${aadhaar}    ${pan}    ${gstin}    ${branch}    ${partnerAliasName}    ${aadhaarAttachments}    ${panAttachments}    ${gstAttachments}    ${licenceAttachments}    ${partnerAttachments}    ${storeAttachments}   
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200 
...
# <<<--------------------update partner ------------------------------------------------------->>>
    ...
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}    ${UNABLE_TO_APPROVE_STATUS_IS_DRAFT}


JD-TC-Approved Partner-UH4
...
# <<<--------------------update partner ------------------------------------------------------->>>
    ...
    ${resp}=   Partner Approved    ${Puid1}    ${empty}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
