...
*** Test Cases ***
JD-TC-GetEnquirieStatus-1
    [Documentation]   Get Enquiries Status
...
JD-TC-GetEnquirieStatus-2
    [Documentation]   Get Enquiry Status with another Provider

    ${resp}=   ProviderLogin  ${PUSERNAME61}  ${PASSWORD} 
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-GetEnquirieStatus-UH1
    [Documentation]   Get Enquiry Status with Consumer Login
...
JD-TC-GetEnquirieStatus-UH2
    [Documentation]   Get Enquiry Status without Login
