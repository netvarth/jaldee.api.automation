...
# *** Comments ***
    ...
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable  ${Lstatus_id}    ${resp.json()[0]['id']}
    Set Suite Variable  ${Lstatus_id1}    ${resp.json()[1]['id']}
    Set Suite Variable  ${Lstatus_id2}    ${resp.json()[2]['id']}
    Set Suite Variable  ${Lstatus_id3}    ${resp.json()[3]['id']}
    Set Suite Variable  ${Lstatus_id4}    ${resp.json()[4]['id']}
    Set Suite Variable  ${Lstatus_id5}    ${resp.json()[5]['id']}
    Set Suite Variable  ${Lstatus_id6}    ${resp.json()[6]['id']}
    Set Suite Variable  ${Lstatus_id7}    ${resp.json()[7]['id']}
    Set Suite Variable  ${Lstatus_id8}    ${resp.json()[8]['id']}
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id1}
    ...
    ${resp}=    Change Status Lead   ${Lstatus_id7}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id7}
    ...
    ${resp}=   Redirect lead   ${le_id}   ${Lstatus_id10}  ${note1}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id8}


    ${resp}=    Change Status Lead    ${Lstatus_id8}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id10}

    ${resp}=    Change Status Lead    ${Lstatus_id10}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id11}
    ...
    ${resp}=    Change Status Lead    ${Lstatus_id11}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id12}
    ...
    ${resp}=    Change Status Lead    ${Lstatus_id12}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id13}

    ${resp}=    Change Status Lead    ${Lstatus_id13}    ${le_id} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id14}
...
JD-TC-RejectLeadStatus-2
  ...
  #  Should Be Equal As Strings      ${resp.json()[0]['panNumber']}  ${panNumber}
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['kycCreated']}  ${bool[1]}
    Should Be Equal As Strings  ${resp.json()['status']['id']}   ${Lstatus_id6}
...
JD-TC-RejectLeadStatus-4
  ...
  #  Should Be Equal As Strings      ${resp.json()[0]['panNumber']}  ${panNumber}
    ...
    ${resp}=    Change Status Lead   ${Lstatus_id7}    ${leUidR3} 
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
