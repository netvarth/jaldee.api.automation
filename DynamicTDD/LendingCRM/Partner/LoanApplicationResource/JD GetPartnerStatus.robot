...
JD-TC-GetPartnerStatus-1
                                  
    [Documentation]               Get Partner Status
...
JD-TC-GetPartnerStatus-UH1
                                  
    [Documentation]               Get Partner Status with consumer login.
...
JD-TC-GetPartnerStatus-UH2
                                  
    [Documentation]               Get Partner Status without login.
...
JD-TC-GetPartnerStatus-UH3
                                  
    [Documentation]               Get Partner Status with  provider login login.
