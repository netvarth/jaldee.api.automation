...
JD-TC-RemoveTaskAssignee-1
    ...
    clear_appt_schedule   ${HLPUSERNAME21}
    clear_Department    ${HLPUSERNAME21}
...
JD-TC-RemoveTaskAssignee-3
    ...
    ${resp}=    Reset LoginId  ${u_id0}  ${PUSERPH0}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=    Change Assignee    ${task_uid3}   ${u_id2}
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
