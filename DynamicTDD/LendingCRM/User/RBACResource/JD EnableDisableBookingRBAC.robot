...
JD-TC-EnableDisableBookingRbac-1
...
JD-TC-EnableDisableBookingRbac-2
    ...
    FOR   ${i}  IN RANGE   0   ${len}
        Should Contain    ${resp.json()[${i}]['featureName']}    booking
    END



JD-TC-EnableDisableBookingRbac-3
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['bookingRbac']}  ${bool[0]}
...
JD-TC-EnableDisableBookingRbac-4
...
JD-TC-EnableDisableBookingRbac-UH1
...
JD-TC-EnableDisableBookingRbac-UH2
...
JD-TC-EnableDisableBookingRbac-UH3
...
JD-TC-EnableDisableBookingRbac-UH4
