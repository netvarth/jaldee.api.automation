...
JD-TC-Auditor-1
    ...
    [Documentation]  Auditor - Create Branch
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+3478451
...
# ....Auditor...
    ...
    ${role1}=           Create Dictionary  id=${role_id12}  roleName=${role_name12}  defaultRole=${bool[1]}   scope=${user_scope}   capabilities=${capabilities}
    ${user_roles}=      Create List        ${role1}

    ${user_ids}=        Create List        ${ADT} 
    ...
    Log   ${resp.json()}
    Should Be Equal As Strings             ${resp.status_code}   200
    Should Be Equal As Strings             ${resp.json()['userRoles'][0]['id']}                 ${role_id12}
    Should Be Equal As Strings             ${resp.json()['userRoles'][0]['roleName']}           ${role_name12}
    Should Be Equal As Strings             ${resp.json()['userRoles'][0]['defaultRole']}        ${bool[1]}
    Should Be Equal As Strings             ${resp.json()['userRoles'][0]['capabilities']}       ${capability12}
    Should Be Equal As Strings             ${resp.json()['defaultRoleName']}                    ${role_name12}
...
JD-TC-Auditor-2
    ...
    [Documentation]  Auditor - approval request
...
JD-TC-Auditor-3
    ...
    [Documentation]  Auditor - Partner approved
...
JD-TC-Auditor-5
    ...
    [Documentation]  Auditor - Activate Partner 
...
JD-TC-Auditor-6
    ...
    [Documentation]  Auditor - Create CDL Enq 
...
JD-TC-Auditor-7
    ...
    [Documentation]  Auditor - Create Loan Application
...
JD-TC-Auditor-9
    ...
    [Documentation]  Auditor - Equifax, Mafil and Credit score
...
JD-TC-Auditor-10
    ...
    [Documentation]  Auditor - Equifax score
...
JD-TC-Auditor-11
    ...
    [Documentation]  Auditor - Mafil score
...
JD-TC-Auditor-12
    ...
    [Documentation]  Auditor - Cibil score
...
JD-TC-Auditor-15
    ...
    [Documentation]  Auditor - Scheme Approval
