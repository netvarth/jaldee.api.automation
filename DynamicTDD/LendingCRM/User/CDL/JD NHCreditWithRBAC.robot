...
JD-TC-NHCreditWithRBAC-1
                                  
    [Documentation]               Create Loan Using Sales officer Role and view loan and approve loan with NH credit
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+5476148
...
JD-TC-NHCreditWithRBAC-2
                                  
    [Documentation]               Create Loan Using Sales officer Role and rejectLoan NH Credit  
...
JD-TC-NHCreditWithRBAC-3
                                  
    [Documentation]               viewPartner NH Credit  role.
...
JD-TC-NHCreditWithRBAC-UH1
                                  
    [Documentation]             NH Credit  - Create Loan Application.
...
JD-TC-NHCreditWithRBAC-UH2
                                  
    [Documentation]             NH Credit  - Create Dealer.
...
JD-TC-NHCreditWithRBAC-UH3
                                  
    [Documentation]             NH Credit  - Create Branch.
...
JD-TC-NHCreditWithRBAC-UH4
                                  
    [Documentation]             NH Credit  - Create BranchMaster.
...
JD-TC-NHCreditWithRBAC-UH5

    [Documentation]     NH Credit - Scheme verified
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+6472148
    ${highest_package}=  get_highest_license_pkg
...
JD-TC-NHCreditWithRBAC-UH6
    ...
    [Documentation]     NH Credit - Branch Approval
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+8711624
    ${highest_package}=  get_highest_license_pkg
...
# ..... Create Sample User for Branch Manager
    ...
    Log   ${resp.json()}
    Should Be Equal As Strings            ${resp.status_code}  200
    Set Suite Variable  ${BM_USERNAME2}     ${resp.json()['mobileNo']}
...
# ....... Save Customer Details .......
    ...
    ${locations}=    Create Dictionary     id=${locId}
    ${kyc_list_cust}=  Create Dictionary   isCoApplicant=${boolean[0]}   id=${kycid2}
...
# ....... Refresh adhaar verify .......
    ...
    ${resp}=                               Refresh loan Bank Details Aadhaar  ${kycid2}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200
...
# ....... Loan Details .......
    ...
    ${LoanApplicationKycList}=             Create Dictionary   id=${kycid2}  customerIntegrationId=${customerIntegrationId}  monthlyIncome=${monthlyIncome}  nomineeType=${nomineeType[1]}  nomineeName=${nomineeName}    nomineeDob=${nominedob}  nomineeGender=${Genderlist[1]}   nomineePhone=${nomineenum}  customerEducation=${customerEducation}    customerEmployement=${customerEmployement}    salaryRouting=${salaryRouting}    familyDependants=${familyDependants}    noOfYearsAtPresentAddress=${noOfYearsAtPresentAddress}     currentResidenceOwnershipStatus=${currentResidenceOwnershipStatus}    ownedMovableAssets=${currentResidenceOwnershipStatus}  vehicleNo=${vehicleNo}   goodsFinanced=${goodsFinanced}   earningMembers=${earningMembers}   existingCustomer=${existingCustomer}    customerOccupation=${customerOccupation}
    Log  ${LoanApplicationKycList}
...
# ....... Draft Loan Details .......
    ...
    ${LoanApplicationKycListSave}=         Create Dictionary   id=${kycid2}  isCoApplicant=${boolean[0]}  customerIntegrationId=${customerIntegrationId}  pan=${pan}  aadhaar=${aadhaar}  permanentAddress1=${permanentAddress1}  permanentAddress2=${permanentAddress2}  permanentPin=${pin}  permanentCity=${city}  permanentState=${state}  currentAddress1=${currentAddress1}  currentAddress2=${currentAddress2}  currentPin=${pin}  currentCity=${city}  currentState=${state}  monthlyIncome=${monthlyIncome}  nomineeType=${nomineeType[1]}  nomineeName=${nomineeName}    nomineeDob=${nominedob}   nomineePhone=${nomineenum}  nomineeGender=${Genderlist[1]}  customerEducation=${customerEducation}    customerEmployement=${customerEmployement}   customerOccupation=${customerOccupation}    salaryRouting=${salaryRouting}    familyDependants=${familyDependants}  earningMembers=${earningMembers}   existingCustomer=${existingCustomer}    noOfYearsAtPresentAddress=${noOfYearsAtPresentAddress}     currentResidenceOwnershipStatus=${currentResidenceOwnershipStatus}    ownedMovableAssets=${currentResidenceOwnershipStatus}  vehicleNo=${vehicleNo}   goodsFinanced=${goodsFinanced}    permanentRelationType=${CDLRelationType[2]}  permanentRelationName=${permanentRelationName}  currentRelationType=${CDLRelationType[2]}  currentRelationName=${permanentRelationName}
    Log  ${LoanApplicationKycListSave}
...
# ....... Equifax Report .......
    ...
    ${resp}=    Equifax Report             ${loanuid}  ${cust}  ${kycid2}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200

# ....... MAFIL Score .......

    ${resp}=    MAFIL Score                ${loanuid}  ${kycid2}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200
...
# ....... Cibil Score .......
    ...
    ${resp}=    Cibil Score                ${kycid2}  ${cibilScore}  ${cibilreport}
    Log  ${resp.content}
    Should Be Equal As Strings             ${resp.status_code}    200
...
JD-TC-NHCreditWithRBAC-UH7

    [Documentation]     NH Credit - Sanctioned
...
JD-TC-NHCreditWithRBAC-UH8

    [Documentation]     NH Credit - Operation Approval
