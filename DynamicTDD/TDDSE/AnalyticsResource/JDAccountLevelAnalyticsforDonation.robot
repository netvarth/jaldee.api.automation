...
JD-TC-AccountLevelAnalyticsforDonation-1
    ...
    Set Suite Variable   ${donation_ids} 
    ${don_amts}=  Create List
    Set Suite Variable   ${don_amts} 
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Set Suite Variable  ${don_id${a}}  ${don_id[0]}
    ...
    Set Suite Variable   ${donation_count_len}
