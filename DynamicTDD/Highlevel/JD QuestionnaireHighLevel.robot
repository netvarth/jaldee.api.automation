...
JD-TC-QuestionnaireHighlevel-1
    ...
    ${fudata}=  db.fileUploadDT   ${resp.json()[0]}  ${FileAction[0]}  ${Questionnaireid}  ${pdffile}  ${mp4file}  ${mp3file}
    Log  ${fudata}
...
JD-TC-questionnaire highlevel - service and order
    ...
    ${fudata}=  db.fileUploadDT   ${resp.json()[0]}  ${FileAction[0]}  ${Questionnaireid3}  ${pdffile}  ${mp4file}  ${mp3file}
    Log  ${fudata}
