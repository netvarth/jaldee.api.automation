...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+3467928
...
# .......Verify Bank Details .......
    ...
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    Should Be Equal As Strings     ${account_id1}     ${resp.json()['account']}
...
JD-TC-GetLoanBankDetails-UH1
                                  
    [Documentation]               Verify Loan Bank without login
...
JD-TC-GetLoanBankDetails-UH3
    ...
    ${resp}=    Get loan Bank Details    ${loan_uids}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
