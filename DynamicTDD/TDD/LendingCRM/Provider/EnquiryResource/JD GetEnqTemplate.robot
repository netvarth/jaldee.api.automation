...
*** Test Cases ***
JD-TC-GetEnqTemplate-1
    [Documentation]   Get Enquire Template
    ...
    Should Be Equal As Strings  ${resp.json()[0]['templateName']}    ${en_temp_name}

JD-TC-GetEnqTemplate-2
    [Documentation]   Get Enquire Template with another Provider
...
JD-TC-GetEnqTemplate-UH1
    [Documentation]   Get Enquire Template with consumer login
...
JD-TC-GetEnqTemplate-UH2
    [Documentation]   Get Enquire Template without Login
