...
JD-TC-BussinessHeadWithRBAC-1
    ...
    [Documentation]               create Location - Business Head
...
JD-TC-BussinessHeadWithRBAC-UH1
...
JD-TC-BussinessHeadWithRBAC-UH2
    ...
    Set Suite Variable  ${cemail}           ${fname}${C_Email}.ynwtest@jaldee.com
    ${cust_email}=    String.RemoveString       ${cemail}    ${SPACE}
...
JD-TC-BussinessHeadWithRBAC-UH3
                                  
    [Documentation]               Approve Loan Application - Business Head
...
JD-TC-BussinessHeadWithRBAC-UH4
                                  
    [Documentation]               Loan Applocation Manual Approval - Business Head
...
JD-TC-BussinessHeadWithRBAC-7
    ...
    [Documentation]               Sales Officer Approval - Business Head
...
JD-TC-BussinessHeadWithRBAC-UH5
                                  
    [Documentation]               Branch Approval - Business Head
...
JD-TC-BussinessHeadWithRBAC-UH6
                                  
    [Documentation]               Partner Accepted - Business Head
...
JD-TC-BussinessHeadWithRBAC-UH7
                                  
    [Documentation]               Operational Approval - Business Head
...
JD-TC-BussinessHeadWithRBAC-8
    ...
    [Documentation]               Get Loan Application - Business Head
