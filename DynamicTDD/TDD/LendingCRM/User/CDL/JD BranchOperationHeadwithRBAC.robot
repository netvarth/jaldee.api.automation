...
JD-TC-BranchOperationHead-1
    ...
    [Documentation]   Branch operation Head - view partner.
...
# ..... SignUp Business Head
    ...
    ${NBFCPUSERNAME1}=  Evaluate  ${PUSERNAME}+6587965
...
JD-TC-BranchOperationHead-4
    ...
    [Documentation]     branch operation head  -  Update Sales Officer
...
JD-TC-BranchOperationHead-5
    ...
    [Documentation]     branch operation head  -  Update Credit Officer
...
JD-TC-BranchOperationHead-6
    ...
    [Documentation]     branch operation head  -  Activate Partner
...
JD-TC-BranchOperationHead-7
    ...
    [Documentation]     branch operation head  -  Create Loan Application
...
JD-TC-BranchOperationHead-8
    ...
    [Documentation]     branch operation head  -  Lan appliation Approval Request 
...
JD-TC-BranchOperationHead-9
    ...
    [Documentation]     branch operation head  -  Manual Approval 
...
JD-TC-BranchOperationHead-10
    ...
    [Documentation]     branch operation head  -  Scheme Approval 
...
JD-TC-BranchOperationHead-11
    ...
    [Documentation]     branch operation head  -  Branch Approval
...
JD-TC-BranchOperationHead-12
    ...
    [Documentation]     branch operation head  -  loan Sanctioned
