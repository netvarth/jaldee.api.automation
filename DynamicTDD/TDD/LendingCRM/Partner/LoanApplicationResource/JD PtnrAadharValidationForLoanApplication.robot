...
JD-TC-Partner Aadhar Validation For Loan Application-1
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application
...
JD-TC-Partner Aadhar Validation For Loan Application-2
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with invalid id

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${invalidid}    Random Number 	digits=5

    ${resp}=   Requst For Partner Aadhar Validation    ${invalidid}    ${loanuid}   ${consnum}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422


JD-TC-Partner Aadhar Validation For Loan Application-3
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with empty id

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${resp}=   Requst For Partner Aadhar Validation    ${empty}    ${loanuid}   ${consnum}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422


JD-TC-Partner Aadhar Validation For Loan Application-4
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with invalid loan uid

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${invalidloanuid}    Random Number 	digits=5

    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${invalidloanuid}   ${consnum}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_KYC_ID}


JD-TC-Partner Aadhar Validation For Loan Application-5
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with empty loan uid

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${empty}   ${consnum}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_KYC_ID}


JD-TC-Partner Aadhar Validation For Loan Application-6
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with invalid consumer number
    ...
    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${loanuid}   ${invconsnum}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_KYC_ID}

JD-TC-Partner Aadhar Validation For Loan Application-7
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with empty consumer number

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${loanuid}   ${empty}    ${aadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_KYC_ID}


JD-TC-Partner Aadhar Validation For Loan Application-8
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with invalid aadhar number

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${invaadhaar}    Random Number 	digits=5

    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${loanuid}   ${consnum}    ${invaadhaar}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
...
JD-TC-Partner Aadhar Validation For Loan Application-9
                                  
    [Documentation]              Partner Aadhar Validation For Loan Application with empty aadhar number

    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${loanuid}   ${consnum}    ${empty}    ${aadhaarAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${AADHAR_NUMBER_REQUIRED}


JD-TC-Partner Aadhar Validation For Loan Application-10
    ...
    ${resp}=   Requst For Partner Aadhar Validation    ${Pid1}    ${loanuid}   ${consnum}    ${aadhaar}    ${empty}
    Log  ${resp.content}
