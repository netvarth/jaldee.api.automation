...
JD-TC-Update consumer number-2
    ...
    ${resp}=  Verify Login Consumer   ${new_Number}  ${OtpPurpose['ConsumerVerifyEmail']}  countryCode=${country_code}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-4
    ...
    ${resp}=  Verify Login Consumer   ${Consumer1}  ${OtpPurpose['ConsumerVerifyEmail']}  countryCode=${country_code2}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-UH3
    ...
    # ${resp}=  Verify Login Consumer   ${Consumer1}  ${OtpPurpose['ConsumerVerifyEmail']}
    # Log  ${resp.content}
    # Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-UH4
    ...
    # ${resp}=  Verify Login Consumer   ${Consumer1}  ${OtpPurpose['ConsumerVerifyEmail']}  countryCode=${country_code1}
    # Log  ${resp.content}
    # Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-UH5
    ...
    ${resp}=  Verify Login Consumer   ${newNo}  ${OtpPurpose['ConsumerVerifyEmail']}  countryCode=${EMPTY}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-UH6
   ...
   ${resp}=  Consumer Activation  ${email}  1
    ...
    ${resp}=  Verify Login Consumer   ${newNo}  ${OtpPurpose['ConsumerVerifyEmail']}  countryCode=${country_code}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Update consumer number-5
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ${resp}=  Verify Login Consumer   ${alternativeNo}  ${OtpPurpose['ConsumerVerifyEmail']}  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
