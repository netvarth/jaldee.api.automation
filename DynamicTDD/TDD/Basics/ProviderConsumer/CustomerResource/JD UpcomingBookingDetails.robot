...
JD-TC-BookingHistoryDetailsOfProviderConsumer-1
    ...
    ${resp}=    Upcoming Booking details Of Provider Consumer
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-UpcomingBookingHistoryDetailsOfProviderConsumer-2

    [Documentation]   Get Booking History of Provider Consumer waitlist
...
JD-TC-UpcomingBookingHistoryDetailsOfProviderConsumer-3
