...
JD-TC-Assign_IVR_User-1
    ...
    ${end_time}=    db.add_timezone_time  ${tz}  6  00 
    ...
    ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${HLPUSERNAME5}  ${countryCodes[1]}${HLPUSERNAME5}  ${user_id}  ${user_name}
...
#........  user answered    ........
    ...
    ${clid_user}=    Convert To String    ${countryCodes[1]}${HLPUSERNAME5}
...
JD-TC-Assign_IVR_User-UH1
    ...
    ${invaliduid}=    FakerLibrary.Random Number

    ${resp}=    Assign IVR User    ${invaliduid}    ${userType[0]}    ${so_id1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Assign_IVR_User-UH3
    ...
    ${invuserid}=    FakerLibrary.Random Number
...
JD-TC-Assign_IVR_User-UH4
    ...
    ${resp}=    Assign IVR User    ${empty}    ${userType[0]}    ${so_id1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()}    ${bool[0]}
