...
JD-TC-Get Account Contact information-6
    ...
    Append To File  ${EXECDIR}/TDD/numbers.txt  ${BUSERNAME_K}${\n}
...
JD-TC-Get Account Contact information-7
    ...
    Set Suite Variable  ${subdomain}  ${resp.json()['subSector']}
    Set Test Variable  ${pro_id3}  ${resp.json()['id']}
    Append To File  ${EXECDIR}/TDD/numbers.txt  ${BUSERNAME_L}${\n}
    ...
    ${resp}=  Create User  ${firstname2}  ${lastname2}  ${dob2}  ${Genderlist[0]}  ${P_Email}${PUSERNAME_U1}.ynwtest@netvarth.com   ${userType[0]}  ${pin2}  ${countryCodes[0]}  ${PUSERNAME_U1}  ${dep_id}  ${sud_domain_id}  ${bool[0]}  ${countryCodes[0]}  ${whpnum}  ${countryCodes[0]}  ${tlgnum}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
