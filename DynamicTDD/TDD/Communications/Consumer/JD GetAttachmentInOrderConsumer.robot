...
JD-TC-GetAttachmentInOrder-1
    ...
    ${resp}=    Get Attachments In Order By Consumer  ${orderid1}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

JD-TC-GetAttachmentInOrder-UH1
    ...
    ${resp}=    Get Attachments In Order By Consumer     ${inv}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200


JD-TC-GetAttachmentInOrder-UH2
...
JD-TC-GetAttachmentInOrder-UH3
