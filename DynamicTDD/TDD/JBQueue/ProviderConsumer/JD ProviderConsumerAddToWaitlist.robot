...
JD-TC-Add To WaitlistByConsumer-1
    ...
    ${PUSERPH0}=  Evaluate  ${PUSERNAME}+199199301
    ...
    ${sTime}=  db.add_timezone_time  ${tz1}  0  15
    ${eTime}=  db.add_timezone_time  ${tz1}   0  30 
    ...
    ${sTime1}=  db.add_timezone_time  ${tz}  0  00
    ...
    ${sTime2}=  db.add_timezone_time  ${tz}  1  45
    ${eTime2}=  db.add_timezone_time  ${tz}   2  30
    ...
    ${resp}=    Send Otp For Login    ${primaryMobileNo}    ${pid0}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer SignUp    ${firstName}  ${lastName}  ${email}    ${primaryMobileNo}     ${pid0}
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200    
   
    ${resp}=    ProviderConsumer Login with token   ${primaryMobileNo}    ${pid0}  ${token} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
#     Should Be Equal As Strings    ${resp.status_code}   200
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[0]}  partySize=1  appxWaitingTime=0   personsAhead=0
...
JD-TC-Add To WaitlistByConsumer-2
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[0]}  partySize=1  appxWaitingTime=5   personsAhead=1
...
JD-TC-Add To WaitlistByConsumer-6
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${TOMORROW}  waitlistStatus=${wl_status[0]}  partySize=1  appxWaitingTime=0   personsAhead=0
    Should Be Equal As Strings  ${resp.json()['service']['name']}  ${P1SERVICE1}
    Should Be Equal As Strings  ${resp.json()['service']['id']}  ${p1_s1}
    # Should Be Equal As Strings  ${resp.json()['jaldeeConsumer']['id']}  ${cid}
    Should Be Equal As Strings  ${resp.json()['waitlistingFor'][0]['id']}  ${cid} 
...
#     ${cid}=  get_id  ${CUSERNAME5}
    ...
    ${p1queue2}=    FakerLibrary.word
    ${sTime2}=  db.add_timezone_time  ${tz}  2  45
    ${eTime2}=  db.add_timezone_time  ${tz}   3  15
    ${list}=  Create List  1  2  3  4  5  6  7
    ${capacity}=  FakerLibrary.Numerify  %%
...
JD-TC-Add To WaitlistByConsumer-18
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[3]} 
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[7]} 
    Should Be Equal As Strings  ${resp.json()['service']['name']}  ${SERVICE1}
    Should Be Equal As Strings  ${resp.json()['service']['id']}  ${Sid1_s1}
    Should Be Equal As Strings  ${resp.json()['jaldeeConsumer']['id']}  ${cid15}
    Should Be Equal As Strings  ${resp.json()['waitlistingFor'][0]['id']}  ${pcons_id2} 
...
#     ${cid}=  get_id  ${CUSERNAME5}
    ...
    ${p1queue1}=    FakerLibrary.word
    ${sTime1}=  db.add_timezone_time  ${tz}  3  30
...
JD-TC-Add To WaitlistByConsumer-UH3
    ...
    ${eTime1}=  db.add_timezone_time  ${tz}   4  45
    ${list}=  Create List  1  2  3  4  5  6  7
    ${capacity}=  FakerLibrary.Numerify  %%
    ${resp}=  Create Queue  ${p1queue1}  ${recurringtype[1]}  ${list}  ${DAY}  ${EMPTY}  ${EMPTY}  ${sTime1}  ${eTime1}  ${parallel[0]}  ${capacity}  ${p1_l1}  ${p1_s1}  ${p1_s2} 
    Log  ${resp.content} 
...
JD-TC-Add To WaitlistByConsumer-UH7
    ...
    ${sTime1}=  db.add_timezone_time  ${tz}  5  00
    ${eTime1}=  db.add_timezone_time  ${tz}   5  30
    ${list}=  Create List  1  2  3  4  5  6  7
    ${capacity}=  FakerLibrary.Numerify  %%
...
JD-TC-Add To WaitlistByConsumer-UH12
    ...
    ${p1queue1}=    FakerLibrary.word
    ${sTime1}=  db.add_timezone_time  ${tz}  5  45
    ${eTime1}=  db.add_timezone_time  ${tz}   6  30
    ${list}=  Create List  1  2  3  4  5  6  7
    ${capacity}=  FakerLibrary.Numerify  %%
...
#     ${cid}=  get_id  ${CUSERNAME5}
    ...
    ${p1queue1}=    FakerLibrary.word
    ${sTime1}=  db.add_timezone_time  ${tz}  1  45
    ${eTime1}=  db.add_timezone_time  ${tz}   4  30
...
JD-TC-Add To WaitlistByConsumer-UH15
    ...
    ${p1queue1}=    FakerLibrary.word
    ${sQTime3}=  db.add_timezone_time  ${tz}  0  15
    ${eQTime3}=  db.add_timezone_time  ${tz}   0  20
    ${list}=  Create List  1  2  3  4  5  6  7
    ${capacity}=  FakerLibrary.Numerify  %%
...
JD-TC-Add To WaitlistByConsumer-UH16
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[3]}  partySize=1  appxWaitingTime=0 
...
JD-TC-Add To WaitlistByConsumer-24
    ...
    Set Suite Variable  ${tz}
    ${sTime}=  db.get_time_by_timezone  ${tz}
    ${eTime}=  db.add_timezone_time  ${tz}   4  15
    ${desc}=   FakerLibrary.sentence
    ${url}=   FakerLibrary.url
    ${parking}   Random Element   ${parkingType}
    ${resp}=  Update Business Profile with schedule  ${bs}  ${desc}   ${companySuffix}  ${city}   ${longi}  ${latti}  ${url}  ${parking}  ${bool[1]}  ${recurringtype[1]}  ${list}  ${DAY}  ${EMPTY}  ${EMPTY}  ${sTime}  ${eTime}  ${postcode}  ${address}  ${ph_nos1}  ${ph_nos2}  ${emails1}  ${EMPTY}
...
#     ${cid}=  get_id  ${CUSERNAME5}
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[0]}  partySize=1  appxWaitingTime=0 
    Should Be Equal As Strings  ${resp.json()['service']['name']}  ${P1SERVICE1}
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[0]}  partySize=1  appxWaitingTime=12 
    Should Be Equal As Strings  ${resp.json()['service']['name']}  ${P1SERVICE1}
    Should Be Equal As Strings  ${resp.json()['service']['id']}  ${ps1}
    # Should Be Equal As Strings  ${resp.json()['jaldeeConsumer']['id']}  ${cid}
...
JD-TC-Add To WaitlistByConsumer-25
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${DAY}  waitlistStatus=${wl_status[3]}  partySize=1  appxWaitingTime=12 
    Should Be Equal As Strings  ${resp.json()['service']['name']}  ${P2SERVICE2}
    Should Be Equal As Strings  ${resp.json()['service']['id']}  ${ps2}
    # Should Be Equal As Strings  ${resp.json()['jaldeeConsumer']['id']}  ${cid}
    Should Be Equal As Strings  ${resp.json()['waitlistingFor'][0]['jaldeeFamilyMemberId']}  ${f1}
...
JD-TC-Add To WaitlistByConsumer-UH18
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${TODAY}  waitlistStatus=${wl_status[0]}  partySize=1  
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${TODAY}  waitlistStatus=${wl_status[4]}  partySize=1  
...
JD-TC-Add To WaitlistByConsumer-UH19
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${TOMORROW}  waitlistStatus=${wl_status[0]}  partySize=1  
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  date=${TOMORROW}  waitlistStatus=${wl_status[4]}  partySize=1  
