...
JD-TC-AccountLevelAnalytics-1
    [Documentation]   take checkins for normal service  for a provider and check account level analytics
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['WALK_IN_TOKEN']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    ...
    ${resp}=  Account Level Analytics   metricId=${tokenAnalyticsMetrics['TOTAL_FOR_TOKEN']}    deptId=${dep_id}   accId=${accid}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Account Level Analytics   metricId=${tokenAnalyticsMetrics['WEB_TOKENS']}    deptId=${dep_id}   accId=${accid}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AccountLevelAnalytics-2
    ...
    ${resp}=  Account Level Analytics   metricId=${tokenAnalyticsMetrics['TELE_SERVICE_TOKEN']}    deptId=${dep_id}   accId=${accid}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AccountLevelAnalytics-3
    [Documentation]   take online checkins, for a provider and check account level analytics 
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['ONLINE_TOKEN']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['ARRIVED_TOKEN']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['CHECKED_IN_TOKEN']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AccountLevelAnalytics-4
    ...
    ${resp}=  Get Account Level Analytics  metricId=${paymentAnalyticsMetrics['PRE_PAYMENT_COUNT']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Account Level Analytics  metricId=${paymentAnalyticsMetrics['PRE_PAYMENT_TOTAL']}  deptId=${dep_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200


JD-TC-AccountLevelAnalytics-5
    [Documentation]   take checkins,for a provider and check account level analytics for waitlist actions
    # [Setup]  Run Keywords  clear_queue  ${PUSERNAME_E}   AND  clear_appt_schedule   ${PUSERNAME_E}
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['STARTED_TOKEN']}  userId=${u_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['CHECKED_IN_TOKEN']}  userId=${u_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['ARRIVED_TOKEN']}  userId=${u_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Verify Response  ${resp}  frequency=DAILY   metricId=${tokenAnalyticsMetrics['ARRIVED_TOKEN']}  
    # Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${len2}
    ...
    ${resp}=  Account Level Analytics  metricId=${tokenAnalyticsMetrics['CANCELLED_TOKEN']}  userId=${u_id}   accId=${accid}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
