...
JD-TC-Getorderbyenclosedid-1
    ...
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME104}.${test_mail}
...
JD-TC-Getorderbyenclosedid-2
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME105}.${test_mail}
...
JD-TC-Getorderbyenclosedid-3
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME142}.${test_mail}
