...
JD-TC-Remove All Item From Cart-1
...
# -------------------------------- Create store type -----------------------------------
    ...
    ${PhoneNumber}=  Evaluate  ${PUSERNAME}+303187748
...
# -------------------------------- Add a provider Consumer -----------------------------------
    ...
    ${primaryMobileNo}    Generate random string    10    123458769
    ...
    ${resp}=    Remove All Items From Cart   ${cartUid} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    Should Be Equal As Strings    ${resp.json()['netTotal']}                                                            0.0
