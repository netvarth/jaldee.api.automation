...
JD-TC-Get OrderCount Filter-1

    [Documentation]  Get Order Count- Filter using account id and storeencid
...
# -------------------------------- Create store type -----------------------------------
    ...
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${accountId}=  get_acc_id  ${HLPUSERNAME25}
...
# -------------------------------- Add a provider Consumer -----------------------------------
    ...
    ${resp}=    Get Order Count- Filter  providerConsumerId-eq=${cid}   soCatalogEncId-eq=${soc_id1}   accountId-eq=${accountId}   storeEncId-eq=${store_id}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1


JD-TC-Get OrderCount Filter-2
    [Documentation]  Get Order Count- Filter using provider consumer id
    ...
    ${resp}=    Get Order Count- Filter  providerConsumerId-eq=${cid}   
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1


JD-TC-Get OrderCount Filter-3
    [Documentation]  Get Order Count- Filter using sorderCatalogEncId
    ...
    ${resp}=    Get Order Count- Filter   soCatalogEncId-eq=${soc_id1} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1


JD-TC-Get OrderCount Filter-4
    [Documentation]  Get Order Count- Filter using ordertype
    ...
    ${resp}=    Get Order Count- Filter   orderType-eq=${orderType} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1


JD-TC-Get OrderCount Filter-5
    [Documentation]  Get Order Count- Filter using orderStatus
    ...
    ${resp}=    Get Order Count- Filter   orderStatus-eq=${orderStatus} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1


JD-TC-Get OrderCount Filter-6
    [Documentation]  Get Order Count- Filter using deliveryType
...
JD-TC-Get OrderCount Filter-7
    [Documentation]  Get Order Count- Filter using createdDate
    ...
    ${resp}=    Get Order Count- Filter   createdDate-eq=${DAY1} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings   ${resp.json()}    1
