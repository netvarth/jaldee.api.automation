...
JD-TC-Save_Report_Criteria-1
    [Documentation]  Save Appointment report  
    ${resp}=  Encrypted Provider Login  ${PUSERNAME27}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ${pid}=  get_acc_id  ${PUSERNAME27}
    ...
    ${PUSERPH_id2}=  Evaluate  ${PUSERNAME}+10145601
    ...
    ${resp}=  Create Appointment Schedule  ${schedule_name}  ${recurringtype[1]}  ${list}  ${DAY}  ${DAY2}  ${EMPTY}  ${sTime1}  ${eTime1}  ${parallel}    ${parallel}  ${p1_l1}  ${duration}  ${bool1}  ${p1_s1}  ${p1_s2}   ${v1_s1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${filter3}=  Create Dictionary   apptForId-eq=${jid_c6},${jid_c6_f1},${jid_c6_f2}  
    ${resp}=  Save Report Criteria  ${reportNames[1]}  ${reportType}  ${reportDateCategory}  ${filter3}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200 
    Should Be Equal As Strings   ${resp.json()[0]['reportCriteria']['apptForId-eq']}     ${jid_c6},${jid_c6_f1},${jid_c6_f2}
    Should Be Equal As Strings   ${resp.json()[0]['reportName']}             ${reportNames[1]}
    Should Be Equal As Strings   ${resp.json()[0]['reportType']}             ${reportType}
    Should Be Equal As Strings   ${resp.json()[0]['reportDateCategory']}     ${reportDateCategory}

    Should Be Equal As Strings   ${resp.json()[1]['reportCriteria']['apptForId-eq']}     ${jid_c6}
    Should Be Equal As Strings   ${resp.json()[1]['reportName']}             ${reportNames[0]}
    Should Be Equal As Strings   ${resp.json()[1]['reportType']}             ${reportType}
    Should Be Equal As Strings   ${resp.json()[1]['reportDateCategory']}     ${reportDateCategory}



JD-TC-Save_Report_Criteria-2
    [Documentation]   Save report using same Report_Name and different report_Type 
    ...
    Set Test Variable  ${reportDateCategory}      TODAY
    ${filter2}=  Create Dictionary   apptForId-eq=${jid_c6} 
    ${resp}=  Save Report Criteria  ${reportNames[3]}  ${reportType}  ${reportDateCategory}  ${filter2}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200 
    Should Be Equal As Strings   ${resp.json()[0]['reportCriteria']['apptForId-eq']}     ${jid_c6}
    Should Be Equal As Strings   ${resp.json()[0]['reportName']}             ${reportNames[3]}
    Should Be Equal As Strings   ${resp.json()[0]['reportType']}             ${reportType}
    Should Be Equal As Strings   ${resp.json()[0]['reportDateCategory']}     ${reportDateCategory}
    ...
    ${filter3}=  Create Dictionary   apptForId-eq=${jid_c6},${jid_c6_f1},${jid_c6_f2}   
    ${resp}=  Save Report Criteria  ${reportNames[3]}  ${reportType2}  ${reportDateCategory2}  ${filter3}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ${resp}=  Get Report Criteria  
    Log  ${resp.json()}
    ...
    Should Be Equal As Strings   ${resp.json()[0]['reportCriteria']['apptForId-eq']}     ${jid_c6},${jid_c6_f1},${jid_c6_f2}
    Should Be Equal As Strings   ${resp.json()[0]['reportName']}             ${reportNames[3]}
    Should Be Equal As Strings   ${resp.json()[0]['reportType']}             ${reportType2}
    Should Be Equal As Strings   ${resp.json()[0]['reportDateCategory']}     ${reportDateCategory2}
    Should Be Equal As Strings   ${resp.json()[1]['reportCriteria']['apptForId-eq']}     ${jid_c6}
    Should Be Equal As Strings   ${resp.json()[1]['reportName']}             ${reportNames[3]}
    Should Be Equal As Strings   ${resp.json()[1]['reportType']}             ${reportType}
    Should Be Equal As Strings   ${resp.json()[1]['reportDateCategory']}     ${reportDateCategory}
...
JD-TC-Save_Report_Criteria-UH1
    [Documentation]   Save report using same Report_Name and same report_Type
    ${resp}=  Encrypted Provider Login  ${PUSERNAME17}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Set Test Variable  ${reportDateCategory}      TODAY
    ${filter2}=  Create Dictionary   apptForId-eq=${jid_c6} 
    ${resp}=  Save Report Criteria  ${reportNames[4]}  ${reportType}  ${reportDateCategory}  ${filter2}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings  ${resp.status_code}  200 
    Should Be Equal As Strings   ${resp.json()[0]['reportCriteria']['apptForId-eq']}     ${jid_c6}
    Should Be Equal As Strings   ${resp.json()[0]['reportName']}             ${reportNames[4]}
    Should Be Equal As Strings   ${resp.json()[0]['reportType']}             ${reportType}
    Should Be Equal As Strings   ${resp.json()[0]['reportDateCategory']}     ${reportDateCategory}

    Set Test Variable  ${reportDateCategory2}      LAST_WEEK
    ${filter3}=  Create Dictionary   apptForId-eq=${jid_c6},${jid_c6_f1},${jid_c6_f2}   
    ${resp}=  Save Report Criteria  ${reportNames[4]}  ${reportType}  ${reportDateCategory2}  ${filter3}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  "${resp.json()}"  "${REPORT_NAME_EXIST}"


JD-TC-Save_Report_Criteria-UH2
    [Documentation]   Save report using Report_Name start with special characters
    ${resp}=  Encrypted Provider Login  ${PUSERNAME17}  ${PASSWORD}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Set Test Variable  ${reportDateCategory2}     LAST_WEEK
    ${filter3}=  Create Dictionary   apptForId-eq=${jid_c6},${jid_c6_f1},${jid_c6_f2}   
    ${resp}=  Save Report Criteria  ${reportNames[6]}  ${reportType}  ${reportDateCategory2}  ${filter3}
    # Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  "${resp.json()}"  "${VALID_REPORT_NAME}"


JD-TC-Save_Report_Criteria-UH3
    [Documentation]   Save report Without login
    
    Set Test Variable  ${reportType}              DONATION
    Set Test Variable  ${reportDateCategory}      TODAY
    ${filter}=  Create Dictionary   apptForId-eq=${jid_c6} 
    ${resp}=  Save Report Criteria  ${reportNames[0]}  ${reportType}  ${reportDateCategory}  ${filter}
    # Log  ${resp.json()}
...
JD-TC-Save_Report_Criteria-UH4
    [Documentation]   Login as consumer and Save report
