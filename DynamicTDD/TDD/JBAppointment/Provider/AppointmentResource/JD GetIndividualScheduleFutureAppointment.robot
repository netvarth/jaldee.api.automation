...
JD-TC-GetIndividualScheduleFutureAppointment-1

    [Documentation]  Get provider's Individual Schedule future appointment list and their count.
    ...
    ${ad2}=   Create Dictionary  availableDate=${DAY4}       availabilityTime=${time}

    ${iA}=   Create List    ${iA}   ${ad}   ${ad1}  ${ad2}
...
JD-TC-GetIndividualScheduleFutureAppointment-2
    ...
    ${cnote}=   FakerLibrary.name
    ${resp}=   Take Appointment For Provider   ${pid}  ${s_id1}  ${sch_id2}  ${DAY4}  ${cnote}   ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-GetIndividualScheduleFutureAppointment-3
...
JD-TC-GetIndividualScheduleFutureAppointment-4

    [Documentation]  Get provider's future appointment list based on payment status
    
    # ${billable_providers}=    Billable Domain Providers
    Log   ${billable_providers}
    Set Suite Variable   ${billable_providers}
    ${pro_len}=  Get Length   ${billable_providers}
    clear_service   ${billable_providers[6]}
    ...
    END
    # Verify Response List   ${resp}  1  uid=${apptid1}  appointmentEncId=${encId1}  appmtDate=${DAY3}  appmtTime=${slot1}  apptBy=CONSUMER   paymentStatus=${paymentStatus[1]}  appointmentMode=${appointmentMode[2]}  apptStatus=${apptStatus[1]}
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    # ${resp}=  Make payment Consumer Mock   ${amount_payable}  ${bool[1]}  ${apptid1}  ${pid}  ${purpose[1]}   ${jdconID}
    # Log  ${resp.json()}
    # Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings   ${resp.json()['merchantId']}  ${merchantid}  
    Set Test Variable   ${payref}   ${resp.json()['paymentRefId']}
...
JD-TC-GetIndividualScheduleFutureAppointment-5
...
JD-TC-GetIndividualScheduleFutureAppointment-6
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer  ${cid2}  ${s_id1}  ${sch_id}  ${DAY3}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-GetIndividualScheduleFutureAppointment-7
...
JD-TC-GetIndividualScheduleFutureAppointment-8
...
JD-TC-GetIndividualScheduleFutureAppointment-9
...
JD-TC-GetIndividualScheduleFutureAppointment-10
...
JD-TC-GetIndividualScheduleFutureAppointment-11
...
JD-TC-GetIndividualScheduleFutureAppointment-12
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer  ${cid2}  ${s_id1}  ${sch_id}  ${DAY4}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-GetIndividualScheduleFutureAppointment-13
...
JD-TC-GetIndividualScheduleFutureAppointment-14
...
JD-TC-GetIndividualScheduleFutureAppointment-15
    ...
    clear_service    ${multilocPro[6]}
    clear_location   ${multilocPro[6]}
    ...
    ${duration}=  FakerLibrary.Random Int  min=1  max=${maxval}
    ${bool1}=  Random Element  ${bool}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid2}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
...
JD-TC-GetIndividualScheduleFutureAppointment-16
...
JD-TC-GetIndividualScheduleFutureAppointment-17
...
JD-TC-GetIndividualScheduleFutureAppointment-18
...
JD-TC-GetIndividualScheduleFutureAppointment-19
...
JD-TC-GetIndividualScheduleFutureAppointment-20
    ...
    ${resp}=  Get Consumer By Id  ${CUSERNAME33}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Consumer By Id  ${CUSERNAME34}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Append To List   ${gens}   ${resp.json()['userProfile']['gender']}
...
JD-TC-GetIndividualScheduleFutureAppointment-21
...
JD-TC-GetIndividualScheduleFutureAppointment-22
...
JD-TC-GetIndividualScheduleFutureAppointment-UH1
    ...
    ${resp}=  Get Future Appointments   date-eq=${DAY4}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-GetIndividualScheduleFutureAppointment-UH2
...
JD-TC-GetIndividualScheduleFutureAppointment-UH3
...
JD-TC-GetIndividualScheduleFutureAppointment-UH4
