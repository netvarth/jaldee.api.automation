...
JD-TC-Take Individual Schedule Appointment-1
    [Documentation]  Provider takes appointment for a valid provider consumer when appointment and today appointment is enabled
    ...
    ${resp}=  AddCustomer  ${primaryMobileNo}  firstName=${proconfname}   lastName=${proconlname}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${proconfname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${proconlname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
    Should Be Equal As Strings  ${resp.json()['schedule']['id']}   ${sch_id}
    Should Be Equal As Strings  ${resp.json()['apptStatus']}   ${apptStatus[1]}
    Should Be Equal As Strings  ${resp.json()['appmtFor'][0]['firstName']}   ${proconfname}
    Should Be Equal As Strings  ${resp.json()['appmtFor'][0]['lastName']}   ${proconlname}
    Should Be Equal As Strings  ${resp.json()['appmtFor'][0]['apptTime']}   ${slot1}
    Should Be Equal As Strings  ${resp.json()['appmtDate']}   ${DAY1}
    Should Be Equal As Strings  ${resp.json()['appmtTime']}   ${slot1}
    Should Be Equal As Strings  ${resp.json()['location']['id']}   ${lid}
    Should Be Equal As Strings  ${resp.json()['scheduleType']}   individual

    Should Be Equal As Strings  ${resp.json()['schedule']['name']}   ${schedule_name}
    Should Be Equal As Strings  ${resp.json()['schedule']['individualApptSchedule'][0]['availableDate']}   ${DAY1}
    Should Be Equal As Strings  ${resp.json()['schedule']['scheduleType']}   individual
    # Should Be Equal As Strings  ${resp.json()['location']['id']}   ${lid}
...
JD-TC-Take Individual Schedule Appointment-2
    [Documentation]  Provider takes phone in individual Schedule Appt for consumer
...
JD-TC-Take Individual Schedule Appointment-3
...
JD-TC-Take Individual Schedule Appointment-4
    ...
    ${dob}=      FakerLibrary.date
    ${resp}=  AddFamilyMemberByProvider  ${cid}  ${mem_fname1}  ${mem_lname1}  ${dob}  ${Genderlist[0]}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${apptfor3}=  Create Dictionary  id=${mem_id1}   apptTime=${slot1}
    ...
    ${apptid2}=  Get From Dictionary  ${resp.json()}  ${proconfname}
    # ${apptid}=  Get Dictionary Values  ${resp.json()}   sort_keys=False
    # Set Test Variable  ${apptid1}  ${apptid[0]}
...
JD-TC-Take Individual Schedule Appointment-5
...
JD-TC-Take Individual Schedule Appointment-6
...
JD-TC-Take Individual Schedule Appointment-7
    [Documentation]  Provider takes appointment for consumer for Past date
    ${resp}=  Encrypted Provider Login  ${PUSERNAME144}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    clear_service   ${PUSERNAME144}
...
JD-TC-Take Individual Schedule Appointment-11
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name1}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer   ${cid}  ${s_id1}  ${sch_id2}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-12
    [Documentation]  Provider takes 2 different appointments for same consumer for different time
    ${resp}=  Encrypted Provider Login  ${PUSERNAME144}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    clear_service   ${PUSERNAME144}
    ...
    ${sTime2}=  db.add_timezone_time  ${tz}  0  30 
    ${sTime3}=  db.add_timezone_time  ${tz}  0  35 
    ...
    ${time}=   Create List    ${sTime1}     ${sTime2}   ${sTime3}       ${sTime3}-${sTime2}
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name1}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
...
JD-TC-Take Individual Schedule Appointment-13
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid1}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer   ${cid}  ${s_id}  ${sch_id2}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-16
...
JD-TC-Take Individual Schedule Appointment-18
...
JD-TC-Take Individual Schedule Appointment-19
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid1}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
...
JD-TC-Take Individual Schedule Appointment-20
...
JD-TC-Take Individual Schedule Appointment-21
...
JD-TC-Take Individual Schedule Appointment-22
    ...
    ${time}=   Create List    ${sTime1}     ${eTime1}
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
...
JD-TC-Take Individual Schedule Appointment-23
    ...
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['primaryMobileNo']}   ${primaryMobileNo}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
    Should Be Equal As Strings  ${resp.json()['schedule']['id']}   ${sch_id}
...
JD-TC-Take Individual Schedule Appointment-24
...
JD-TC-Take Individual Schedule Appointment-25
...
JD-TC-Take Individual Schedule Appointment-26
...
JD-TC-Take Individual Schedule Appointment-28
    ...
    ${time}=   Create List    ${eTime2}
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Update Individual Schedule    ${sch_id}   ${schedule_name}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-32
...
JD-TC-Take Individual Schedule Appointment-33
...
JD-TC-Take Individual Schedule Appointment-34
    ...
    ${time}=   Create List    ${sTime1}
    ${iA}=   Create Dictionary  availableDate=${DAY3}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-35
...
JD-TC-Take Individual Schedule Appointment-36
    [Documentation]  take appointment for future after disabling future appointment
...
JD-TC-Take Individual Schedule Appointment-37
...
JD-TC-Take Individual Schedule Appointment-38
...
JD-TC-Take Individual Schedule Appointment-39
...
JD-TC-Take Individual Schedule Appointment-UH1
...
JD-TC-Take Individual Schedule Appointment-UH2
...
JD-TC-Take Individual Schedule Appointment-UH4
...
JD-TC-Take Individual Schedule Appointment-UH5
...
JD-TC-Take Individual Schedule Appointment-UH6
...
JD-TC-Take Individual Schedule Appointment-UH7
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id1}  ${resp.json()}
...
JD-TC-Take Individual Schedule Appointment-UH8
    ...
    ${apptfor}=   Create List  ${apptfor1}
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer  0  ${s_id}  ${sch_id}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  404
    Should Be Equal As Strings  "${resp.json()}"  "${INVALID_CONSUMER}"
    

JD-TC-Take Individual Schedule Appointment-UH9
...
JD-TC-Take Individual Schedule Appointment-UH10
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name1}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id1}  ${resp.json()}
...
JD-TC-Take Individual Schedule Appointment-UH11
...
JD-TC-Take Individual Schedule Appointment-UH12
...
JD-TC-Take Individual Schedule Appointment-UH13
...
JD-TC-Take Individual Schedule Appointment-UH14
...
JD-TC-Take Individual Schedule Appointment-UH15
...
JD-TC-Take Individual Schedule Appointment-UH16
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY3}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
...
JD-TC-Take Individual Schedule Appointment-UH17
...
JD-TC-Take Individual Schedule Appointment-UH18
...
JD-TC-Take Individual Schedule Appointment-UH20
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment with Appointment Mode  ${appointmentMode[2]}   ${cid}  ${s_id}  ${sch_id}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  "${resp.json()}"  "${INVALID_APPOINTMENT_MODE}"
    
    
JD-TC-Take Individual Schedule Appointment-UH21
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment with Appointment Mode  ${EMPTY}   ${cid}  ${s_id}  ${sch_id}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  500
    Should Be Equal As Strings  "${resp.json()}"  "${JALDEE_OUT_OF_REACH_PROBLEM}"

JD-TC-Take Individual Schedule Appointment-UH22
...
JD-TC-Take Individual Schedule Appointment-UH23
...
JD-TC-Take Individual Schedule Appointment-UH24
...
JD-TC-Take Individual Schedule Appointment-UH25
...
JD-TC-Take Individual Schedule Appointment-UH26
...
JD-TC-Take Individual Schedule Appointment-UH27
...
JD-TC-Take Individual Schedule Appointment-UH28
...
JD-TC-Take Individual Schedule Appointment-UH29
...
JD-TC-Take Individual Schedule Appointment-40
    ...
    ${resp}=  Take Appointment with Phone no  ${cid}  ${s_id}  ${sch_id}  ${DAY1}  ${CUSERPH8}  91  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-41
    ...
    ${country_code}    Convert To Integer  ${country_code}
    ${CUSERPH8}=  Evaluate  ${CUSERNAME8}+${PO_Number}
    ${resp}=  Take Appointment with Phone no  ${cid}  ${s_id}  ${sch_id}  ${DAY1}  1746173745  880  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Take Individual Schedule Appointment-42
    ...
    ${cnote}=   FakerLibrary.word
    ${resp}=  Take Appointment For Consumer   ${mem_id}  ${s_id}  ${sch_id}  ${DAY1}  ${cnote}  ${apptfor}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ${apptid}=  Get Dictionary Values  ${resp.json()}   sort_keys=False
    Set Test Variable  ${apptid1}  ${apptid[0]}
...
JD-TC-Take Individual Schedule Appointment-45
...
JD-TC-Take Individual Schedule Appointment-UH32
    [Documentation]  create holiday for a time period in between the schedule, not the entire schedule.
...
JD-TC-Take Individual Schedule Appointment-46
