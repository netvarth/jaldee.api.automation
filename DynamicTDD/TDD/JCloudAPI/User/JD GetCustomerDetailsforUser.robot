...
JD-TC-GetCustomerDetailsForUser-1
...
JD-TC-GetCustomerDetailsForUser-2
    ...
    ${resp}=  Get Customer Details  ${user_token1}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()[0]['id']}           ${pcons_id3}
    Should Be Equal As Strings  ${resp.json()[0]['phoneNo']}      ${CUSERNAME3}


JD-TC-GetCustomerDetailsForUser-3
...
JD-TC-GetCustomerDetailsForUser-4
...
JD-TC-GetCustomerDetailsForUser-5
...
JD-TC-GetCustomerDetailsForUser-6
...
JD-TC-GetCustomerDetailsForUser-7
    ...
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()[1]['id']}           ${pcons_id3}
    Should Be Equal As Strings  ${resp.json()[1]['phoneNo']}      ${CUSERNAME3}

    Should Be Equal As Strings  ${resp.json()[0]['id']}           ${pcons_id0}
    Should Be Equal As Strings  ${resp.json()[0]['phoneNo']}      ${CUSERNAME10}


# JD-TC-GetCustomerDetailsForUser-
...
JD-TC-GetCustomerDetailsForUser-UH1
...
JD-TC-GetCustomerDetailsForUser-UH2
