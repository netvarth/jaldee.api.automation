...
JD-TC-AccountLevelAnalytics-2
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${s2_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${s2_num_slots}  
        ...
        ${apptfor1}=  Create Dictionary  id=${cid${a}}   apptTime=${s2_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-3
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${vs1_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${vs1_num_slots}  
        ...
        ${apptfor1}=  Create Dictionary  id=${cid${a}}   apptTime=${vs1_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-4
    ...
    ...  ${resp.json()['apptSchedule']['startDate']}  ${resp.json()['apptSchedule']['terminator']['endDate']}  ${EMPTY}  ${resp.json()['apptSchedule']['timeSlots'][0]['sTime']}
    ...  ${resp.json()['apptSchedule']['timeSlots'][0]['eTime']}  3    3  ${lid}  ${resp.json()['timeDuration']}  ${bool[1]}  ${s_id4}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AccountLevelAnalytics-5
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${s5_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${self}   apptTime=${s5_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-6
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${vs2_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${vs2_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${self}   apptTime=${vs2_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-8
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${s8_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${self}   apptTime=${s8_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-9
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${vs3_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${self}   apptTime=${vs3_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-10
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${s10_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${s10_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${cid${a}}   apptTime=${s10_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-11
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${s11_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        ${apptfor1}=  Create Dictionary  id=${cid${a}}   apptTime=${s11_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-12
    ...
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        Run Keyword If  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   Append To List   ${vs4_slots}  ${resp.json()['availableSlots'][${i}]['time']}
    END
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        Exit For Loop If    ${a}>=${vs4_slots_len}  
        ...
        ${apptfor1}=  Create Dictionary  id=${cid${a}}   apptTime=${vs4_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-17
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        ${apptfor1}=  Create Dictionary  id=${self}   apptTime=${s13_slots[${a}]}
        ${apptfor}=   Create List  ${apptfor1}
...
JD-TC-AccountLevelAnalytics-20
    [Documentation]   change status from arrived to cancelled and check ARRIVED_APPMT and CANCELLED_APPMT metrics
...
JD-TC-AccountLevelAnalytics-26
    ...
    ${completed_appt_ids}=  Create List
    FOR   ${a}  IN RANGE   ${count}
    ...
    ${completed_appt_len}=  Get Length  ${completed_appt_ids}
    # Set Suite Variable   ${started_appt_len}
    ${arrived_appt_len}=  Evaluate  len($walkin_appt_ids) + len($walkin_prepay_appt_ids) + len($walkin_vs_appt_ids) - len($cancelled_walkin_appt_ids) - len($rejected_walkin_appt_ids) - $completed_appt_len
    # Set Suite Variable   ${arrived_appt_len}
...
JD-TC-AccountLevelAnalytics-28
    ...
    # ${SERVICE13}=    Set Variable  ${ser_names[12]}
    # ${s_id13}=  Create Sample Service  ${SERVICE13}
    # Set Suite Variable  ${s_id13}
    ...
    ${cancelled_appt_len}=  Evaluate  len($cancelled_online_appt_ids) + len($cancelled_online_prepay_appt_ids) + len($cancelled_walkin_appt_ids) + len($rejected_online_appt_ids) + len($rejected_walkin_appt_ids) - len($confirmed_appt_ids) - len($arrived_appt_ids)
    # Set Suite Variable   ${cancelled_appt_len}
...
JD-TC-AccountLevelAnalytics-29
    ...
    ${cancelled_appt_len}=  Evaluate  len($cancelled_online_appt_ids) + len($cancelled_online_prepay_appt_ids) + len($cancelled_walkin_appt_ids) + len($rejected_online_appt_ids) + len($rejected_walkin_appt_ids) - len($confirmed_appt_ids) - len($arrived_appt_ids) - len($started_appt_ids)
    # Set Suite Variable   ${cancelled_appt_len}
...
JD-TC-AccountLevelAnalytics-30
    [Documentation]   change status from rejected to confirmed and check CONFIRMED_APPMT and CANCELLED_APPMT metrics
...
JD-TC-AccountLevelAnalytics-32
    ...
    ${SERVICE19}=    Set Variable  ${ser_names[18]}
...
JD-TC-AccountLevelAnalytics-35
    ...
    FOR   ${a}  IN RANGE   ${count}
        ...
        ${cnote}=   FakerLibrary.word
        ${resp}=  Take Appointment For Consumer  ${cid${a}}  ${s_id21}  ${sch_id6}  ${DAY1}  ${cnote}  ${apptfor}
        Log  ${resp.content}
        Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-AccountLevelAnalytics-36
    ...
    ${s_id20}=  Create Sample Service  ${SERVICE22}  maxBookingsAllowed=10
...
JD-TC-AccountLevelAnalytics-45
...
JD-TC-AccountLevelAnalytics-46
