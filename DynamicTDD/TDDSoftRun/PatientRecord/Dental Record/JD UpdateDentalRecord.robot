...
JD-TC-Update Dental Record-10

    [Documentation]    Update Dental records with new toothConditions.
    ...
    ${resp}=    Update DentalRecord    ${id}    ${toothNo1}  ${toothType[1]}  ${caseUId}    investigation=${investigation}    toothSurfaces=${toothSurfaces}    toothConditions=${toothConditions}
    Log   ${resp.json()}
    Should Be Equal As Strings              ${resp.status_code}   200
