...
JD-TC-Get Prescription Template By Account Id-1
...
JD-TC-Get Prescription Template By Account Id-UH1
...
JD-TC-Get Prescription Template By Account Id-UH2
    ...
    [Documentation]    Get Prescription Template By Account Id without login
...
JD-TC-Get Prescription Template By Account Id-2
    ...
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][0]['medicineName']}     ${medicineName1}
    ...
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][0]['instructions']}     ${instructions1}
...
JD-TC-Get Prescription Template By Account Id-3
    ...
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    Should Be Equal As Strings    ${resp.json()[0]['id']}     ${temId1} 
...
JD-TC-Get Prescription Template By Account Id-7
    ...
    Should Be Equal As Strings    ${resp.json()[0]['id']}     ${temId1} 
    Should Be Equal As Strings    ${resp.json()[0]['templateName']}     ${templateName1} 
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][0]}     {}
...
JD-TC-Get Prescription Template By Account Id-8
    ...
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][0]['instructions']}     ${instructions1}
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][0]['dosage']}     ${dosage1}
     Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][1]['medicineName']}     ${medicineName2}
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][1]['frequency']}     ${frequency2}
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][1]['duration']}     ${duration2}
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][1]['instructions']}     ${instructions2}
    Should Be Equal As Strings    ${resp.json()[0]['prescriptionDto'][1]['dosage']}     ${dosage2}
