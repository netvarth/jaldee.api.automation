...
JD-TC-GET_All_IVR_USer_Details-2
...
JD-TC-GET_All_IVR_USer_Details-3
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${user_id}   ${resp.json()[3]['id']}
...
JD-TC-GET_All_IVR_USer_Details-4
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${id}   ${resp.json()[2]['id']}
    Set Test Variable  ${userId}   ${resp.json()[2]['userId']}
...
JD-TC-GET_All_IVR_USer_Details-UH2
...
JD-TC-GET_All_IVR_USer_Details-UH3
    ...
    ${resp}=    Update User Availability   ${so_id1}  ${Availability[0]}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  "${resp.json()}"   "${NO_ACTIVE_SCHEDULES_FOUND}"
