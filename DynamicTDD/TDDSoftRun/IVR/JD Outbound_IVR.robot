...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    create a call back    ${ivr_uid}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable    ${callback_refid}    ${resp.json()}

    ${incall_uid2}=    FakerLibrary.Random Number
    ${incall_id2}=    FakerLibrary.Random Number

#.......   call initiated by user to customer    ..........

    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${callback_refid}    ${company_id}  ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[3]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=    innode IVR    ${acc_id}     ${incall_uid2}    ${cons_verfy_node_value}    ${current_time}    ${clid}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Incoming call on server    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[1]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user answered    ...............................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[6]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      ..............................                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[2]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=    Get Ivr By Uid    ${callback_refid}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200

JD-TC-Outbound_IVR-2
...
#........  Incoming call on server    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[9]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user disconnected call    ...............................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[4]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user answered call    ...............................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[9]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Consumer disconnect the call    ......................

    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[4]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Outbound_IVR-UH1

    [Documentation]   Outbound IVR with consumer login
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${callback_refid1}=  FakerLibrary.Random Number
    ${incall_uid2}=    FakerLibrary.Random Number
    ${incall_id2}=    FakerLibrary.Random Number

#.......   call initiated by user to customer    ..........

    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${callback_refid}    ${company_id}  ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[3]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid1}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Incoming call on server    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[1]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid1}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user answered call    ...............................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[9]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${callback_refid1}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Consumer disconnect the call    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[4]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid1}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      ..............................                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[2]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${callback_refid1}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......   call initiated by user to customer    ..........
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${callback_refid}    ${company_id}  ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[3]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${SPACE}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Incoming call on server    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[1]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${SPACE}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user answered call    ...............................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[9]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${SPACE}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  Consumer disconnect the call    ......................
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[4]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${SPACE}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      ..............................                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id2}    ${incall_uid2}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[2]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${SPACE}     ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Outbound_IVR-UH4

    [Documentation]   Outbound IVR without login
