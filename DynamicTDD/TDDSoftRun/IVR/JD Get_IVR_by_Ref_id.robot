...
JD-TC-Get_IVR_By_Ref_Id-1
    ...
    ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME162}  ${countryCodes[1]}${PUSERNAME162}  ${user_id}  ${user_name}
...
#........  user answered    ........
    ...
    ${clid_user}=    Convert To String    ${countryCodes[1]}${PUSERNAME162}
