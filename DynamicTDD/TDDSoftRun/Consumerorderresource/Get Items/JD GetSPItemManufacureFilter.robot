...
JD-TC-Get sp item manufacturer Filter-1

    [Documentation]  Get sp item manufacturer Filter  using status
...
# -------------------------------- Add a provider Consumer -----------------------------------
    ...
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()[0]['manufacturerCode']}                                              ${manufacturerCode}
