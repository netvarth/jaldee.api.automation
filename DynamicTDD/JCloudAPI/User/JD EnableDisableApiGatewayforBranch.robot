...
JD-TC-EnableDisableApiGateway-3
...
JD-TC-EnableDisableApiGateway-4
    ...
    Run Keyword If  '${resp}' != '${None}'   Log  ${resp.content}
    Run Keyword If  '${resp}' != '${None}'   Should Be Equal As Strings  ${resp.status_code}  200
    # Run Keyword If  '${resp}' != '${None}'   Should Be Equal As Strings  ${resp.content}    "${LOGIN_NO_ACCESS_FOR_URL}"
