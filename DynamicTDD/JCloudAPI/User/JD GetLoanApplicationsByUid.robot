...
JD-TC-GetLoanApplicationsByUid-1
...
#  .....Get Loan Applications Public APi call....
    ...
    ${resp}=  Get Loan Applications By Uid  ${loanUid}  ${user_token}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Should Be Equal As Strings   ${resp.json()['customer']['firstName']}    ${Custfname}
    Should Be Equal As Strings   ${resp.json()['customer']['lastName']}     ${Custlname}
    Should Be Equal As Strings   ${resp.json()['customer']['phoneNo']}      ${consumernumber}
    Should Be Equal As Strings   ${resp.json()['partner']['id']}            ${partid1}
    Should Be Equal As Strings   ${resp.json()['partner']['partnerName']}   ${partnername1} 
    Should Be Equal As Strings   ${resp.json()['branch']['id']}             ${branchid1}
    Should Be Equal As Strings   ${resp.json()['branch']['branchName']}     ${branchName}
    Should Be Equal As Strings   ${resp.json()['location']['id']}           ${locId}
    Should Be Equal As Strings   ${resp.json()['location']['name']}         ${locname}
    Should Be Equal As Strings   ${resp.json()['spInternalStatus']}         ${LoanApplicationSpInternalStatus[4]}


JD-TC-GetLoanApplicationsByUid-2
...
#  .....Get Loan Applications Public APi call....
    ...
    ${resp}=  Get Loan Applications By Uid  ${loanUid1}  ${user_token}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings   ${resp.json()['id']}                       ${loanid1}
    Should Be Equal As Strings   ${resp.json()['uid']}                      ${loanUid1}
    Should Be Equal As Strings   ${resp.json()['accountId']}                ${account_id1}
    Should Be Equal As Strings   ${resp.json()['customer']['id']}           ${custid1}
    Should Be Equal As Strings   ${resp.json()['customer']['firstName']}    ${Custfname1}
    Should Be Equal As Strings   ${resp.json()['customer']['lastName']}     ${Custlname1}
    Should Be Equal As Strings   ${resp.json()['customer']['phoneNo']}      ${consumernumber1}
    Should Be Equal As Strings   ${resp.json()['partner']['id']}            ${partid2}
    Should Be Equal As Strings   ${resp.json()['partner']['partnerName']}   ${partnername2} 
    Should Be Equal As Strings   ${resp.json()['branch']['id']}             ${branchid1}
    Should Be Equal As Strings   ${resp.json()['branch']['branchName']}     ${branchName}
    Should Be Equal As Strings   ${resp.json()['location']['id']}           ${locId}
    Should Be Equal As Strings   ${resp.json()['location']['name']}         ${locname}
...
JD-TC-GetLoanApplicationsByUid-3
...
#  .....Get Loan Applications Public APi call....
    ...
    ${resp}=  Get Loan Applications By Uid   ${loanUid2}   ${user_token}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    Should Be Equal As Strings   ${resp.json()['id']}                       ${loanid2}
    Should Be Equal As Strings   ${resp.json()['uid']}                      ${loanUid2}
    Should Be Equal As Strings   ${resp.json()['accountId']}                ${account_id1}
    Should Be Equal As Strings   ${resp.json()['customer']['id']}           ${custid2}
    Should Be Equal As Strings   ${resp.json()['customer']['firstName']}    ${Custfname2}
    Should Be Equal As Strings   ${resp.json()['customer']['lastName']}     ${Custlname2}
    Should Be Equal As Strings   ${resp.json()['customer']['phoneNo']}      ${consumernumber2}
    Should Be Equal As Strings   ${resp.json()['partner']['id']}            ${partid3}
    Should Be Equal As Strings   ${resp.json()['partner']['partnerName']}   ${partnername3} 
    Should Be Equal As Strings   ${resp.json()['branch']['id']}             ${branchid2}
    Should Be Equal As Strings   ${resp.json()['branch']['branchName']}     ${branchName1}
    Should Be Equal As Strings   ${resp.json()['location']['id']}           ${locId}
    Should Be Equal As Strings   ${resp.json()['location']['name']}         ${locname}
    Should Be Equal As Strings   ${resp.json()['spInternalStatus']}         ${LoanApplicationSpInternalStatus[4]}
...
JD-TC-GetLoanApplicationsByUid-4
...
#  .....Get Loan Applications Public APi call....
    ...
    ${resp}=  Get Loan Applications By Uid   ${loanUid3}   ${user_token}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    Should Be Equal As Strings   ${resp.json()['id']}                       ${loanid3}
    Should Be Equal As Strings   ${resp.json()['uid']}                      ${loanUid3}
    Should Be Equal As Strings   ${resp.json()['accountId']}                ${account_id1}
    Should Be Equal As Strings   ${resp.json()['customer']['id']}           ${custid}
    Should Be Equal As Strings   ${resp.json()['customer']['firstName']}    ${Custfname}
    Should Be Equal As Strings   ${resp.json()['customer']['lastName']}     ${Custlname}
    Should Be Equal As Strings   ${resp.json()['customer']['phoneNo']}      ${consumernumber}
    Should Be Equal As Strings   ${resp.json()['partner']['id']}            ${partid4}
    Should Be Equal As Strings   ${resp.json()['partner']['partnerName']}   ${partnername4} 
    Should Be Equal As Strings   ${resp.json()['branch']['id']}             ${branchid3}
    Should Be Equal As Strings   ${resp.json()['branch']['branchName']}     ${branchName2}
    Should Be Equal As Strings   ${resp.json()['location']['id']}           ${locid1}
    Should Be Equal As Strings   ${resp.json()['location']['name']}         ${locname1}
    Should Be Equal As Strings   ${resp.json()['spInternalStatus']}         ${LoanApplicationSpInternalStatus[4]}
...
JD-TC-GetLoanApplicationsByUid-UH1

    [Documentation]   Get Loan Applications By Uid with user token and invalid loan uid.

    ${invalid_loanuid}=   FakerLibrary.word
    ${resp}=  Get Loan Applications By Uid  ${invalid_loanuid}  ${user_token}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  ${resp.content}   "${INVALID_LOAN_APPLICATION_ID}"

JD-TC-GetLoanApplicationsByUid-UH2

    [Documentation]   Get Loan Applications By Uid with invalid user token and loan uid.

    ${invalid_usrtkn}=  Set Variable   1c8a2c74-0477-4b48-bafc-8008ca1d89a5-USRTKN
    ${resp}=  Get Loan Applications By Uid  ${loanUid}  ${invalid_usrtkn}
    Log  ${resp.content}
