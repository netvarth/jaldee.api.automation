...
JD-TC-ApplyServiceLevelDiscountForAppointmnet-2
    [Documentation]   Apply service level discount for future appointment.(online)
...
JD-TC-ApplyServiceLevelDiscountForAppointmnet-3
    [Documentation]   Apply service level discount for same appointment and same discount.
...
JD-TC-ApplyServiceLevelDiscountForAppointmnet-4
