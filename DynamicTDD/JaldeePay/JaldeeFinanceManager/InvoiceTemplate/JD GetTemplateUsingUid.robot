...
JD-TC-Get InvoiceTemplate By Uid-1

    [Documentation]  create Invoice Template and get invoice template by uid.
...
JD-TC-Get InvoiceTemplate By Uid-2

    [Documentation]   create invoice using termsAndConditions,notesForCustomer,description and get invoice template by uid
    ...
    ${resp}=   Get InvoiceTemplate By Uid    ${templateUid7}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    Should Be Equal As Strings  ${resp.json()['accountId']}  ${account_id}
...
JD-TC-Get InvoiceTemplate By Uid-UH1

    [Documentation]   Get InvoiceTemplate By Uid without login
...
JD-TC-Get InvoiceTemplate By Uid-3

    [Documentation]   update invoice template and Get Invoice Template by account id
...
JD-TC-Get InvoiceTemplate By Uid-UH2
