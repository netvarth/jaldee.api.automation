...
JD-TC-Payment By Consumer-1
    ...
    sleep  2s
    ${resp}=  Make payment Consumer Mock  ${pid}  ${balamount1}  ${purpose[1]}  ${cwid}  ${p1_sid1}  ${bool[0]}   ${bool[1]}  ${cid1}
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Payment By Consumer-4
    ...
    Should Be Equal As Numbers  ${resp.json()['netTotal']}   ${Tot1}
    Should Be Equal As Numbers  ${resp.json()['netRate']}   ${totalamt}
...
JD-TC-Payment By Consumer-UH7
   [Documentation]   payment consumer to provider with invalid uuid
    ...
    ${invalid_uuid}=  Set Variable   570a36c4-235b-45c0-9440-2f48c49c10b9_wl
