...
JD-TC-GetPaymentProfileById-1
    ...
    ${resp}=   Get conspayment profiles By Id    ${pid}    ${id} 
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-GetPaymentProfileById-2
    ...
    ${resp}=   Get conspayment profiles By Id    ${pid}    ${id1} 
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-GetPaymentProfileById-UH1
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ${pid1}=  get_acc_id  ${PUSERNAME120}
    # Set Suite Variable   ${pid}
    
    ${resp}=  Get conspayment profiles By Id    ${pid1}    ${id}    
    Log  ${resp.json()}
...
JD-TC-GetPaymentProfileById-UH3
    ...
    ${resp}=   Get conspayment profiles By Id    ${pid}     00000
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   422
    Should Be Equal As Strings  ${resp.json()}   ${INVALID_PAYMENT_PROFILE_ID}


JD-TC-GetPaymentProfileById-3
