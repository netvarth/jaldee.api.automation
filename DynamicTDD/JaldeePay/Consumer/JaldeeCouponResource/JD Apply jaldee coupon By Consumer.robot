...
JD-TC-ApplyJaldeeCouponByConsumer-1
    ...
    ${PUSERPH0}=  Evaluate  ${PUSERNAME}+1002108
...
JD-TC-ApplyJaldeeCouponByConsumer-2
    ...
    ${resp}=  Create Jaldee Coupon  ${cupn_code01}  ${cupn_name}  ${cupn_des}  ${age_group[0]}  ${DAY1}  ${DAY2}  ${discountType[0]}  50  100  ${bool[0]}  ${bool[0]}  100  100  1000  20  15  ${bool[0]}  ${bool[0]}  ${bool[0]}  ${bool[0]}  ${bool[1]}  ${c_des}  ${p_des}  ${domains}  ${sub_domains}  ALL  ${licenses}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-ApplyJaldeeCouponByConsumer-UH5
    ...
    ${CUSERPH2}=  Evaluate  ${CUSERPH}+100100163
