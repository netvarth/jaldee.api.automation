...
JD-TC-ApplyJaldeeCoupon-UH6
    ...
    ${resp}=  Create Jaldee Coupon  ${cupn_code0113}  ${cupn_name}  ${cupn_des}  ${age_group[0]}  ${DAY1}  ${DAY2}  ${discountType[0]}  50  100  ${bool[0]}  ${bool[0]}  0  100  1000  5  2  ${bool[0]}  ${bool[0]}  ${bool[0]}  ${bool[0]}  ${bool[0]}  ${c_des}  ${p_des}  ${domains}  ${sub_domains}  ALL  ${licenses}  targetDate=${targetDate}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-ApplyJaldeeCoupon-UH4
    ...
    Log  ${decrypted_data}
    Set Suite Variable   ${d_1}   ${decrypted_data['sector']}
    Set Suite Variable   ${sd_1}    ${decrypted_data['subSector']}
