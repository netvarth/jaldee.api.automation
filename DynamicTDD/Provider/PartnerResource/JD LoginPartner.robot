...
JD-TC-Login Partner-UH1
    ...
    ${inv_acc}    FakerLibrary.Random Number

    ${resp}=    Login Partner with Password    ${inv_acc}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    401
    Should Be Equal As Strings    ${resp.json()}    ${NOT_REGISTERED_PARTNER}


JD-TC-Login Partner-UH2
    ...
    ${resp}=    Login Partner with Password    ${empty}  ${P_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    401
    Should Be Equal As Strings    ${resp.json()}    ${NOT_REGISTERED_PARTNER}


JD-TC-Login Partner-UH3
    ...
    ${resp}=    Login Partner with Password    ${account_id}  ${inv_phone}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    401
    Should Be Equal As Strings    ${resp.json()}    ${NOT_REGISTERED_PARTNER}


JD-TC-Login Partner-UH4
    ...
    ${resp}=    Login Partner with Password    ${account_id}  ${empty}  ${PASSWORD}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    401
    Should Be Equal As Strings    ${resp.json()}    ${LOGIN_CREDENTIALS_NOT_VALID}


JD-TC-Login Partner-UH5
    ...
    ${resp}=    Login Partner with Password    ${account_id}  ${P_phone}  ${empty}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    401
    Should Be Equal As Strings    ${resp.json()}    ${NOT_REGISTERED_PARTNER}