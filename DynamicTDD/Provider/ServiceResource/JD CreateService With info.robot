...
JD-TC-Create Service With info-9
        ...
        ${resp}=  Update Virtual Service   ${s_id1}  ${SERVICE3}  ${description}   ${service_duration[1]}   ${status[0]}    ${btype}   ${bool[1]}  ${notifytype[1]}  ${EMPTY}  ${Total1}    ${bool[0]}  ${bool[0]}   ${service_type[1]}   ${virtualCallingModes}
        Log  ${resp.json()}
        Should Be Equal As Strings  ${resp.status_code}  200
