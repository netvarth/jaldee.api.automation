...
JD-TC-AppointmentAttachment-1

    [Documentation]   Add appointment attachment as jpg file.
...
JD-TC-AppointmentAttachment-2

    [Documentation]   Add appointment attachment as png file.
...
JD-TC-AppointmentAttachment-3

    [Documentation]   Add appointment attachment as pdf file.
...
JD-TC-AppointmentAttachment-5
    ...
    ${resp}=  Imageupload.PApptAttachment   ${cookie}   ${apptid1}   ${EMPTY}   ${pdffile}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
