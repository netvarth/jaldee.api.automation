...
JD-TC-ChangeLoanApplication-1
                                  
    [Documentation]               Change Loan Application after update loan application
...
JD-TC-ChangeLoanApplication-2
    ...
    [Documentation]               Change Loan Application without  update loan application
...
JD-TC-ChangeLoanApplication-3
                                  
    [Documentation]               Change Loan Application after reject  
...
JD-TC-ChangeLoanApplication-4
                                  
    [Documentation]               Change Loan Application invalied uuid
    ...
    ${resp}=  Change Loan Application Status   2435   ${status_id0}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200



JD-TC-ChangeLoanApplication-5
                                  
    [Documentation]               Change Loan Application invalied status
    ...
    ${resp}=  Change Loan Application Status   ${loan_uuid}   hjkjhj
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200

JD-TC-ChangeLoanApplication-6
                                  
    [Documentation]               Change Loan Application consumer login
...
JD-TC-ChangeLoanApplication-7
                                  
    [Documentation]               Change Loan Application without login
...
JD-TC-ChangeLoanApplication-8
                                  
    [Documentation]               Change Loan Application another provider login
