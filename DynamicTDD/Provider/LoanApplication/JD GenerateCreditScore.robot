...
# .... Create Branch1....
    ...
    ${resp}    Update Partner Bank  ${bankAccountNo}  ${bankIfsc}  ${bankName}  ${Puid1}  ${LoanAction[0]}  ${Pid1}  ${pdffile}  ${fileSize}  ${caption3}  ${fileType3}  ${order}    partnerAttachments=${partnerAttachments}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
