...
JD-TC-Create Payment-2
    ...
    Verify Response  ${resp}  billPaymentStatus=${paymentStatus[3]}   totalAmountPaid=${Total2}  amountDue=-50.0
...
JD-TC-Create Payment-12
    ...
    ${resp}=  Make payment Consumer Mock  ${pid0}  ${min_pre1}  ${purpose[0]}  ${wid}  ${p1_sid1}  ${bool[0]}   ${bool[1]}  ${consumer_id}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Create Payment-13
    ...
    ${resp}=  Make payment Consumer Mock  ${pid0}  ${min_pre}  ${purpose[0]}  ${apptid1}  ${p1_sid1}  ${bool[0]}   ${bool[1]}  ${consumer_id}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200