...
JD-TC-AddLabelForMultipleOrders-1
    ...
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME75}.ynwtest@netvarth.com
...
JD-TC-AddLabelForMultipleOrders-2
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME76}.ynwtest@netvarth.com
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email}  ${firstname}${CUSERNAME9}.ynwtest@netvarth.com
...
JD-TC-AddLabelForMultipleOrders-3
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME70}.ynwtest@netvarth.com
...
JD-TC-AddLabelForMultipleOrders-5
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME79}.ynwtest@netvarth.com
...
JD-TC-AddLabelForMultipleOrders-6
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME82}.ynwtest@netvarth.com
