...
JD-TC-CreateOrderByProviderForHomeDelivery-UH18

    [Documentation]    An item disabled then again added to the catalog , and take order.
    ...
    ${catalogItem4}=  Create Dictionary  item=${item4_Id}  minQuantity=${minQ1}  maxQuantity=${maxQ1}  
    
    ${Items_list}=  Create List     ${catalogItem4}
