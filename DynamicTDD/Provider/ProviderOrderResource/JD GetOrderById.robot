...
JD-TC-Getorderbyid-1
    ...
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME140}.ynwtest@netvarth.com
...
JD-TC-GetOrderById-2
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME141}.ynwtest@netvarth.com
...
JD-TC-GetOrderById-3
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME143}.ynwtest@netvarth.com
...
JD-TC-GetOrderById-6
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME154}.ynwtest@netvarth.com
