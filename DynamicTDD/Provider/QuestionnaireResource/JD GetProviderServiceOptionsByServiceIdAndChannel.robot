...
JD-TC-ServiceOptionsByChannelServiceId-1
    [Documentation]  Get Service options by service id and channel for a consumer Where Channel is walkin
...
JD-TC-ServiceOptionsByChannelServiceId-3
    ...
    ${resp}=    Get Service Options By Serviceid and Channel  ${s_id}  ${QnrChannel[3]}
    Log     ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-ServiceOptionsByChannelServiceId-4
    ...
    ${resp}=    Get Service Options By Serviceid and Channel  ${s_id}  ${QnrChannel[2]}
    Log     ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
