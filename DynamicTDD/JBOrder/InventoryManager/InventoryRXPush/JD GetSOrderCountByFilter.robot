...
JD-TC-GetOrderCountByFilter-1
    ...
    ${PUSERNAME_E}=  Evaluate  ${PUSERNAME}+4448457
...
JD-TC-GetOrderCountByFilter-2
    ...
    ${resp}=    Get Sorder Count By Filter      account-eq=${accountId}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-3
    ...
    ${resp}=    Get Sorder Count By Filter      uid-eq=${sorder_uid}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-4
    ...
    ${resp}=    Get Sorder Count By Filter       locationId-eq=${locId1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-5
    ...
    ${resp}=    Get Sorder Count By Filter       storeEncId-eq=${store_id}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-6
    ...
    ${resp}=    Get Sorder Count By Filter       storeName-eq=${Store_Name1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-7
    ...
    ${resp}=    Get Sorder Count By Filter       storeRefNo-eq=${refNumber}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

# JD-TC-GetOrderCountByFilter-8
...
JD-TC-GetOrderCountByFilter-9
    ...
    ${resp}=    Get Sorder Count By Filter       originFrom-eq=${orgin_From}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-10
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionUid-eq=${prescription_id}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-11
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionRefNo-eq=${presc_ref}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-12
...
JD-TC-GetOrderCountByFilter-13
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionDate-eq=${DAY1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-14
    ...
    ${resp}=    Get Sorder Count By Filter        doctorId-eq=${doc1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-15
    ...
    ${resp}=    Get Sorder Count By Filter        doctorName-eq=${Docfname} ${Doclname}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-16
    ...
    ${resp}=    Get Sorder Count By Filter        orderStatus-eq=${couponState[0]}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-17
    ...
    ${resp}=    Get Sorder Count By Filter        pushedStatus-eq=${pushedStatus[0]}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-18
    ...
    ${resp}=    Get Sorder Count By Filter        providerConsumerId-eq=${cid}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-19
    ...
    ${resp}=    Get Sorder Count By Filter        providerConsumerName-eq=${firstName} ${lastName}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  1

JD-TC-GetOrderCountByFilter-20 
...
# JD-TC-GetOrderCountByFilter-UH1
...
JD-TC-GetOrderCountByFilter-UH2
    ...
    ${resp}=    Get Sorder Count By Filter      uid-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH3
    ...
    ${resp}=    Get Sorder Count By Filter       locationId-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH4
    ...
    ${resp}=    Get Sorder Count By Filter       storeEncId-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH5
...
JD-TC-GetOrderCountByFilter-UH6
    ...
    ${resp}=    Get Sorder Count By Filter       storeRefNo-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH7
...
# JD-TC-GetOrderCountByFilter-UH8-----eNUM VALUE
...
JD-TC-GetOrderCountByFilter-UH9
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionUid-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH10
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionRefNo-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH11
...
JD-TC-GetOrderCountByFilter-UH12
    ...
    ${resp}=    Get Sorder Count By Filter        prescriptionDate-eq=${day2}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH13
    ...
    ${resp}=    Get Sorder Count By Filter        doctorId-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH14
...
# JD-TC-GetOrderCountByFilter-UH15--enum
...
JD-TC-GetOrderCountByFilter-UH16
    ...
    ${resp}=    Get Sorder Count By Filter        pushedStatus-eq=${pushedStatus[1]}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH17
    ...
    ${resp}=    Get Sorder Count By Filter        providerConsumerId-eq=${inv}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()}                  0

JD-TC-GetOrderCountByFilter-UH18
...
JD-TC-GetOrderCountByFilter-UH19
...
JD-TC-GetOrderCountByFilter-UH20
