...
JD-TC-GetRXPrescriptionItemByFilter-2
    ...
    ${resp}=    Get RX Prescription By filter  id-eq=${RDID1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemByFilter-3
    ...
    ${resp}=    Get RX Prescription By filter  account-eq=${accountId}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    ...
    FOR  ${i}  IN RANGE   ${len}
        ...
        IF  '${resp.json()[${i}]['id']}' == '${RDID1}'  
            Should Be Equal As Strings      ${resp.json()[${i}]['id']}                     ${RDID1}
            Should Be Equal As Strings      ${resp.json()[${i}]['spItemCode']}             ${item1}
            Should Be Equal As Strings      ${resp.json()[${i}]['medicineName']}           ${displayName1}    
            Should Be Equal As Strings      ${resp.json()[${i}]['duration']}               ${duration1}    
            Should Be Equal As Strings      ${resp.json()[${i}]['frequency']['id']}        ${frequency_id}    
            Should Be Equal As Strings      ${resp.json()[${i}]['dosage']}                 ${dos}    
            Should Be Equal As Strings      ${resp.json()[${i}]['description']}            ${description}  
            Should Be Equal As Strings      ${resp.json()[${i}]['quantity']}               ${quantity1}  
            Should Be Equal As Strings      ${resp.json()[${i}]['prescriptioinUid']}       ${prescription_id} 

        ELSE IF     '${resp.json()[${i}]['id']}' == '${RDID2}'    
            Should Be Equal As Strings      ${resp.json()[${i}]['id']}                     ${RDID2}
            Should Be Equal As Strings      ${resp.json()[${i}]['spItemCode']}             ${item2}
            Should Be Equal As Strings      ${resp.json()[${i}]['medicineName']}           ${displayName2}    
            Should Be Equal As Strings      ${resp.json()[${i}]['duration']}               ${duration2}    
            Should Be Equal As Strings      ${resp.json()[${i}]['frequency']['id']}        ${frequency_id}    
            Should Be Equal As Strings      ${resp.json()[${i}]['dosage']}                 ${dos}    
            Should Be Equal As Strings      ${resp.json()[${i}]['description']}            ${description}  
            Should Be Equal As Strings      ${resp.json()[${i}]['quantity']}               ${quantity2}  
            Should Be Equal As Strings      ${resp.json()[${i}]['prescriptioinUid']}       ${prescription_id}   
...
JD-TC-GetRXPrescriptionItemByFilter-4
    ...
    ${resp}=    Get RX Prescription By filter  spItemCode-eq=${item1}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()[0]['id']}                     ${RDID1}
    Should Be Equal As Strings      ${resp.json()[0]['spItemCode']}             ${item1}
...
*** Comments ***
    ...
    ${resp}=    Get RX Prescription By filter  medicineName-eq=${displayName2}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()[0]['id']}                     ${RDID2}
    Should Be Equal As Strings      ${resp.json()[0]['spItemCode']}             ${item2}
...
JD-TC-GetRXPrescriptionItemByFilter-7
    ...
    ${resp}=    Get RX Prescription By filter  frequency-eq=${frequency}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
    Should Be Equal As Strings      ${resp.json()[0]['id']}                     ${RDID2}
    Should Be Equal As Strings      ${resp.json()[0]['spItemCode']}             ${item2}
