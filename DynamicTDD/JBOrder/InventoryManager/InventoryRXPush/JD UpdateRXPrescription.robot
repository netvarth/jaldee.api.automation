...
# ------------------------------Create SalesOrder Catalog Item-invMgmt True-------------------------------
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-2
    ...
    ${resp}=    RX Update Prescription  ${inv}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
...
JD-TC-UpdatePrescription-3
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${inv}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-4
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${empty}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-6
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${empty}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-7
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${empty}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-8
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName_ran}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-9
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${empty}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-10
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${inv}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-11
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${empty}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-12
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${inv}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-13
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${empty}  ${item1}  ${dos}  ${frequency_id}  ${html}    itemDosage=${dos}
    Log   ${resp.content} 
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-14
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${des}  ${item1}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-15
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${empty}  ${dos}  ${frequency_id}  ${html}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-16
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${inv}  ${dos}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-17
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${empty}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-18
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${inv}  ${frequency_id}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     200
...
JD-TC-UpdatePrescription-19
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${empty}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
...
JD-TC-UpdatePrescription-20
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${inv}  ${html}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}     422
    Should Be Equal As Strings      ${resp.json()}          ${INVALID_FREEQUENCY_VALUE}
...
JD-TC-UpdatePrescription-21
    ...
    ${resp}=    RX Update Prescription  ${prescription_id}  ${cid}  ${doc1}  ${medicineName2}  ${duration1}  ${quantity1}  ${description}  ${item1}  ${dos}  ${frequency_id}  ${empty}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}        422
