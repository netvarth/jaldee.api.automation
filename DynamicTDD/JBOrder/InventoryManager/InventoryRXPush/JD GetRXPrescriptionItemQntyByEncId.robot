...
JD-TC-GetRXPrescriptionItemQuantity-2
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${inv}  ${duration2}  ${quantity2}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemQuantity-3
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${empty}  ${duration2}  ${quantity2}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemQuantity-4
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${inv}  ${quantity2}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}     itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemQuantity-UH1
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${empty}  ${quantity2}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
...
JD-TC-GetRXPrescriptionItemQuantity-6
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${duration2}  ${inv}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemQuantity-7
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${duration2}  ${empty}  ${description}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             422
...
8JD-TC-GetRXPrescriptionItemQuantity-9
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${duration2}  ${quantity2}  ${inv}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
...
JD-TC-GetRXPrescriptionItemQuantity-10
    ...
    ${resp}=    Get RX Prescription Item Qnty By EncId  ${displayName2}  ${duration2}  ${quantity2}  ${empty}  ${item2}  ${dos}  ${frequency_id}  ${prescription_id}    itemDosage=${dos}
    Log   ${resp.content}
    Should Be Equal As Strings      ${resp.status_code}             200
