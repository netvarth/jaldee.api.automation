...
JD-TC-Assign User For Sales Order-2
    ...
    ${us_id2}=  Create Sample User    deptId=${dep_id} 
...
JD-TC-Assign User For Sales Order-3
    ...
    ${us_id3}=  Create Sample User    admin=${bool[0]}  deptId=${dep_id} 
...
JD-TC-Assign User For Sales Order-UH1
    ...
    ${us_id4}=  Create Sample User   deptId=${dep_id} 
...
JD-TC-Assign User For Sales Order-UH5
    ...
    ${us_id5}=  Create Sample User   deptId=${dep_id} 
...
JD-TC-Assign User For Sales Order-UH6
    ...
    ${PUSERNAME_U1}  ${us_id6} =  Create and Configure Sample User    deptId=${dep_id} 
