...
JD-TC-Get Item Stock adjust Count Filter-1
    ...
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${accountId}=  get_acc_id  ${HLMUSERNAME7}
...
JD-TC-Get Item Stock adjust Count Filter-2
    ...
    ${resp}=  Get Item Stock adjust Count Filter   locationName-eq=${place}      
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-3
    ...
    ${resp}=  Get Item Stock adjust Count Filter   storeId-eq=${id_of_store}    
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-4
    ...
    ${resp}=  Get Item Stock adjust Count Filter    storeEncId-eq=${store_id} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-5
    ...
    ${resp}=  Get Item Stock adjust Count Filter   storeName-eq=${Name}  
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-6
    ...
    ${resp}=  Get Item Stock adjust Count Filter    invCatalogId-eq=${id_of_inventory_catalog}    
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-7
    ...
    ${resp}=  Get Item Stock adjust Count Filter    status-eq=${couponStatus[0]}    
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-8
    ...
    ${resp}=  Get Item Stock adjust Count Filter    location-eq=${locId1}    
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-9
    ...
    ${resp}=  Get Item Stock adjust Count Filter    invCatalogEncId-eq=${inventory_catalog_encid}      
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-10
    ...
    ${resp}=  Get Item Stock adjust Count Filter    uid-eq=${uid}       
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-11
    ...
    ${resp}=  Get Item Stock adjust Count Filter    remark-eq=${remarks}        
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-12
    ...
    ${resp}=  Get Item Stock adjust Count Filter     invRemark-eq=${id}       
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH2
    ...
    ${resp}=  Get Item Stock adjust Count Filter     invRemark-eq=${inventory_catalog_encid}   
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH3
    ...
    ${resp}=  Get Item Stock adjust Count Filter    remark-eq=${inventory_catalog_encid} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH4
    ...
    ${resp}=  Get Item Stock adjust Count Filter    uid-eq=${inventory_catalog_encid}   
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH5
    ...
    ${resp}=  Get Item Stock adjust Count Filter    location-eq=${inventory_catalog_encid}    
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH6
    ...
    ${resp}=  Get Item Stock adjust Count Filter    status-eq=${InvStatus[1]}     
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH7
    ...
    ${resp}=  Get Item Stock adjust Count Filter    locationName-eq=${inventory_catalog_encid}       
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH8
    ...
    ${resp}=  Get Item Stock adjust Count Filter    storeId-eq=${inventory_catalog_encid}        
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH9
    ...
    ${resp}=  Get Item Stock adjust Count Filter    storeEncId-eq=${inventory_catalog_encid}         
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
...
JD-TC-Get Item Stock adjust Count Filter-UH10
    ...
    ${resp}=  Get Item Stock adjust Count Filter   storeName-eq=${inventory_catalog_encid}         
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.json()}    ${count}
