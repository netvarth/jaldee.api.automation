...
#----------------------------------------------------------------------------
    ...
    ${purchaseItemDtoList2}=        Create purchaseItemDtoList  ${ic_id1}   ${quantity}  ${freeQuantity}  ${amount}  ${discountAmount}  ${discountPercentage}  500  ${expiryDate}  ${mrp}  ${batchNo}   ${iu_id}    
