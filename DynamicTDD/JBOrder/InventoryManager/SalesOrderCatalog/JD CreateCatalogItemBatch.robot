...
JD-TC-Create Catalog Item Batch-2
    ...
    ${purchaseItemDtoList1}=        Create purchaseItemDtoList  ${ic_id1}    ${quantity}  ${freeQuantity}  ${amount}  ${discountAmount}  ${discountPercentage}  500  ${taxableAmount}  ${taxAmount}  ${netTotal}   ${expiryDate}  ${mrp}    ${batchNo}  ${cgst}  ${sgst}  ${iu_id}    
