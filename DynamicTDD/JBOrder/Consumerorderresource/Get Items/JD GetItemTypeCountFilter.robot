...
# -------------------------------- Create store type -----------------------------------
    ...
    ${resp}=    Create Item Inventory  ${displayName}     isBatchApplicable=${boolean[0]}    isInventoryItem=${bool[0]}   categoryCode=${categoryCode}   typeCode=${typeCode}  typeCode2=${typeCode}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
