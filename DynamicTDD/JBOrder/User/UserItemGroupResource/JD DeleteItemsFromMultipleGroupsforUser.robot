...
JD-TC-DeleteItemsFromMultipleGroupsforUser-1
...
JD-TC-DeleteItemsFromMultipleGroupsforUser-3

    [Documentation]  delete items from multiple item groups by user.

    ${resp}=  Provider Login  ${MUSERNAME116}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-DeleteItemsFromMultipleGroupsforUser-UH1
...
JD-TC-DeleteItemsFromMultipleGroupsforUser-UH2
