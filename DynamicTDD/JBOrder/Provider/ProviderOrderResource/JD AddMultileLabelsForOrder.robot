...
JD-TC-AddMultipleLabelsForOrder-1
    ...
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME45}.ynwtest@netvarth.com
...
JD-TC-AddMultipleLabelsForOrder-4
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME46}.ynwtest@netvarth.com
...
JD-TC-AddMultipleLabelsForOrder-7
    ...
    FOR   ${a}  IN RANGE   15
        ...
        ${item_quantity1}=  FakerLibrary.Random Int  min=${minQuantity}   max=${maxQuantity}
        ${firstname}=  FakerLibrary.first_name
        Set Test Variable  ${email}  ${firstname}${CUSERNAME${a}}.ynwtest@netvarth.com
        ${EMPTY_List}=  Create List
        Set Suite Variable  ${EMPTY_List}
