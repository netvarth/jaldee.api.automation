...
JD-TC-Getordercountbycriteria-1
    ...
    ${accountId}=  get_acc_id  ${PUSERNAME110}
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email0}  ${firstname}${consumerPhone}.${test_mail}
    ...
    ${resp}=   Create Order For HomeDelivery    ${cookie}  ${accountId}    ${self}    ${CatalogId1}     ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${consumerPhone}    ${email0}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id1}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=   Create Order For HomeDelivery   ${cookie}  ${accountId}    ${self}    ${CatalogId2}     ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${consumerPhone}    ${email0}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id2}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${item_quantity1}=  FakerLibrary.Random Int  min=${minQuantity}   max=${maxQuantity}
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email2}  ${firstname}${consumerPhone}.${test_mail}

    ${resp}=   Create Order For HomeDelivery    ${cookie}  ${accountId}    ${self}    ${CatalogId2}     ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${consumerPhone}    ${email2}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id2}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=   Create Order For HomeDelivery   ${cookie}  ${accountId}    ${self}    ${CatalogId1}     ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${CUSERNAME3}    ${email}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id1}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=   Get Order By Id   ${accountId}   ${orderid4}  
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    Set Suite Variable     ${jdconID}   ${resp.json()['jaldeeConsumer']['id']}       


    ${resp}=   Create Order For HomeDelivery   ${cookie}  ${accountId}    ${self}    ${CatalogId2}     ${bool[1]}    ${address}    ${sTime1}    ${eTime1}   ${DAY1}    ${CUSERNAME3}    ${email}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id2}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=   Get Order By Id   ${accountId}   ${orderid5}  
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Getordercountbycriteria-15
    ...
    ${accountId3}=  get_acc_id  ${PUSERNAME119}
    Set Test Variable  ${accountId3} 
    ...
    ${resp}=  Consumer Login  ${consumerPhone0}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${consumerPhone0}.${test_mail}

    ${cookie}  ${resp}=  Imageupload.conLogin  ${consumerPhone0}   ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings   ${resp.status_code}    200

    ${resp}=   Create Order For HomeDelivery   ${cookie}   ${accountId3}    ${self}    ${CatalogId3}     ${bool[1]}    ${address}    ${sTime3}    ${eTime3}   ${DAY1}    ${consumerPhone0}    ${email}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id3}    ${item_quantity1}  ${item_id4}    ${item_quantity1}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${resp}=   Get Order By Id    ${accountId3}   ${orderid7}   
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Getordercountbycriteria-16
    ...
    ${accountId2}=  get_acc_id  ${PUSERNAME120}
    ...
    ${resp}=  Consumer Login  ${consumerPhone1}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${item_quantity1}=  FakerLibrary.Random Int  min=${minQuantity}   max=${maxQuantity}
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${consumerPhone1}.${test_mail}

    ${cookie}  ${resp}=  Imageupload.conLogin  ${consumerPhone1}   ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings   ${resp.status_code}    200

    ${resp}=   Create Order For Pickup   ${cookie}  ${accountId2}    ${self}    ${CatalogId2}   ${bool[1]}    ${sTime1}    ${eTime1}   ${DAY1}    ${consumerPhone1}    ${email}  ${countryCodes[1]}  ${EMPTY_List}  ${item_id2}    ${item_quantity1} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Getordercountbycriteria-18
    ...
    ${accountId3}=  get_acc_id  ${PUSERNAME121}
    Set Suite Variable  ${accountId3} 
    ...
    ${resp}=  AddCustomer  ${consumerPhone0}  firstName=${fname}   lastName=${lname}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${cid20}   ${resp.json()}

    ${resp}=  GetCustomer  phoneNo-eq=${consumerPhone0}
    Log   ${resp.json()}
    Should Be Equal As Strings      ${resp.status_code}  200

    # ${cid20}=  get_id  ${consumerPhone0}
    ...
    ${resp}=   Create Order By Provider For HomeDelivery    ${cookie}  ${cid20}   ${cid20}   ${CatalogId1}   ${boolean[1]}   ${address}  ${sTime3}    ${eTime3}   ${DAY1}    ${consumerPhone0}    ${email}  ${orderNote}  ${countryCodes[1]}  ${item_id3}   ${item_quantity1}  ${item_id4}   ${item_quantity1}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
...
#     ${resp}=  Get Order By Criterias   account-eq=${accountId1}
#     Log  ${resp.json()}
#     Should Be Equal As Strings  ${resp.status_code}  200  
    
#     ${resp}=  Get Order count by Criterias   account-eq=${accountId1}
#     Log  ${resp.json()}
#     Should Be Equal As Strings  ${resp.status_code}  200  
#     Should Be Equal As Strings  ${resp.json()}  1
