...
JD-TC-UpdateOrder-1
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email0}  ${firstname}${CUSERPH0}.ynwtest@netvarth.com
    ...
    Set Suite Variable  ${email1}  ${firstname2}${CUSERPH0}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-5
    ...
    # ${address1}=  get_address
    ${firstname2}=  FakerLibrary.first_name
    Set Test Variable  ${email2}  ${firstname2}${CUSERPH0}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-6
    ...
    sleep  1s
    ${firstname2}=  FakerLibrary.first_name
    Set Test Variable  ${email2}  ${firstname2}${CUSERPH3}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-7
    ...
    ${sTime2}=  add_timezone_time  ${tz1}  2  35
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERPH4}.ynwtest@netvarth.com
    ...
    sleep  1s
    ${DAY2}=  db.add_timezone_date  ${tz1}  13  
...
JD-TC-UpdateOrder-UH13
    ...
    ${DAY2}=  db.add_timezone_date  ${tz1}   17
...
JD-TC-UpdateOrder-UH14
    ...
    ${DAY2}=  db.subtract_timezone_date  ${tz1}    2
    ${resp}=   Update Order For Pickup   ${orderid}   ${bool[1]}   ${sTime0}    ${eTime0}   ${DAY2}    ${CUSERPH2}    ${email}   ${countryCodes[1]} 
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    422
    Should Be Equal As Strings  "${resp.json()}"    "${ORDER_DATE_IS_PAST}"
...
JD-TC-UpdateOrder-10
    ...
    ${sTime5}=  add_timezone_time  ${tz3}  0  15  
    Set Suite Variable   ${sTime5}
    ${eTime5}=  add_timezone_time  ${tz3}  1  00   
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERPH5}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-UH20
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERNAME4}.ynwtest@netvarth.com
    ${orderNote}=  FakerLibrary.Sentence   nb_words=5
    ...
    ${Add_Day1}=  db.add_timezone_date  ${tz3}  1
    ${firstname2}=  FakerLibrary.first_name
    Set Test Variable  ${email2}  ${firstname2}${CUSERPH3}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-UH21
    ...
    ${Sub_DAY1}=  db.subtract_timezone_date  ${tz3}    1
    ${firstname2}=  FakerLibrary.first_name
    Set Test Variable  ${email2}  ${firstname2}${CUSERPH3}.ynwtest@netvarth.com
...
JD-TC-UpdateOrder-UH22
    ...
    ${DAY1}=  db.add_timezone_date  ${tz3}  11  
    # ${address}=  get_address
    ${C_firstName}=   FakerLibrary.first_name 
    ${C_lastName}=   FakerLibrary.name 
    ${C_num1}    Random Int  min=123456   max=999999
...
JD-TC-UpdateOrder-UH26
    ...
    ${DAY1}=  db.add_timezone_date  ${tz1}   8
...
JD-TC-UpdateOrder-11
    ...
    ${DAY2}=  db.add_timezone_date  ${tz3}  13  
...
JD-TC-UpdateOrder-UH27
    ...
    ${item_quantity1}=  Convert To Number  ${item_quantity1}  1
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERPH6}.ynwtest@netvarth.com
    ${orderNote}=  FakerLibrary.Sentence   nb_words=5
    ...
    ${DAY1}=  db.add_timezone_date  ${tz3}   18
    ${firstname2}=  FakerLibrary.first_name
    Set Test Variable  ${email2}  ${firstname2}${CUSERPH3}.ynwtest@netvarth.com
