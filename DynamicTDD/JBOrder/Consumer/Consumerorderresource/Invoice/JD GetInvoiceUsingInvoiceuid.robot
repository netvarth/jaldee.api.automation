...
#     Set Test Variable  ${enccid}
                         
#     # ${resp}=   Create Catalog Item Batch-invMgmt False   ${SO_itemEncIds}     ${Name}     ${price}      
#     # Log   ${resp.content}
#     # Should Be Equal As Strings    ${resp.status_code}    200
#     # Set Test Variable  ${SO_Cata_Item_Batch_Encid}  ${resp.json()[0]}
...
#     Set Test Variable  ${catalog_details}  
...
#     ${quantity}=                    Convert To Number  ${quantity}  1
    ...
    ${catalogItems}=  Create Dictionary    catalogItem=${catalogItem}  quantity=${freeQuantity}
