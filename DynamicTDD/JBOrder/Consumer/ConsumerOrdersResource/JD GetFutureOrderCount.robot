...
JD-TC-GetFutureOrderCountByCriteria-1
    ...
    Set Suite Variable  ${email_id}  ${firstname}${PUSERNAME157}.ynwtest@netvarth.com
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email}  ${firstname}${CUSERNAME22}.ynwtest@netvarth.com
...
JD-TC-GetFutureOrderCountByCriteria-2
    ...
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME158}.ynwtest@netvarth.com
