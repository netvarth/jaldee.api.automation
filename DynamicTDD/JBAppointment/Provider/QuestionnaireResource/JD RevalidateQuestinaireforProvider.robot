...
JD-TC-RevalidateQuestionnaire-1
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid}  ${mp4file}  ${mp3file}
    Log  ${fudata}
...
JD-TC-RevalidateQuestionnaire-2
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid2}  ${mp4file}  ${mp3file}
    Log  ${fudata}
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[1]}  ${Questionnaireid2}  ${mp4file}  ${mp3file}
    Log  ${fudata}
...
JD-TC-RevalidateQuestionnaire-3
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid3}  ${mp4file}  ${mp3file}
    Log  ${fudata}
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[1]}  ${Questionnaireid3}  ${mp4file}  ${mp3file}
    Log  ${fudata}
...
JD-TC-RevalidateQuestionnaire-UH1
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid4}  ${mp4file}  ${mp3file}
    Log  ${fudata}
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[1]}  ${Questionnaireid4}  ${mp4file}  ${mp3file}
    Log  ${fudata}
