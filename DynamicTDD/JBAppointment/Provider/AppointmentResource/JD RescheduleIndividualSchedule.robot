...
JD-TC-Reschedule Appointment-1
    [Documentation]  Provider takes appointment for a consumer and reschedules individualSchedule it to a later time in the same day
    ...
    clear_location_n_service  ${PUSERNAME150}
...
JD-TC-Reschedule Appointment-2
    ...
    ${sTime1}=  add_timezone_time  ${tz}  0  15 
    ${sTime2}=  add_timezone_time  ${tz}  0  30  
    ${sTime3}=  add_timezone_time  ${tz}  0  45  
...
JD-TC-Reschedule Appointment-3
    ...
    Should Be Equal As Strings  ${slot1}  ${slot2}
...
JD-TC-Reschedule Appointment-5
    ...
    ${iA}=   Create List    ${iA}   ${ad}   ${ad1}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid}    ${bool[1]}  ${s_id2}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Reschedule Appointment-6
    ...
    ${billable_providers}   ${multilocPro}=    Multiloc and Billable Providers   min=40   max=150
    ...
    clear_location_n_service  ${multilocPro[5]}
...
JD-TC-Reschedule Appointment-7
    ...
    Should Be Equal As Strings   ${resp.json()['availableSlots'][0]['noOfAvailbleSlots']}   ${parallel}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][2]['time']}   ${slot2}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][2]['noOfAvailbleSlots']}   ${parallel-1}
...
JD-TC-Reschedule Appointment-9
    ...
    clear_provider_msgs  ${PUSERNAME150}
...
JD-TC-Reschedule Appointment-10
    ...
    ${resp}=  Encrypted Provider Login  ${billable_providers[5]}  ${PASSWORD}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    # clear_service   ${billable_providers[5]}
    # clear_location  ${billable_providers[5]}
    clear_location_n_service  ${billable_providers[5]}
    clear_customer   ${billable_providers[5]}
    ...
    # clear_appt_schedule   ${billable_providers[5]}
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel2}    ${parallel2}  ${lid}    ${bool[1]}  ${s_id}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
...
JD-TC-Reschedule Appointment-11
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${servicecharge}  ${purpose[1]}  ${apptid1}  ${s_id}  ${bool[0]}   ${bool[1]}  ${jdconID}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable   ${payref}   ${resp.json()['paymentRefId']}
    ...
    # Should Be Equal As Strings  ${resp.json()[1]['status']}  ${cupnpaymentStatus[0]}  
    # Should Be Equal As Strings  ${resp.json()[1]['acceptPaymentBy']}  ${pay_mode_selfpay}
    # Should Be Equal As Strings  ${resp.json()[1]['amount']}  ${servicecharge}.0 
    # Should Be Equal As Strings  ${resp.json()[1]['custId']}  ${jdconID}   
    # Should Be Equal As Strings  ${resp.json()[1]['paymentMode']}  ${payment_modes[5]}  
    # Should Be Equal As Strings  ${resp.json()[1]['accountId']}  ${pid}    
    # Should Be Equal As Strings  ${resp.json()[1]['paymentGateway']}  RAZORPAY
    ...
    Verify Response List   ${resp}  0  uid=${apptid1}  appointmentEncId=${encId1}  
    ...   appmtDate=${DAY1}  appmtTime=${slot1}  apptBy=${apptBy[1]}   apptStatus=${apptStatus[1]}  
    ...   paymentStatus=${paymentStatus[2]}  appointmentMode=${appointmentMode[2]}  
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  id=${sch_id}   name=${schedule_name2}  apptState=${Qstate[0]}

    ${resp}=  Get Appointment Slots By Date Schedule  ${sch_id}  ${DAY3}  ${s_id}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  scheduleName=${}  scheduleId=${sch_id}
    ${no_of_slots}=  Get Length  ${resp.json()['availableSlots']}
    @{slots}=  Create List
    FOR   ${i}  IN RANGE   0   ${no_of_slots}
        IF  ${resp.json()['availableSlots'][${i}]['noOfAvailbleSlots']} > 0   
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  scheduleName=${schedule_name2}  scheduleId=${sch_id}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j2}]['time']}   ${slot2}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j2}]['noOfAvailbleSlots']}   0
...
JD-TC-Reschedule Appointment-13
    ...
    Verify Response  ${resp}  scheduleName=${schedule_name1}  scheduleId=${sch_id1}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j1}]['time']}   ${slot1}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j1}]['noOfAvailbleSlots']}   ${parallel1}
...
JD-TC-Reschedule Appointment-14
    ...
    ${list}=  Create List  1  2  3  4  5  6  7
    ${sTime1}=  add_timezone_time  ${tz}  0  15  
    ${sTime2}=  add_timezone_time  ${tz}  0  60  
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response   ${resp}  uid=${apptid1}  appmtDate=${DAY1}   appmtTime=${slot1}  
    ...   appointmentEncId=${encId1}  apptStatus=${apptStatus[3]}
    # Should Be Equal As Strings  ${resp.json()['consumer']['id']}   ${jdconID}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
    ...
    Verify Response  ${resp}  scheduleName=${schedule_name1}  scheduleId=${sch_id1}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][1]['time']}   ${slot2}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][1]['noOfAvailbleSlots']}   ${parallel1}
    
    ${resp}=  Get Appointment Slots By Date Schedule  ${sch_id1}  ${DAY1}  ${s_id}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  scheduleName=${schedule_name2}  scheduleId=${sch_id1}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][2]['time']}   ${slot3}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][2]['noOfAvailbleSlots']}   0
...
JD-TC-Reschedule Appointment-21
    ...
    ${delta}=  FakerLibrary.Random Int  min=10  max=60
    ${sTime2}=  add_timezone_time  ${tz}  0  30  
    ${sTime3}=  add_timezone_time  ${tz}  0  60  
...
JD-TC-Reschedule Appointment-22
    ...
    ${time}=   Create List    ${sTime1}     ${sTime2}   ${eTime1}
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${ad}=   Create Dictionary  availableDate=${DAY2}       availabilityTime=${time}
    ${ad1}=   Create Dictionary  availableDate=${DAY3}       availabilityTime=${time}
...
JD-TC-Reschedule Appointment-UH2
    ...
    clear_location_n_service  ${PUSERNAME151}
    ...
    ${lid1}=  Create Sample Location  
    # clear_appt_schedule   ${PUSERNAME151}
    ...
    ${iA}=   Create List    ${iA}   ${ad}   ${ad1}
    ${resp}=  Create Individual Schedule  ${schedule_name1}  ${parallel}    ${parallel}  ${lid1}    ${bool[1]}  ${s_id1}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id1}  ${resp.json()}
...
JD-TC-Reschedule Appointment-UH10
    ...
    ${resp}=  Create Holiday   ${recurringtype[1]}  ${list}  ${DAY2}  ${DAY2}  ${EMPTY}  ${sTime1}  ${eTime2}  ${desc}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${hId}    ${resp.json()['holidayId']}
    ...
    ${resp}=  Reschedule Consumer Appointment   ${apptid1}  ${slot2}  ${DAY2}  ${sch_id}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  "${resp.json()}"  "${USER_HOLIDAY}"
...
JD-TC-Reschedule Appointment-UH23
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response   ${resp}  uid=${apptid1}  appmtDate=${DAY1}   appmtTime=${slot1}  
    ...    appointmentEncId=${encId1}  apptStatus=${apptStatus[4]}
    # Should Be Equal As Strings  ${resp.json()['consumer']['id']}   ${jdconID}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
...
JD-TC-Reschedule Appointment-UH24
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response   ${resp}  uid=${apptid1}  appmtDate=${DAY1}   appmtTime=${slot1}  
    ...    appointmentEncId=${encId1}  apptStatus=${apptStatus[5]}
    # Should Be Equal As Strings  ${resp.json()['consumer']['id']}   ${jdconID}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
...
JD-TC-Reschedule Appointment-UH25
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response   ${resp}  uid=${apptid1}  appmtDate=${DAY1}   appmtTime=${slot1}  
    ...    appointmentEncId=${encId1}  apptStatus=${apptStatus[6]}
    # Should Be Equal As Strings  ${resp.json()['consumer']['id']}   ${jdconID}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
...
JD-TC-Reschedule Appointment-UH26
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response   ${resp}  uid=${apptid1}  appmtDate=${DAY1}   appmtTime=${slot1}  
    ...   appointmentEncId=${encId1}  apptStatus=${apptStatus[7]}
    # Should Be Equal As Strings  ${resp.json()['consumer']['id']}   ${jdconID}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['firstName']}   ${fname}
    # Should Be Equal As Strings  ${resp.json()['consumer']['userProfile']['lastName']}   ${lname}
    Should Be Equal As Strings  ${resp.json()['service']['id']}   ${s_id}
    ...
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  scheduleName=${schedule_name}  scheduleId=${sch_id}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j[0]}]['time']}   ${slot1}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j[0]}]['noOfAvailbleSlots']}   ${parallel}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j[1]}]['time']}   ${slot2}
    Should Be Equal As Strings   ${resp.json()['availableSlots'][${j[1]}]['noOfAvailbleSlots']}   ${parallel-1}

    ${CANNOT_RESCHEDULE_APPT}=  Format String    ${CANNOT_RESCHEDULE_APPT}    ${apptStatus[7]}
    ${resp}=  Reschedule Consumer Appointment   ${apptid1}  ${slot1}  ${DAY1}  ${sch_id}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings   "${resp.json()}"    "${CANNOT_RESCHEDULE_APPT}"
...
JD-TC-Reschedule Appointment-UH28
    ...
    ${iA}=   Create Dictionary  availableDate=${DAY1}       availabilityTime=${time}
    ${iA}=   Create List    ${iA}
    ${resp}=  Create Individual Schedule  ${schedule_name2}  ${parallel}    ${parallel}  ${lid1}    ${bool[1]}  ${s_id2}      individualApptSchedule=${iA}    scheduleType=individual  
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Test Variable  ${sch_id2}  ${resp.json()}
...
JD-TC-Reschedule Appointment-UH30
    ...
    ${schedule_name2}=    FakerLibrary.Word
