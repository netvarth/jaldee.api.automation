...
# *** COMMENTS ***
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid}  ${pdffile}
    Log  ${fudata}
...
JD-TC-ResubmitQuestionnaireForAppointment-2
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid2}  ${pdffile}
    Log  ${fudata}
...
JD-TC-ResubmitQuestionnaireForAppointment-UH1
    ...
    Should Be Equal As Strings   ${qnr_resp.json()['questionnaireId']}  ${qnrid}
    Should Be Equal As Strings  ${qnr_resp.json()['id']}   ${id}
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid6}  ${pdffile}
    Log  ${fudata}
    ${data}=  db.QuestionnaireAnswers   ${qnr_resp.json()}   ${self}   &{fudata}
    Log  ${data}
    ${resp}=  Consumer Validate Questionnaire  ${account_id}  ${data}
...
JD-TC-ResubmitQuestionnaireForAppointment-UH2
    ...
    Should Be Equal As Strings   ${qnr_resp.json()['questionnaireId']}  ${qnrid}
    Should Be Equal As Strings  ${qnr_resp.json()['id']}   ${id}
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid7}  ${pdffile}
    Log  ${fudata}
    ${data}=  db.QuestionnaireAnswers   ${qnr_resp.json()}   ${self}   &{fudata}
    Log  ${data}
...
JD-TC-ResubmitQuestionnaireForAppointment-UH3
    ...
    Should Be Equal As Strings   ${qnr_resp.json()['questionnaireId']}  ${qnrid}
    Should Be Equal As Strings  ${qnr_resp.json()['id']}   ${id}
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid8}  ${pdffile}
    Log  ${fudata}
    ${data}=  db.QuestionnaireAnswers   ${qnr_resp.json()}   ${self}   &{fudata}
    Log  ${data}
...
JD-TC-ResubmitQuestionnaireForAppointment-6
    ...
    ${fudata}=  db.fileUploadDT   ${qnr_resp.json()}  ${FileAction[0]}  ${Questionnaireid9}  ${mp4file}  ${mp3file}
    Log  ${fudata}
