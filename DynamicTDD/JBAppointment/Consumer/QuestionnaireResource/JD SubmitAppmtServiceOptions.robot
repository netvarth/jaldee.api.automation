...
${xlFile2}     ${EXECDIR}/TDD/ServiceoptionsQnrDisc.xlsx   
...
JD-TC-SubmitServiceOptionForAppointment-1
    ...
    clear_appt_schedule   ${PUSERNAME3}
...
JD-TC-SubmitServiceOptionForAppointment-2
    [Documentation]  Submit service option for appointment taken from provider side
...
JD-TC-SubmitServiceOptionForAppointment-3
    [Documentation]  Submit serviceoptions for appointment after starting appointment
...
JD-TC-SubmitServiceOptionForAppointment-4
    [Documentation]  Submit serviceoptions for appointment after completing appointment
...
JD-TC-SubmitServiceOptionForAppointment-UH1
    [Documentation]  Submit serviceoptions for appointment after canceling appointment
...
JD-TC-SubmitServiceOptionForAppointment-UH2
...
JD-TC-SubmitServiceOptionForAppointment-UH3
    [Documentation]  Submit serviceoptions without login

    ${resp}=  Imageupload.CApptSerOptUpload   ${empty}  ${account_id}   ${apptid1}   ${data}  ${pdffile}  ${jpgfile}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  419
    Should Be Equal As Strings  ${resp.json()}  ${SESSION_EXPIRED}

JD-TC-SubmitServiceOptionForAppointment-UH4
    [Documentation]  Submit serviceoptions with invalid Appointment id
    ...
    ${resp}=  Imageupload.CApptSerOptUpload   ${cookie}  ${account_id}   ${inv_appmt_id}   ${data}  ${pdffile}  ${jpgfile}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  422
    Should Be Equal As Strings  ${resp.json()}  ${INVALID_UID}
    

JD-TC-SubmitServiceOptionForAppointment-Category
    [Documentation]  Submit service options for appointment
    ...
    ${fudata}=  db.fileUploadDT   ${resp.json()}  ${FileAction[0]}  ${Questionnaireid5}  ${mp4file}  ${mp3file}
    Log  ${fudata}
