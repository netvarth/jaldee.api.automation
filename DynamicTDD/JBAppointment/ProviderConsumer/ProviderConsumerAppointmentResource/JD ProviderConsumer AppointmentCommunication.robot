...
# *** Comments ***
    ...
    Append To File  ${EXECDIR}/TDD/TDD_Logs/proconnum.txt  ${SUITE NAME} - ${TEST NAME} - ${consumerPhone3}${\n}
    ...
    Append To File  ${EXECDIR}/TDD/TDD_Logs/proconnum.txt  ${SUITE NAME} - ${TEST NAME} - ${consumerPhone4}${\n}
...
JD-TC-ConsumerAppointmentCommunication-3
    ...
    ${resp}=    Verify Otp For Login   ${consumerPhone3}   12  
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable   ${token}  ${resp.json()['token']}
...
JD-TC-ConsumerAppointmentCommunication-4
    ...
    ${resp}=    Verify Otp For Login   ${consumerPhone4}   12  
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable   ${token}  ${resp.json()['token']}
