...
JD-TC-PCTakeIndividualScheduleAppointment-3
    ...
    Should Be Equal As Strings  ${resp.json()['schedule']['id']}                                ${sch_id2}
    Should Be Equal As Strings  ${resp.json()['apptStatus']}                                    ${appt_status[1]}
    Should Be Equal As Strings  ${resp.json()['appmtFor'][1]['firstName']}                      ${fname}
    # Should Be Equal As Strings  ${resp.json()['appmtFor'][0]['lastName']}                       ${family_lname}
    Should Be Equal As Strings  ${resp.json()['appmtFor'][1]['apptTime']}                       ${slot4}
    Should Be Equal As Strings  ${resp.json()['appmtDate']}                                     ${DAY1}
...
JD-TC-PCTakeIndividualScheduleAppointment-18
...
JD-TC-PCTakeIndividualScheduleAppointment-19
...
JD-TC-PCTakeIndividualScheduleAppointment-20
...
JD-TC-PCTakeIndividualScheduleAppointment-21
...
JD-TC-PCTakeIndividualScheduleAppointment-UH14
...
JD-TC-PCTakeIndividualScheduleAppointment-25
