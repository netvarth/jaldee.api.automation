...
JD-TC-providerConsumerSignup-UH2
    ...
    ${resp}=    ProviderConsumer SignUp    ${empty}  ${lastName}  ${email}    ${primaryMobileNo}     ${accountId1}
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   422
...
JD-TC-providerConsumerSignup-UH3
    ...
    ${resp}=    ProviderConsumer SignUp    ${firstName}  ${empty}  ${email}    ${primaryMobileNo}     ${accountId1}
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   422
