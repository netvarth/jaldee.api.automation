...
JD-TC-DepartmentWiseAnalytics-3
    ...
    ${VirtualcallingMode2}=   Create Dictionary   callingMode=${CallingModes[1]}   value=${PUSERNAME_U2}   countryCode=${countryCodes[0]}  status=ACTIVE    instructions=${instructions2} 
