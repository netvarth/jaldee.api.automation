...
JD-TC-General Communication with User-1
    ...
    ${iscorp_subdomains}=  get_iscorp_subdomains  1
     ...
     ${PUSERNAME_E1}=  Evaluate  ${PUSERNAME}+695721796
...
JD-TC-General Communication with User-UH2
    ...
    ${resp}=  Imageupload.GeneralUserCommunicationWithProvider   ${cookie}   0000  ${u_id1}  ${msg2}  ${messageType[0]}  ${caption2}   ${EMPTY}  ${jpgfile}
    Log  ${resp.json()}
...
#     ${resp}=  General Communication with User   ${msg1}   ${p_id}  ${u_id1}
#     Log   ${resp.json()}
