...
JD-TC-GetAttachmentFromWLByConsumer-1
...
JD-TC-GetAttachmentFromWLByConsumer-UH1
    ...
    ${resp}=    Get Attachments In Waitlist By Consumer     ${inv}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200


JD-TC-GetAttachmentFromWLByConsumer-UH2
