...
JD-TC-Unread Count of Provider Communications-INDEPENDENT_SP-1
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME28}    ${account_id1}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token    ${CUSERNAME28}    ${account_id1}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    # clear_Consumermsg  ${CUSERNAME28}
    

    ${cookie}  ${resp}=    Imageupload.ProconLogin    ${CUSERNAME28}    ${account_id1}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-Unread Count of Provider Communications-INDEPENDENT_SP-4
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME29}    ${account_id1}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token    ${CUSERNAME29}    ${account_id1}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    # clear_Consumermsg  ${CUSERNAME28}
    

    ${cookie}  ${resp}=    Imageupload.ProconLogin    ${CUSERNAME29}    ${account_id1}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable    ${cid}    ${resp.json()['providerConsumer']}
    Set Test Variable    ${cR_id2}   ${resp.json()['id']} 
...
JD-TC-Unread Count of Provider Communications-BRANCH-5
    ...
    # Set Suite Variable  ${pR_id1}  ${resp.json()['id']}
    ${account_id2}=  get_acc_id  ${MUSERNAME_E1}
    Set Suite Variable  ${account_id2}
    ...
    # Log   ${resp.json()}
    # Should Be Equal As Strings  ${resp.status_code}  200  
    ${resp}=    Send Otp For Login    ${CUSERNAME28}    ${account_id2}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token    ${CUSERNAME28}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    # clear_Consumermsg  ${CUSERNAME28}
    

    ${cookie}  ${resp}=    Imageupload.ProconLogin    ${CUSERNAME28}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable    ${cid}    ${resp.json()['providerConsumer']}
    Set Test Variable    ${cR_id1}   ${resp.json()['id']} 
...
JD-TC-Unread Count of Provider Communications-BRANCH-6
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME30}    ${account_id2}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token    ${CUSERNAME30}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    # clear_Consumermsg  ${CUSERNAME28}
    

    ${cookie}  ${resp}=    Imageupload.ProconLogin    ${CUSERNAME30}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable    ${cid}    ${resp.json()['providerConsumer']}
    Set Test Variable    ${cR_id1}   ${resp.json()['id']} 
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME29}    ${account_id2}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token    ${CUSERNAME29}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    # clear_Consumermsg  ${CUSERNAME28}
    

    ${cookie}  ${resp}=    Imageupload.ProconLogin    ${CUSERNAME29}    ${account_id2}    ${token}
    Log   ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Test Variable    ${cid}    ${resp.json()['providerConsumer']}
    Set Test Variable    ${cR_id1}   ${resp.json()['id']} 
