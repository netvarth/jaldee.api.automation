...
JD-TC-IVR_Remove_Call_Back_Request-1
    ...
    ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME172}  ${countryCodes[1]}${PUSERNAME172}  ${user_id}  ${user_name}
...
#........  user answered    ........
    ...
    ${clid_user}=    Convert To String    ${countryCodes[1]}${PUSERNAME172}
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    IVR Request Call Back Token     ${ivr_uid}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['tokenRaised']}    ${bool[1]}

    ${resp}=    IVR Remove Call Back Request     ${ivr_uid}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()['tokenRaised']}    ${bool[0]}

JD-TC-IVR_Remove_Call_Back_Request-2
...
JD-TC-IVR_Remove_Call_Back_Request-3
...
JD-TC-IVR_Remove_Call_Back_Request-UH1
    ...
    ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME133}  ${countryCodes[1]}${PUSERNAME133}  ${user_id}  ${user_name}
...
#........  user answered    ........
    ...
    ${clid_user}=    Convert To String    ${countryCodes[1]}${PUSERNAME133}
...
JD-TC-IVR_Remove_Call_Back_Request-UH2

    [Documentation]   IVR Remove Call Back Request where uid is invalid
    ...
    ${resp}=    IVR Remove Call Back Request     ${inv}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings  ${resp.json()}    ${bool[0]}

JD-TC-IVR_Remove_Call_Back_Request-UH3

    [Documentation]   IVR Remove Call Back Request without login
...
JD-TC-IVR_Remove_Call_Back_Request-UH4

    [Documentation]   IVR Remove Call Back Request with another provider login
