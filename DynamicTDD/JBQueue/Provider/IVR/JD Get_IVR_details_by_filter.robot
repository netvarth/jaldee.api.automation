...
JD-TC-Get_IVR_Details_By_Filter-1
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${end}=    DateTime.Convert Date    ${end_tym}    result_format=%H:%M:%S       #result_format=%s
    ...
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}  200
    Should Be Equal As Strings    ${resp.json()[0]['callStatus']}      ${ivr_status[0]}
    Should Be Equal As Strings    ${resp.json()[0]['callCompleted']}    ${bool[1]}


JD-TC-Get_IVR_Details_By_Filter-2
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}  200
    Should Be Equal As Strings    ${resp.json()[1]['callStatus']}    ${ivr_status[0]}
    Should Be Equal As Strings    ${resp.json()[1]['callCompleted']}    ${bool[1]}
...
JD-TC-Get_IVR_Details_By_Filter-3
...
JD-TC-Get_IVR_Details_By_Filter-4
...
JD-TC-Get_IVR_Details_By_Filter-5
...
#........  user answered    ........
    ...
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}  200
    Should Be Equal As Strings    ${resp.json()[0]['callCompleted']}    ${bool[0]} 
...
JD-TC-Get_IVR_Details_By_Filter-UH1

    [Documentation]   Get IVR Count with another provider login
