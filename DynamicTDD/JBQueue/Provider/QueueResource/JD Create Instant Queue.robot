...
Jaldee-TC-CreateIQ-5
    ...
    # Set Suite Variable  ${address}
    ${latti}  ${longi}  ${postcode}  ${city}  ${district}  ${state}  ${address}=  get_loc_details
    ${p2tz}=   db.get_Timezone_by_lat_long   ${latti}  ${longi}
    Set Suite Variable  ${p2tz}
    Set Suite Variable  ${city}
    Set Suite Variable  ${latti}
    Set Suite Variable  ${longi}
    Set Suite Variable  ${postcode}
    ...
    Set Suite Variable  ${DAY1}  ${DAY1}
    ${stime}=  add_timezone_time  ${p2tz}  0  15  
    Set Suite Variable   ${stime}  ${stime}
    ${etime}=  add_timezone_time  ${p2tz}  0  30  
    Set Suite Variable   ${etime}  ${etime}
    ${parking}    Random Element     ${parkingType} 
    Set Suite Variable  ${parking}
    ${24hours}    Random Element    ['True','False']
...
Jaldee-TC-CreateIQ-7
    ...
    Set Suite Variable  ${postcode}
    Set Suite Variable  ${address}
    ${stime5}=  add_timezone_time  ${tz1}  2  45  
    Set Suite Variable   ${stime5}  ${stime5}
    ${etime5}=  add_timezone_time  ${tz1}    3  0
    ...
    # Set Suite Variable  ${address}
    ${latti1}  ${longi1}  ${postcode}  ${city}  ${district}  ${state}  ${address}=  get_loc_details
    ${tz2}=   db.get_Timezone_by_lat_long   ${latti1}  ${longi1}
    ...
    Set Suite Variable  ${postcode}
    Set Suite Variable  ${address}
    ${stime5}=  add_timezone_time  ${tz2}  2  45  
    Set Suite Variable   ${stime5}  ${stime5}
    ${etime5}=  add_timezone_time  ${tz2}    3  0
    Set Suite Variable   ${etime5}  ${etime5}
    ${parking}    Random Element     ${parkingType} 
    Set Suite Variable  ${parking}
    ${24hours}    Random Element    ['True','False']
    ...
    ${ri}=  Create List  @{EMPTY}
    ${stime3}=  add_timezone_time  ${tz1}  1  45  
    ${etime3}=  add_timezone_time  ${tz1}    2  0
    ${p1queue1}=    FakerLibrary.word
    Set Suite Variable  ${p1queue1}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
    ...
    ${stime3}=  add_timezone_time  ${tz2}  1  45  
    ${etime3}=  add_timezone_time  ${tz2}    2  0
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-9
    ...
    ${stime}=  add_timezone_time  ${p2tz}  0  15  
    Set Suite Variable   ${stime}  ${stime}
    ${etime1}=  add_timezone_time  ${p2tz}  1  0  
    Set Suite Variable   ${etime1}  ${etime1}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-10
    ...
    ${stime4}=  add_timezone_time  ${p2tz}  2  15  
    Set Suite Variable   ${stime4}
    ${etime4}=  add_timezone_time  ${p2tz}    2  30
...
Jaldee-TC-CreateIQ-11
    ...
    ${stime1}=  add_timezone_time  ${tz1}  0  45  
    Set Suite Variable   ${stime1}  ${stime1}
    ${etime1}=  add_timezone_time  ${tz1}  1  0  
    Set Suite Variable   ${etime1}  ${etime1}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-UH-1
    ...
    ${time_now}=  db.get_time_by_timezone  ${tz1}
    Log  ${time_now}
    ${ri}=  Create List  @{EMPTY}
...
Jaldee-TC-CreateIQ-12
    ...
    ${tz3}=   db.get_Timezone_by_lat_long   ${latti2}  ${longi2}
    ...
    Set Suite Variable  ${postcode}
    Set Suite Variable  ${address}
    ${stime4}=  add_timezone_time  ${tz3}  2  15  
    Set Suite Variable   ${stime4}
    ${etime4}=  add_timezone_time  ${tz3}    2  30
    Set Suite Variable   ${etime4}
    ${parking}    Random Element     ${parkingType} 
    Set Suite Variable  ${parking}
    ${24hours}    Random Element    ['True','False']
    ...
    ${ri}=  Create List  @{EMPTY}
    ${stime3}=  add_timezone_time  ${tz3}  1  45  
    ${etime3}=  add_timezone_time  ${tz3}    2  0
    ${p1queue1}=    FakerLibrary.word
    Set Suite Variable  ${p1queue1}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
    ...
    # Set Suite Variable  ${address}
    ${latti2}  ${longi2}  ${postcode}  ${city}  ${district}  ${state}  ${address}=  get_loc_details
    ${tz4}=   db.get_Timezone_by_lat_long   ${latti2}  ${longi2}
    Set Suite Variable  ${tz4}
    Set Suite Variable  ${city}
    Set Suite Variable  ${latti2}
    Set Suite Variable  ${longi2}
    Set Suite Variable  ${postcode}
    Set Suite Variable  ${address}
    ${stime5}=  add_timezone_time  ${tz4}  2  45  
    Set Suite Variable   ${stime5}  ${stime5}
    ${etime5}=  add_timezone_time  ${tz4}    3  0
    Set Suite Variable   ${etime5}  ${etime5}
    ${parking}    Random Element     ${parkingType} 
    Set Suite Variable  ${parking}
    ${24hours}    Random Element    ['True','False']
    ...
    ${p1queue2}=    FakerLibrary.word
    Set Suite Variable  ${p1queue2}
    ${DAY1}=  db.get_date_by_timezone  ${tz4}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-UH-4
    ...
    ${stime3}=  add_timezone_time  ${tz4}  1  45  
    Set Suite Variable   ${stime3}
    ${etime3}=  add_timezone_time  ${tz4}    2  0
    Set Suite Variable   ${etime3}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-UH-5
    ...
    ${stime1}=  add_timezone_time  ${tz4}  0  45  
    Set Suite Variable   ${stime1}  ${stime1}
    ${etime1}=  add_timezone_time  ${tz4}  1  0  
    Set Suite Variable   ${etime1}  ${etime1}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
...
Jaldee-TC-CreateIQ-UH-9
    ...
    ${stime5}=  add_timezone_time  ${p2tz}  2  45  
    Set Suite Variable   ${stime5}  ${stime5}
    ${etime5}=  add_timezone_time  ${p2tz}    3   0
    Set Suite Variable   ${etime5}  ${etime5}
    ${capacity}=  FakerLibrary.Numerify  %%%
    ${parallel}=  FakerLibrary.Numerify  %
