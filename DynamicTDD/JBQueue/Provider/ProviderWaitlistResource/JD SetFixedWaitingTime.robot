...
JD-TC-FixedWaitingTime-5
    ...
    ${strt_time1}=   add_time   0  11
    Set Suite Variable    ${strt_time1}
    ${end_time1}=    add_time   0  28 
...
JD-TC-FixedWaitingTime-6
      ...
      ${sTime}=  subtract_time  4  15
      Set Suite Variable   ${sTime}
      ${eTime}=  subtract_time  2  50
      ...
      ${strt_time2}=   subtract_time  2  40
      Set Suite Variable    ${strt_time2}
      ${end_time2}=    add_time  0  10 
...
JD-TC-FixedWaitingTime-UH4
    ...
    Append To File  ${EXECDIR}/TDD/numbers.txt  ${PUSERNAME30}${\n}
