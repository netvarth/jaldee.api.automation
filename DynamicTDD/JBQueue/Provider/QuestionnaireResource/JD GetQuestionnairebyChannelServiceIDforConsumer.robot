...
Check Questions
    ...
    FOR  ${i}  IN RANGE   ${qn len}
        ...
        Log  ${billableVal}
        ${string_billable_Val}  Convert To String  ${billableVal[0]}
        ${stripped_val}=  Strip String  ${string_billable_Val}
...
JD-TC-QuestionnaireByChannelServiceId-1
    [Documentation]  Get questionnaire by service id and channel for a consumer when channel is walkin
    ...
    &{dict}=  Create Dictionary   ${colnames[1]}=${QnrTransactionType[3]}   ${colnames[3]}=${QnrChannel[0]}  ${colnames[0]}=${qnrid}
    ${s_names}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[6]}  &{dict}  
    Log  ${s_names}
    ${u_snames}=    Remove Duplicates    ${s_names}
    Log  ${u_snames}
    ...
    ${s_len}=  Get Length  ${resp.json()}
    FOR  ${i}  IN RANGE   ${s_len}
        # ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' == '${u_snames[0]}'   Set Variable   ${resp.json()[${i}]['id']}
        ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' in @{u_snames} and '${resp.json()[${i}]['serviceType']}' != '${service_type[0]}'   Set Variable   ${resp.json()[${i}]['id']}
    ...
    # ${transactionTypeVal}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[5]}  &{dict}          
    # Log  ${transactionTypeVal}
    # ${ChannelVal}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[6]}  &{dict}  
    # Log  ${ChannelVal}
    # ${captureTimeVal}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[17]}  &{dict}  
    # Log  ${captureTimeVal}
...
JD-TC-QuestionnaireByChannelServiceId-2
    ...
    #   ${chnl}   Run Keyword If   '${resp.json()[${i}]['transactionType']}' == '${QnrTransactionType[3]}'   Set Variable  ${resp.json()[${i}]['channel']}
    ...
    &{dict}=  Create Dictionary   ${colnames[1]}=${QnrTransactionType[3]}   ${colnames[3]}=${QnrChannel[1]}  ${colnames[0]}=${qnrid}
    ${s_names}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[6]}  &{dict}  
    Log  ${s_names}
    ${u_snames}=    Remove Duplicates    ${s_names}
    Log  ${u_snames}
...
JD-TC-QuestionnaireByChannelServiceId-UH5
    ...
    &{dict}=  Create Dictionary   ${colnames[3]}=${QnrChannel[3]}   ${colnames[1]}=${QnrTransactionType[0]}     #${colnames[0]}=${qnrid}
    ${s_names}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[6]}  &{dict}  
    Log  ${s_names}
    ${u_snames}=    Remove Duplicates    ${s_names}
    Log  ${u_snames}
    ...
    FOR  ${i}  IN RANGE   ${s_len}
        # ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' == '${u_snames[0]}'   Set Variable   ${resp.json()[${i}]['id']}
        ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' in @{u_snames} and '${resp.json()[${i}]['serviceType']}' == '${service_type[2]}'   Set Variable   ${resp.json()[${i}]['id']}
        Exit For Loop If   '${s_id}' != '${None}'
    END

    ${cid}=  get_id  ${CUSERNAME1}

    ${resp}=  Get Consumer Questionnaire By Channel and ServiceID   ${s_id}   ${QnrChannel[3]}  ${cid}      
    Log  ${resp.content}
...
JD-TC-QuestionnaireByChannelServiceId-4
    [Documentation]  Get questionnaire by service id and channel for a consumer's family member.
    ...
    ${resp}=  AddFamilyMemberByProvider  ${cid}  ${mem_fname}  ${mem_lname}  ${dob}  ${gender}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Consumer Questionnaire By Channel and ServiceID   ${s_id}   ${QnrChannel[1]}  ${mem_id1}      
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # &{dict}=  Create Dictionary   ${colnames[0]}=${qnrid}
    # ${transactionTypeVal}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[5]}  &{dict}          
...
JD-TC-QuestionnaireByChannelServiceId-5
    ...
    ${CUSERPH1}=  Evaluate  ${CUSERNAME}+${randomval}
...
JD-TC-QuestionnaireByChannelServiceId-UH1
    ...
    FOR  ${i}  IN RANGE   ${s_len}
        # ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' != '${u_snames[0]}'   Set Variable   ${resp.json()[${i}]['id']}
        ${s_id}=  Run Keyword If   '${resp.json()[${i}]['name']}' not in @{u_snames} and '${resp.json()[${i}]['serviceType']}' != '${service_type[0]}'   Set Variable   ${resp.json()[${i}]['id']}
        Exit For Loop If   '${s_id}' != '${None}'
    END
...
JD-TC-QuestionnaireByChannelServiceId-UH3
    ...
    ${resp}=  Get Consumer Questionnaire By Channel and ServiceID   ${s_id}   ${QnrChannel[2]}  ${cid}      
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings   ${resp.json()}   {'id': 0}
    Should Be Equal As Strings   ${resp.json()}   ${id_zero}
...
JD-TC-QuestionnaireByChannelServiceId-UH4
    ...
    &{dict}=  Create Dictionary   ${colnames[1]}=${QnrTransactionType[3]}   #${colnames[6]}=${QnrChannel[1]}  ${colnames[0]}=${qnrid}
    ${s_names}=  getColumnValueByMultipleVals  ${sheet1}  ${colnames[6]}  &{dict}  
    Log  ${s_names}
    ${u_snames}=    Remove Duplicates    ${s_names}
    Log  ${u_snames}
