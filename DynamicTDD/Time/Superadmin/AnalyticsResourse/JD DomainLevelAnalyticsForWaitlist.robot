...
JD-TC-DomainLevelAnalytics-1
    [Documentation]   take checkins for normal service for a provider and check domain level analytics
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${tokenAnalyticsMetrics['WALK_IN_TOKEN']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${tokenAnalyticsMetrics['TOTAL_FOR_TOKEN']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${tokenAnalyticsMetrics['WEB_TOKENS']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-2
    [Documentation]   take checkins teleservice for a provider and check domain level analytics
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${tokenAnalyticsMetrics['TELE_SERVICE_TOKEN']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-3
    [Documentation]   take tokens for normal service and teleservice for a provider and check domain level analytics
...
JD-TC-DomainLevelAnalytics-4
    [Documentation]   take online checkins, for normal service and teleservice for a provider and check domain level analytics 
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['ONLINE_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['ARRIVED_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 

    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['CHECKED_IN_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-6
    [Documentation]   take checkins,for a provider and check account level analytics for waitlistactions(started,cancelled)
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['STARTED_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['CANCELLED_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-7
    [Documentation]   take checkins,for a provider and check account level analytics for waitlistactions(Done tokens)
    # [Setup]  Run Keywords  clear_queue  ${PUSERPH0}   AND  clear_service    ${PUSERPH0}  AND  clear_appt_schedule   ${PUSERPH0}
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['DONE_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-8
    [Documentation]     take checkins, for a provider from consumer side and check domain level analytics after reschedule it
    # [Setup]  Run Keywords  clear_queue  ${PUSERPH0}   AND  clear_service    ${PUSERPH0}  AND  clear_appt_schedule   ${PUSERPH0}
    ...
    ${resp}=  Get Domain Level Analytics  metricId=${tokenAnalyticsMetrics['RESCHEDULED_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
...
JD-TC-DomainLevelAnalytics-11
    [Documentation]    Place an order By Consumer for Home Delivery both provider and consumer side.and get domain analytics(online order,walkin order,recieved order)
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['ONLINE_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['WALK_IN_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['TOTAL_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['RECEIVED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
...
JD-TC-DomainLevelAnalytics-12
    [Documentation]    Place an order By Consumer for Home Delivery both provider and consumer side.and get domain analytics.(Aknowledged order,preapring,packing,confirmed)
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['ACKNOWLEDGED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['CONFIRMED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['PREPARING_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['PACKING_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
...
JD-TC-DomainLevelAnalytics-13
    ...
    [Documentation]    Place an order By Consumer for Home Delivery both provider and consumer side.and get domain analytics.(Payment required,ready for pickup,ready for shipment,Ready for delivery order)
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['PAYMENT_REQUIRED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['READY_FOR_PICKUP_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['READY_FOR_SHIPMENT_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['READY_FOR_DELIVERY_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
...
JD-TC-DomainLevelAnalytics-14
    
    [Documentation]    Place an order By Consumer for Home Delivery both provider and consumer side.and get domain analytics.(Intransit order,completed , shipped ,canceled order)
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['COMPLETED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['IN_TRANSIT_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['SHIPPED_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${orderAnalyticsMetrics['CANCEL_ORDER']}    domainId=${domain_id1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
...
JD-TC-DomainLevelAnalytics-15
    [Documentation]   take checkins, for a provider and check domain level analytics brand new customers
    ...
    ${resp}=  Create Sample Schedule   ${lid1}   ${s_id}   ${s_id1}   
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ...  ${resp.json()['apptSchedule']['timeSlots'][0]['eTime']}  3    3  ${lid1}  ${resp.json()['timeDuration']}  ${bool[1]}  ${s_id}   ${s_id1}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['NEW_CONSUMER_TOTAL']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    # Should Be Equal As Strings  ${resp.json()['frequency']}      DAILY
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['TOTAL_BRAND_NEW_TRANSACTIONS']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['WEB_NEW_CONSUMER_COUNT']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['ANDROID_NEW_CONSUMER_COUNT']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-16
    [Documentation]   take checkins,for a provider and check domain level analytics android through (keywords)
    ...
    ${resp}=  Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['IOS_NEW_CONSUMER_COUNT']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DomainLevelAnalytics-17
    [Documentation]   take checkins for a provider and check domain level analytics brand new customers ios through 
...
JD-TC-DomainLevelAnalytics-13
    ...
    ${PUSERNAME_N}=  Evaluate  ${PUSERNAME}+8067801112
    ${firstname}=  FakerLibrary.first_name
    ${lastname}=  FakerLibrary.last_name
    ${dob}=  FakerLibrary.Date
    ${gender}=  Random Element    ${Genderlist}
    ...
    # ${desc}=   FakerLibrary.word
    # ${resp}=  Add To Waitlist  ${cid}  ${s_id2}  ${q_id2}  ${DAY1}  ${desc}  ${bool[1]}  ${cid} 
    # Log  ${resp.content}
    # Should Be Equal As Strings  ${resp.status_code}  200
        
    # ${wid}=  Get Dictionary Values  ${resp.json()}
    # Set Test Variable  ${token_wid}  ${wid[0]}
    # ${tid}=  Get Dictionary Keys  ${resp.json()}
    # Set Suite Variable  ${token_id}  ${tid[0]}

    # ${resp}=  Get Waitlist By Id  ${token_wid}
    # Log  ${resp.json()} 
    # Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Android App Get Domain Level Analytics   metricId=${consumerAnalyticsMetrics['ANDROID_NEW_CONSUMER_COUNT']}    domainId=${domain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
