...
JD-TC-SubdomainLevelAnalytics-1
    [Documentation]   take appointments for normal service  and check subdomain level analytics
    ...
    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['WALK_IN_APPMT']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['WEB_APPMTS']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['CONFIRMED_APPMT']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['ARRIVED_APPMT']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['TELE_SERVICE_APPMT']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SubdomainLevelAnalytics-2
    ...
    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['WALK_IN_TOKEN']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Subdomain Level Analytics   metricId=${appointmentAnalyticsMetrics['TOTAL_APPMT']}    domainId=${domain_id}   subdomainId=${subdomain_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SubdomainLevelAnalytics-3
    [Documentation]   take appointments for normal service and virtual service  and check subdomain level analytics for online appointments
    ...
    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['ONLINE_APPMT']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SubdomainLevelAnalytics-4
    [Documentation]   take appointments for prepayment service and check subdomain level analytics 
    # [Setup]  Run Keywords  clear_queue  ${PUSERPH0}   AND  clear_appt_schedule   ${PUSERPH0}
    ...
    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['PRE_PAYMENT_COUNT']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['PRE_PAYMENT_TOTAL']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

JD-TC-SubdomainLevelAnalytics-5
    [Documentation]   take appointments for a provider and check subdomain level analytics for online appointments action change(arrived,started)
    ...
    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['STARTED_TOKEN']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    # ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['CHECKED_IN_TOKEN']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    # Log  ${resp.content}
    # Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-SubdomainLevelAnalytics-6
    [Documentation]   take  appointments for a provider and check subdomain level analytics for online appointments action changes(completed,cancelled)
    # [Setup]  Run Keywords  clear_queue  ${PUSERPH0}   AND  clear_service    ${PUSERPH0}  AND  clear_appt_schedule   ${PUSERPH0}
    ...
    FOR   ${a}  IN RANGE   ${len2}
        ...
        ${resp}=    Provider Cancel Appointment  ${appt_ids[${a}]}  ${reason}  ${msg}  ${DAY1}
        Log   ${resp.json()}
        Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['CANCELLED_APPMT']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  

    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['COMPLETETED_APPMT']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
...
JD-TC-SubdomainLevelAnalytics-7
    [Documentation]     take appointments for a provider from consumer side and check subdomain level analytics after reschedule it
    # [Setup]  Run Keywords  clear_queue  ${PUSERPH0}   AND  clear_service    ${PUSERPH0}  AND  clear_appt_schedule   ${PUSERPH0}
    ...
    ${resp}=  Get Subdomain Level Analytics  metricId=${appointmentAnalyticsMetrics['RESCHEDULED_APPMT']}  domainId=${domain_id}   subdomainId=${subdomain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 