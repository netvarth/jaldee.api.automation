...
JD-TC-DepartmentLevelAnalytics-1
    ...
    ${MUSERNAME_E}=  Evaluate  ${MUSERNAME}+8835650
    ...
    ${PUSERNAME_U1}=  Evaluate  ${PUSERNAME}+58736720
    ...
    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['WALK_IN_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    ...
    ${resp}=  Get Department Level Analytics   metricId=${appointmentAnalyticsMetrics['TOTAL_APPMT']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${appointmentAnalyticsMetrics['TOTAL_APPMT']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${walkin_appmt_len}
    ...
    ${resp}=  Get Department Level Analytics   metricId=${appointmentAnalyticsMetrics['WEB_APPMTS']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-2
    ...
    ${resp}=  Get Department Level Analytics   metricId=${appointmentAnalyticsMetrics['TELE_SERVICE_APPMT']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-3
    ...
    ${online_app_len3}=   Evaluate  len($online_appmts)+len($online_vertualids)
    Set Suite Variable   ${online_app_len3}
    ...
    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['ONLINE_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${appointmentAnalyticsMetrics['ONLINE_APPMT']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${online_app_len3}
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['dateFor']}   ${DAY1}

    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['ARRIVED_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['CONFIRMED_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-4
    [Documentation]   take appointments for normal service  and check dept level analytics for online appointments action change
    # [Setup]  Run Keywords  clear_queue  ${MUSERNAME_E}   AND  clear_appt_schedule   ${MUSERNAME_E}
    ...
    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['STARTED_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-5
    ...
    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['CANCELLED_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Department Level Analytics  metricId=${appointmentAnalyticsMetrics['COMPLETETED_APPMT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
