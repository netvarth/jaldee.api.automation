...
JD-TC-DepartmentLevelAnalytics-1
    [Documentation]   take checkins for normal service and teleservice for a provider and check department level analytics
     ...
     ${PUSERNAME_E}=  Evaluate  ${PUSERNAME}+814550
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['WALK_IN_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 

    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['TOTAL_FOR_TOKEN']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['WEB_TOKENS']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-2
    [Documentation]   take checkins for teleservice for a provider and check department level analytics
    ...
    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['WALK_IN_TOKEN']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['TOTAL_FOR_TOKEN']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${tokenAnalyticsMetrics['TOTAL_FOR_TOKEN']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${walkin_token_len1}
    ...
    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['WEB_TOKENS']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${tokenAnalyticsMetrics['WEB_TOKENS']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${walkin_token_len1}
    ...
    ${resp}=  Get Department Level Analytics   metricId=${tokenAnalyticsMetrics['TELE_SERVICE_TOKEN']}    userId=${u_id}   accId=${accid}   deptId=${dep_id}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-3
    [Documentation]   take online checkins, for a provider and check department level analytics 
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['ONLINE_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200  
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['ARRIVED_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 

    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['CHECKED_IN_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200

JD-TC-DepartmentLevelAnalytics-4
    ...
    ${resp}=  Get Department Level Analytics  metricId=${paymentAnalyticsMetrics['PRE_PAYMENT_COUNT']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Department Level Analytics  metricId=${paymentAnalyticsMetrics['PRE_PAYMENT_TOTAL']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${paymentAnalyticsMetrics['PRE_PAYMENT_COUNT']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   ${prepay_checkins}
...
JD-TC-DepartmentLevelAnalytics-5
    [Documentation]   take checkins,for a provider and check department level analytics for waitlist actions
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['STARTED_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['CANCELLED_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-6
    [Documentation]   take checkins,for a provider and check department level analytics for waitlistactions
    # [Setup]  Run Keywords  clear_queue  ${PUSERNAME_E}   AND  clear_service    ${PUSERNAME_E}  AND  clear_appt_schedule   ${PUSERNAME_E}
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['DONE_TOKEN']}  userId=${u_id}   accId=${accid}   deptId=${dep_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-DepartmentLevelAnalytics-7
    [Documentation]     take checkins, for a provider from consumer side and check department level analytics after reschedule it
    # [Setup]  Run Keywords  clear_queue  ${PUSERNAME_E}   AND  clear_service    ${PUSERNAME_E}  AND  clear_appt_schedule   ${PUSERNAME_E}
    ...
    ${resp}=  Get Department Level Analytics  metricId=${tokenAnalyticsMetrics['RESCHEDULED_TOKEN']}  domainId=${domain_id}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200 
...
JD-TC-DepartmentLevelAnalytics-8
    [Documentation]    signup  a consumer and take checkins for normal for a provider and check department level analytics for brand new customer
     ...
     ${firstname_A}=  FakerLibrary.first_name
     ${lastname_A}=  FakerLibrary.last_name
     ${PUSERNAME_F}=  Evaluate  ${PUSERNAME}+884153
     ${highest_package}=  get_highest_license_pkg
     ${resp}=  Account SignUp  ${firstname_A}  ${lastname_A}  ${None}  ${domains}  ${sub_domains}  ${PUSERNAME_E}    ${highest_package[0]}
     Log  ${resp.json()}
     Should Be Equal As Strings    ${resp.status_code}    200
     ...
     ${accid1}=   get_acc_id   ${PUSERNAME_F}
     Set Suite Variable  ${accid1} 
     ${DAY1}=  db.get_date_by_timezone  ${tz}
     Set Suite Variable  ${DAY1}  ${DAY1}
     ${list}=  Create List  1  2  3  4  5  6  7
     Set Suite Variable  ${list}  ${list}
     ${ph1}=  Evaluate  ${PUSERNAME_F}+1000000000
     ${ph2}=  Evaluate  ${PUSERNAME_F}+2000000000
     ${views}=  Random Element    ${Views}
     ${name1}=  FakerLibrary.name
     ${name2}=  FakerLibrary.name
     ${name3}=  FakerLibrary.name
     ...
     ${resp}=  Create User  ${firstname}  ${lastname}  ${dob}  ${Genderlist[0]}  ${P_Email}${PUSERNAME_U1}.${test_mail}   ${userType[0]}  ${pin}  ${countryCodes[0]}  ${PUSERNAME_U1}  ${dep_id1}  ${sub_domain_id}  ${bool[0]}  ${countryCodes[0]}  ${PUSERNAME_U1}  ${countryCodes[0]}  ${PUSERNAME_U1}  bProfilePermitted  ${boolean[1]}  displayOrder  1  userDisplayName  ${user_dis_name}  employeeId  ${employee_id}
     Log   ${resp.json()}
     Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=  Get Department Level Analytics  metricId=${consumerAnalyticsMetrics['NEW_CONSUMER_TOTAL']}  userId=${u_id1}   accId=${accid1}  dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Verify Response  ${resp}  frequency=DAILY   metricId=${consumerAnalyticsMetrics['NEW_CONSUMER_TOTAL']}  
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['value']}   1
    Run Keyword And Continue On Failure  Should Be Equal As Strings  ${resp.json()['metricValues'][0]['dateFor']}   ${DAY1}
  

    ${resp}=  Get Department Level Analytics   metricId=${consumerAnalyticsMetrics['TOTAL_BRAND_NEW_TRANSACTIONS']}    userId=${u_id1}   accId=${accid1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
   
    ${resp}=  Get Department Level Analytics   metricId=${consumerAnalyticsMetrics['WEB_NEW_CONSUMER_COUNT']}    userId=${u_id1}   accId=${accid1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
   

JD-TC-DepartmentLevelAnalytics-9
    [Documentation]   take checkins,  for a provider and check department level analytics brand new customers android through 
    ...
    ${resp}=  Get Department Level Analytics   metricId=${consumerAnalyticsMetrics['ANDROID_NEW_CONSUMER_COUNT']}    userId=${u_id1}   accId=${accid1}    dateFrom=${DAY1}  dateTo=${DAY1}  frequency=DAILY
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
