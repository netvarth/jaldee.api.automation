...
JD-TC-GetAppointmentHistoryCount-1
    ...
    ${resp}=  AddCustomer  ${CUSERNAME20}   firstName=${fname1}   lastName=${lname1}  countryCode=${countryCodes[1]}  
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME20}    ${accId}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token   ${CUSERNAME20}    ${accId}  ${token} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-GetAppointmentHistory-6
    ...
    [Documentation]    Get provider's appointments history in schedule ${sch_id}
...
JD-TC-GetAppointmentHistory-11
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME21}    ${accId}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token   ${CUSERNAME21}    ${accId}  ${token} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Suite Variable   ${cname1}   ${resp.json()['firstName']}
    Set Suite Variable   ${cname2}   ${resp.json()['lastName']}
...
JD-TC-GetAppointmentHistory-12
    ...
    ${fname1}=  FakerLibrary.first_name
    ${lname1}=  FakerLibrary.last_name
    ${resp}=  AddCustomer  ${CUSERNAME22}   firstName=${fname1}   lastName=${lname1}  countryCode=${countryCodes[1]}  
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable   ${cid}  ${resp.json()}
    ...
    ${resp}=    Send Otp For Login    ${CUSERNAME22}    ${accId}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    ...
    ${resp}=    ProviderConsumer Login with token   ${CUSERNAME22}    ${accId}  ${token} 
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
    Set Suite Variable   ${cname1}   ${resp.json()['firstName']}
    Set Suite Variable   ${cname2}   ${resp.json()['lastName']}
