...
#     clear_payment_invoice   ${PUSERNAME112}
#     [Documentation]  Provider apply a coupon after waitlist ,done payment and settil bill,create report then get reprt by invoice_id     
#     clear_queue  ${PUSERNAME112}  
#     clear_payment_invoice  ${PUSERNAME112}
#     clear_waitlist  ${PUSERNAME112}    
#     clear_payment_invoice  ${PUSERNAME112}    
...
#     Should Be Equal As Strings  ${resp.status_code}  200
#     Set Suite Variable  ${cid}  ${resp.json()[0]['id']}
#     ${resp}=  Add To Waitlist  ${cid}  ${s_id1}  ${qid1}  ${DAY1}  ${description}  ${bool[1]}  ${cid}
#     Should Be Equal As Strings  ${resp.status_code}  200
