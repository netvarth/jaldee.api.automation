...
JD-TC-GetConsumerOrderHistoryCount-1
    ...
    Set Suite Variable  ${email_id}  ${firstname}${PUSERNAME178}.ynwtest@netvarth.com
    ...
    ${firstname}=  FakerLibrary.first_name
    Set Suite Variable  ${email}  ${firstname}${CUSERNAME35}.ynwtest@netvarth.com
...
JD-TC-GetConsumerOrderHistoryCount-2
    ...
    ${item_quantity1}=  FakerLibrary.Random Int  min=${minQuantity}   max=${maxQuantity}
    ${firstname}=  FakerLibrary.first_name
    Set Test Variable  ${email}  ${firstname}${CUSERNAME35}.ynwtest@netvarth.com
