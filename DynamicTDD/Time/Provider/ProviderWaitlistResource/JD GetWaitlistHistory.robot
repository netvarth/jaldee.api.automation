...
JD-TC-GetWaitlistHistory-2
      ...
      Log   ${resp.json()}
      Should Be Equal As Strings  ${resp.status_code}  200
      ${resp}=  Get Provider Waitlist History  waitlistStatus-eq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      Log   ${resp.json()}
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
      ${resp}=  Get Provider Waitlist History  waitlistStatus-eq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
...
JD-TC-GetWaitlistHistory-3
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200
      ${resp}=  Get Provider Waitlist History  waitlistStatus-neq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-4
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  waitlistStatus-neq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-5
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-6
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-7
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
...
JD-TC-GetWaitlistHistory-8
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History   firstName-neq=${cname2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-9
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  service-eq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  4
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-10
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200
      ${resp}=  Get Provider Waitlist History  service-neq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
...
JD-TC-GetWaitlistHistory-11
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200      
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  waitlistStatus-eq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-12
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname1}  waitlistStatus-neq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  4
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-13
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  waitlistStatus-eq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1    
...
JD-TC-GetWaitlistHistory-14
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname2}  waitlistStatus-eq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
...
JD-TC-GetWaitlistHistory-15
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname2}  waitlistStatus-neq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id4}
...
JD-TC-GetWaitlistHistory-16
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname2}  waitlistStatus-eq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-17    
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  service-eq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-18
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname1}  service-neq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-19
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname2}  service-eq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id1}
...
JD-TC-GetWaitlistHistory-20
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname2}  service-neq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id4}
...
JD-TC-GetWaitlistHistory-21
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  service-eq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id4}
...
JD-TC-GetWaitlistHistory-22
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname1}  service-neq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-23
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname2}  service-eq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-24
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-neq=${cname2}  service-neq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-25
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  service-eq=${s_id1}  waitlistStatus-eq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-26
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200      
      ${resp}=  Get Provider Waitlist History  service-neq=${s_id1}  waitlistStatus-neq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-27
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  service-eq=${s_id1}  waitlistStatus-eq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-28
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  service-eq=${s_id2}  waitlistStatus-eq=${wl_status[1]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-29
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  service-eq=${s_id2}  waitlistStatus-eq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  0
...
JD-TC-GetWaitlistHistory-30
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200      
      ${resp}=  Get Provider Waitlist History  service-neq=${s_id2}  waitlistStatus-neq=${wl_status[4]}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-31
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  token-eq=${token_id}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
...
JD-TC-GetWaitlistHistory-32
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  token-neq=${token_id}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
...
JD-TC-GetWaitlistHistory-33
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  token-eq=${token_id}  service-eq=${s_id1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  token=${token_id}
...
JD-TC-GetWaitlistHistory-34
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  token-neq=${token_id}  service-neq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  3
...
JD-TC-GetWaitlistHistory-35
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  firstName-eq=${cname1}  date-eq=${DAY1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
...
JD-TC-GetWaitlistHistory-36
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  date-neq=${DAY1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  0
...
JD-TC-GetWaitlistHistory-37
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  date-eq=${DAY1}  service-neq=${s_id2}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  4
      Verify Response List  ${resp}  0  token=${token_id3}
...
JD-TC-GetWaitlistHistory-38
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  waitlistStatus-eq=${wl_status[4]}  date-eq=${DAY1}  from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  token=${token_id}
...
JD-TC-GetWaitlistHistory-39
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
...
JD-TC-GetWaitlistHistory-40
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-neq=${qid1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  0
...
JD-TC-GetWaitlistHistory-41
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  token-eq=${token_id}    from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  token=${token_id}
...
JD-TC-GetWaitlistHistory-42
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  token-neq=${token_id}    from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  5
      Verify Response List  ${resp}  0  token=${token_id5}
...
JD-TC-GetWaitlistHistory-43
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  firstName-eq=${cname2}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-44
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  service-eq=${s_id1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  4
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-45
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  waitlistStatus-eq=${wl_status[4]}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-46
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  queue-eq=${qid1}  date-eq=${DAY1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  6
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-47
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  6
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-48
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-neq=${lid}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  0
...
JD-TC-GetWaitlistHistory-49
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  token-eq=${token_id}    from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  token=${token_id}
...
JD-TC-GetWaitlistHistory-50
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  token-neq=${token_id}    from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  5
      Verify Response List  ${resp}  0  token=${token_id5}
...
JD-TC-GetWaitlistHistory-51
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  firstName-eq=${cname2}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  2
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-52
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  service-eq=${s_id1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  4
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id3}
...
JD-TC-GetWaitlistHistory-53
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  waitlistStatus-eq=${wl_status[4]}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  1
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id}
...
JD-TC-GetWaitlistHistory-54
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  date-eq=${DAY1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  6
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-55
      ...
      ${resp}=  Encrypted Provider Login  ${PUSERNAME24}  ${PASSWORD}
      Should Be Equal As Strings  ${resp.status_code}  200 
      ${resp}=  Get Provider Waitlist History  location-eq=${lid}  queue-eq=${qid1}   from=0  count=10
      Should Be Equal As Strings  ${resp.status_code}  200
      ${len}=  Get Length  ${resp.json()}
      Should Be Equal As Integers  ${len}  6
      Verify Response List  ${resp}  0  ynwUuid=h_${waitlist_id5}
...
JD-TC-GetWaitlistHistory-UH1
      ...
      Should Be Equal As Strings  ${resp.status_code}  200      
      ${resp}=  Get Provider Waitlist History  service-neq=${s_id2}  waitlistStatus-neq=${wl_status[1]}  from=0  count=10
