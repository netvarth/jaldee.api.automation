...
JD-TC-GetWaitlistByEncryptedIDHistory-1
...
JD-TC-GetWaitlistByEncryptedIDHistory-UH1

    [Documentation]   View Waitlist By Encoded Id
    ...
    ${resp}=   Get Waitlist By EncodedID    ${waitlist_id}
    Log   ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}   404
    Should Be Equal As Strings  "${resp.json()}"  "${INVALID_CHECKIN_ID}"

JD-TC-GetWaitlistByEncryptedIDHistory-UH2

    [Documentation]   View Waitlist By Encoded Id is Zero
