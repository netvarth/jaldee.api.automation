...
JD-TC-PartnerAddGeneralNotes-1
                                  
    [Documentation]            Partner Add General Notes
...
JD-TC-PartnerAddGeneralNotes-2
                                  
    [Documentation]            Partner Add General Notes -  with another   loan  uid
...
JD-TC-PartnerAddGeneralNotes-UH1
                                  
    [Documentation]            Partner Add General Notes  - empty note
    ...
    ${resp}=     Partner Add General Notes     ${loanuid}    ${empty}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_NOTE}

    
JD-TC-PartnerAddGeneralNotes-UH2
                                  
    [Documentation]            Partner Add General Notes - empty loan uid
    ...
    ${resp}=     Partner Add General Notes     ${empty}    ${note}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_LOAN_APPLICATION_ID}


JD-TC-PartnerAddGeneralNotes-UH3
                                  
    [Documentation]            Partner Add General Notes - invalid uid
    ...
    ${resp}=     Partner Add General Notes     35#@gvd    ${note}
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    422
    Should Be Equal As Strings    ${resp.json()}   ${INVALID_LOAN_APPLICATION_ID}


JD-TC-PartnerAddGeneralNotes-UH4
                                  
    [Documentation]            Partner Add General Notes - without login
...
JD-TC-PartnerAddGeneralNotes-UH5
                                  
    [Documentation]            Partner Add General Notes- consumer login
...
JD-TC-PartnerAddGeneralNotes-UH6
                                  
    [Documentation]            Partner Add General Notes -  with another provider login
