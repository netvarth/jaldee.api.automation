...
JD-TC-Partner Loan Application Approval Request-1
                                  
    [Documentation]             Partner Loan Application Approval Request
    ...
    ${resp}=    Partner Loan Application Approval   ${loanuid}   ${Schemeid} 
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
    ...
    ${partner}=       Create Dictionary    id=${partuid}  
    ...
    ${resp}=    Verify Partner loan Bank Details     ${loanuid}       ${montlyIncome}     ${invoiceAmount}   ${downpaymentAmount}    ${requestedAmount}       5       ${partner}     ${loanScheme}    ${loanProduct}    ${loanid}  ${LoanApplicationKycList}    
    Log  ${resp.content}
    Should Be Equal As Strings     ${resp.status_code}    200
...
JD-TC-Partner Loan Application Approval Request-UH1
                                  
    [Documentation]             Partner Loan Application Approval Request - without login
...
JD-TC-Partner Loan Application Approval Request-UH2
...
JD-TC-Partner Loan Application Approval Request-UH3
                                  
    [Documentation]             Partner Loan Application Approval Request - with consumer login
