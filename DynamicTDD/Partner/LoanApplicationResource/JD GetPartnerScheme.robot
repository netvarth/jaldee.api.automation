...
JD-TC-GetPartnerScheme-1
                                  
    [Documentation]              Get Partner Scheme
...
JD-TC-GetPartnerScheme-UH1
                                  
    [Documentation]               Get Partner Scheme with consumer login.
...
JD-TC-GetPartnerScheme-UH2
                                  
    [Documentation]               Get Partner Scheme without login.
...
JD-TC-GetPartnerScheme-UH3
                                  
    [Documentation]               Get Partner Scheme with  provider login login.
