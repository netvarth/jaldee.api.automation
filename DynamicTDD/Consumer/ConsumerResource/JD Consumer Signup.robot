...
JD-TC-Consumer Signup-5
    ...
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${resp}=  Consumer Set Credential  ${CUSERPH3_EMAIL}  ${PASSWORD}  1  countryCode=+${countryCode}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Consumer Signup-6
    ...
    # Should Be Equal As Strings  ${resp.json()}    ${INVALID_PHONE}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${resp}=  Consumer Activation  ${CUSERPH4_EMAIL1}  1
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${resp}=  Consumer Set Credential  ${CUSERPH4_EMAIL1}  ${PASSWORD}  1   countryCode=+${country_code1}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Consumer Signup-UH4
    ...
    # Log  ${resp.content}
    # Should Be Equal As Strings    ${resp.status_code}    200
    # ${resp}=  Consumer Set Credential  ${CUSERPH3}  ${PASSWORD}  1  countryCode=+${countryCode}
    # Log  ${resp.content}
    # Should Be Equal As Strings    ${resp.status_code}    200
    # ${resp}=  Consumer Login  ${CUSERPH3}  ${PASSWORD}  countryCode=+${countryCode}
    # Log  ${resp.content}
...
JD-TC-Consumer Signup-12
    ...
    ${resp}=  Consumer Set Credential  ${PUSERPH0}  ${PASSWORD}  1  
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Consumer Signup-13
    ...
    ${resp}=  Consumer Activation  ${PUSERPH1}  1
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200

    ${resp}=  Consumer Set Credential  ${PUSERPH1}  ${PASSWORD}  1  
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
