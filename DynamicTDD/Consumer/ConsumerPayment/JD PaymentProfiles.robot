...
JD-TC-paymentprofiles-1
    ...
    Set Suite Variable  ${sub_dom}  ${resp.json()['subSector']}
    ...
    ${emails1}=  Emails  ${name3}  Email  ${P_Email}${PUSERNAME155}.ynwtest@netvarth.com  ${views}
    ${bs}=  FakerLibrary.bs
...
JD-TC-paymentprofiles-1.2
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${totalamt}  ${purpose[0]}  ${cwid}  ${s_id}  ${bool[0]}   ${bool[1]}  ${cid1}   profileId=${proid}    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-paymentprofiles-1.3
    ...
    Should Be Equal As Strings  ${resp.json()[0]['amount']}  ${totalamt}
    Should Be Equal As Strings  ${resp.json()[0]['paymentOn']}  ${DAY}
    Should Be Equal As Strings  ${resp.json()[1]['amount']}  ${Tot1}
...
JD-TC-paymentprofiles-2.1
    ...
    clear_appt_schedule   ${PUSERNAME155}
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${min_pre}  ${purpose[0]}  ${apptid1}  ${s_id}  ${bool[0]}   ${bool[1]}  ${jdconID}   profileId=${proid}    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-paymentprofiles-3.1
    ...
    Set Test Variable  ${email_id}  ${firstname}${PUSERNAME155}.ynwtest@netvarth.com
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${advanceAmount}  ${purpose[0]}  ${orderid1}  ${EMPTY}  ${bool[0]}   ${bool[1]}  ${cid1}    profileId=customizedJBProfile    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-paymentprofiles-3.2
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${advanceAmount}  ${purpose[0]}  ${orderid1}  ${EMPTY}  ${bool[0]}   ${bool[1]}  ${jdconID}    profileId=customizedJBProfile    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable   ${mer}   ${resp.json()['merchantId']}  
    Set Suite Variable   ${payref}   ${resp.json()['paymentRefId']}
...
#  with convenienceFee
    ...
    delete_donation_service  ${PUSERNAME155}
    ...
    ${resp}=  Make payment Consumer Mock  ${acc_id}  ${don_amt}  ${purpose[5]}  ${don_id}  ${sid1}  ${bool[0]}   ${bool[1]}  ${con_id}    profileId=${proid}    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable   ${payref}   ${resp.json()['paymentRefId']}
...
JD-TC-paymentprofiles-P2
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${Tot1}  ${purpose[1]}  ${cwid}  ${s_id1}  ${bool[0]}   ${bool[1]}  ${cid1}    profileId=${proid}    paymentGateway=RAZORPAY    paymentSettingsId=1
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-paymentprofiles-P3.3
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${price1float}  ${purpose[1]}  ${orderid1}  ${EMPTY}  ${bool[0]}   ${bool[1]}  ${cid1}     profileId=${id}
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
    Set Suite Variable   ${mer}   ${resp.json()['merchantId']}  
    Set Suite Variable   ${payref}   ${resp.json()['paymentRefId']}
...
JD-TC-paymentprofiles-9
    ...
    ${resp}=  Make payment Consumer Mock  ${pid}  ${Total1}  ${purpose[1]}  ${cwid}  ${s_id}  ${bool[0]}   ${bool[1]}  ${con_id}   
    Log   ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
