...
JD-TC-Get Waiting time of queue-4
    ...
    ${eTime3}=  add_timezone_time  ${tz}  3  0  
...
JD-TC-Get Waiting time of queue-6
    ...
    ${sTime3}=  add_timezone_time  ${tz}  3  35  
    ${eTime3}=  add_timezone_time  ${tz}  4  0  
...
JD-TC-Get Waiting time of queue-7
    ...
    Set Suite Variable  ${DAY3}                                 
    ${sTime3}=  add_timezone_time  ${tz}  4  5  
    ${eTime3}=  add_timezone_time  ${tz}  5  30  
...
JD-TC-Get Waiting time of queue-8
    ...
    ${list}=  Create List  1  2  3  4  5  6  7
    ${sTime3}=  add_timezone_time  ${tz}  0  5  
...
Add Waitlist Saturday
    ...
    ${Date}=  db.add_timezone_date  ${tz}  ${d}  
    ${Date1}=  db.add_timezone_date  ${tz}  ${d+1}  
    ${Date2}=  db.add_timezone_date  ${tz}  7  
    ${Date3}=  db.add_timezone_date  ${tz}  8  
