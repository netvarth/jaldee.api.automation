...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Get Ivr By Uid    ${incall_uid}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......   call initiated by user to customer    ..........
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id}    ${incall_uid}    ${reference_id}    ${company_id}  ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[3]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${NONE}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
