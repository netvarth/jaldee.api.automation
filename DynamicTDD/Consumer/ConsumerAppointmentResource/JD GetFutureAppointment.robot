...
JD-TC-GetFutureAppointment-1
    ...
    ${resp}=  Provider Login  ${PUSERNAME_Q}  ${PASSWORD}
    Log  ${resp.json()}
    Should Be Equal As Strings    ${resp.status_code}    200
    ...
    ${emails1}=  Emails  ${name3}  Email  ${P_Email}${PUSERNAME_Q}.ynwtest@netvarth.com  ${views}
    ${bs}=  FakerLibrary.bs
    ${city}=   get_place
    ${latti}=  get_latitude
    ${longi}=  get_longitude
    ...
    Set Test Variable  ${email_id}  ${P_Email}${PUSERNAME_Q}.ynwtest@netvarth.com
