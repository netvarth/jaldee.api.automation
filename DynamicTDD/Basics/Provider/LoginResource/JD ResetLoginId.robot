...
JD-TC-Reset_LoginId-3
    ...
    ${decrypted_data}=  db.decrypt_data  ${resp.content}
    Log  ${decrypted_data}
    Set Suite Variable      ${id2}  ${decrypted_data['id']}
...
JD-TC-Reset_LoginId-6
    ...
    ${resp}=  Encrypted Provider Login  ${alph_digits}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Reset_LoginId-7
    ...
    ${resp}=  Encrypted Provider Login  ${withus}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Reset_LoginId-8
    ...
    ${resp}=  Encrypted Provider Login  ${withat}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Reset_LoginId-9
    ...
    ${resp}=  Encrypted Provider Login  ${withdot}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Reset_LoginId-UH10
    ...
    ${resp}=  Encrypted Provider Login  ${withatanuc}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
...
JD-TC-Reset_LoginId-UH11
    ...
    ${resp}=  Encrypted Provider Login  ${loginId_22}  ${PASSWORD}
    Log   ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}    200
    ${decrypted_data}=  db.decrypt_data  ${resp.content}
    Log  ${decrypted_data}
    Set Suite Variable      ${id22}  ${decrypted_data['id']}
    Set Suite Variable      ${userName}  ${decrypted_data['userName']}
