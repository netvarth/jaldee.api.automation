...
JD-TC-Get Customer count-1
    ...
    Log   ${resp.json()}
    Append To File  ${EXECDIR}/data/TDD_Logs/numbers.txt  ${phoneno}${\n}
    ...
    Log   ${resp.json()}
    Append To File  ${EXECDIR}/data/TDD_Logs/numbers.txt  ${phone}${\n}
    ${f_name}=   FakerLibrary.first_name
    ${l_name}=   FakerLibrary.last_name
    ${dob}=      FakerLibrary.date
    ...
    Log   ${resp.json()}
    Append To File  ${EXECDIR}/data/TDD_Logs/numbers.txt  ${phone3}${\n}
    ${l_name}=   FakerLibrary.last_name
    ${dob}=      FakerLibrary.date
    ...
    Log   ${resp.json()}
    Append To File  ${EXECDIR}/data/TDD_Logs/numbers.txt  ${phone2}${\n}
    ${f_name}=   FakerLibrary.first_name
    ${l_name}=   FakerLibrary.last_name
    ${dob}=      FakerLibrary.date
    ${phone}=    FakerLibrary.Random Int    min=1000000000   max=9999999999
