...
JD-TC-AddCustomer-18
     ...
     [Documentation]  Add a new valid customer with age, telegram number, whats app number
     ...
     ${cust18}=  Evaluate  ${PUSERNAME23}+73009
     ${cust182}=  Evaluate  ${PUSERNAME23}+73475
     ...
     ${resp}=  db.calculate_age_years_months      ${dob18}
     ...
     Should Be Equal As Strings    ${resp.json()[0]['age']['year']}                 ${year}
     Should Be Equal As Strings    ${resp.json()[0]['age']['month']}                ${month}
