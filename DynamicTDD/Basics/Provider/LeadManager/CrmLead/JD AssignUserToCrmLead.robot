...
JD-TC-Assign_User_To_Crm_Lead-1

    [Documentation]   Assign User To Crm Lead
    ...
    ${resp}=    Create Lead Consumer  ${firstName_n}  ${lastName_n}  phone=${CUSERNAME15}  countryCode=${countryCodes[0]}
    Log  ${resp.content}
    Should Be Equal As Strings  ${resp.status_code}  200
