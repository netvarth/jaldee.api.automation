...
JD-TC-AddSubServicesToAppt-3
    ...
    [Documentation]  add subservice to an appointment with sub service quantity as one.
...
JD-TC-AddSubServicesToAppt-UH5
    ...
    [Documentation]  add a users subservice to another users appointment
...
JD-TC-AddSubServicesToAppt-UH12
