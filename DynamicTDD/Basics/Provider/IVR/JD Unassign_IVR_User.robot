...
JD-TC-Unassign_IVR_User-1
    ...
    ${resp}=   Create Sample Service  ${ser_name1}    department=${dep_id}
    ...
    ${end_time}=    db.add_timezone_time  ${tz}  1  00 
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Unassign IVR User    ${ivr_uid}    ${userType[0]}    ${so_id1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
JD-TC-Unassign_IVR_User-UH1

    [Documentation]   Unassign IVR User without login
...
JD-TC-Update_User_Language-UH2
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Unassign IVR User    ${fake_id}    ${userType[0]}    ${so_id1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Unassign IVR User    ${ivr_uid}    ${userType[0]}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Unassign IVR User    ${ivr_uid}    ${userType[0]}    ${user_id}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
