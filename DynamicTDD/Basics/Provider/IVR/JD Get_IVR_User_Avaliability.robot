...
JD-TC-GET_All_IVR_USer_Avaliability-3
...
JD-TC-GET_All_IVR_USer_Avaliability-4
...
JD-TC-GET_All_IVR_USer_Avaliability-UH1
    ...
    [Documentation]   Get all IVR user availability with another provider login
...
JD-TC-GET_All_IVR_USer_Avaliability-UH2
    ...
    [Documentation]   Get all IVR user availability Without login
