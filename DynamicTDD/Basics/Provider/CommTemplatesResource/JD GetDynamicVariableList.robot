...
JD-TC-GetDynamicVariableList-1

    [Documentation]  Get Dynamic avriable list for a provider
...
JD-TC-GetDynamicVariableList-UH1

    [Documentation]  Get Dynamic avriable list without login.
...
JD-TC-GetDynamicVariableList-UH2

    [Documentation]  Get Dynamic avriable list with provider consumer login.
