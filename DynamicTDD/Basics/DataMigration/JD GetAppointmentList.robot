...
JD-TC-Get Appointment By Uid-1
    ...
    FOR   ${i}  IN RANGE   ${len}
        ...
        # Set Test Variable  ${Apptid${i}}    ${resp.json()[${i}]['uid']}
        ...
        Should Be Equal As Strings  ${resp.json()['migrationPatientId']}           ${Patient${i}}
        Should Be Equal As Strings  ${resp.json()['appointmentDate']}          ${date}
        Should Be Equal As Strings  ${resp.json()['notes']}                  ${Notes${i}}
