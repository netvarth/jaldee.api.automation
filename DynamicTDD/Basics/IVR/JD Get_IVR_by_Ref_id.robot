...
JD-TC-Get_IVR_By_Ref_Id-1

    [Documentation]   Get IVR By Referance Id
    ...
    ${acc_id}=  get_acc_id  ${HLPUSERNAME27}
    ...
    ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${HLPUSERNAME27}  ${countryCodes[1]}${HLPUSERNAME27}  ${user_id}  ${user_name}
...
#........  user answered    ........
    ...
    ${clid_user}=    Convert To String    ${countryCodes[1]}${HLPUSERNAME27}
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    Should Be Equal As Strings    ${resp.json()['callCompleted']}    ${bool[1]}

JD-TC-Get_IVR_By_Ref_Id-2

    [Documentation]   Get IVR By Referance Id Before After call
    ...
    ${myoperator_id}    FakerLibrary.Random Number
    ${incall_id}    FakerLibrary.Random Number
    ${incall_uid1}    FakerLibrary.Random Number
    Set Suite Variable    ${incall_uid1}
    ${reference_id}    FakerLibrary.Random Number
    ${company_id}    FakerLibrary.Random Number
    ${created_date}=  db.get_date_by_timezone  ${tz}
    ${call_time}=    db.get_tz_time_secs  ${tz}
...
# ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME5}  ${countryCodes[1]}${PUSERNAME5}  ${user_id}  ${user_name}

#.......   Incoming call on server    ..........

    ${resp}=    Incall IVR    ${acc_id}     ${incall_id}    ${incall_uid1}    ${reference_id}    ${company_id}  ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[1]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${NONE}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${resp}=    innode IVR    ${acc_id}     ${incall_uid1}    ${cons_verfy_node_value}    ${current_time}    ${clid}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200

#........  dialing users    .......

    ${resp}=    Incall IVR    ${acc_id}     ${incall_id}    ${incall_uid1}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[5]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${NONE}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#........  user answered    ........
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id}    ${incall_uid1}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[6]}    ${ivr_inputValue[1]}    ${empty}    ${user}    ${created_date}    ${call_time}    ${empty}    ${NONE}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
...
#.......  call finished      .........                                                                                                                                                                                                                                                                                                   
    ...
    ${resp}=    Incall IVR    ${acc_id}     ${incall_id}    ${incall_uid1}    ${reference_id}    ${company_id}    ${clid_row}   ${clid}    ${empty}    ${ivr_inputValue[2]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${created_date}    ${call_time}    ${empty}    ${NONE}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    ...
    ${in_uid}=  Convert To String  ${incall_uid1}
    ...
    ${resp}=    Get Ivr By reference id    ${incall_uid1}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200
    Should Be Equal As Strings    ${resp.json()['callStatus']}    ${ivr_status[5]}
    Should Be Equal As Strings    ${resp.json()['callCompleted']}    ${bool[0]}

    ${resp}=    Aftercall IVR    ${acc_id}    ${incall_id}    ${ivr_inputValue[1]}    ${comp_id}    ${clid_row}    ${caller_name}    ${clid}    ${countryCodes[0]}    ${loc}    ${start_time}    ${start_time}    ${start_time_in_milli_sec}    ${timestamp}    ${end_time}    ${difference}    ${dur_min}    ${ivr_inputValue[1]}    ${ivr_inputValue[1]}    ${file_name}    ${file_link}    ${ivr_inputValue[0]}    ${ivr_inputValue[1]}    ${empty}    ${empty}    ${pm}    ${empty}    ${call_log}    ${ivr_inputValue[0]}    ${empty}    ${empty}    ${empty}    ${empty}
    Log  ${resp.json()}
    Should Be Equal As Strings  ${resp.status_code}  200

JD-TC-Get_IVR_By_Ref_Id-3

    [Documentation]   Get IVR By Referance Id after incoming call on server
  ...
  #  ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME2}  ${countryCodes[1]}${PUSERNAME2}  ${user_id}  ${user_name}
...
JD-TC-Get_IVR_By_Ref_Id-4

    [Documentation]   Get IVR By Referance Id after dialling user
...
JD-TC-Get_IVR_By_Ref_Id-5

    [Documentation]   Get IVR By Referance Id after user answered the call
   ...
   # ${resp}=    ivr_user_details    ${acc_id}  ${countryCodes[1]}  ${myoperator_id}  ${PUSERNAME1}  ${countryCodes[1]}${PUSERNAME1}  ${user_id}  ${user_name}
...
JD-TC-Get_IVR_By_Ref_Id-UH1

    [Documentation]   Get IVR By Referance Id with another provider login
...
JD-TC-Get_IVR_By_Ref_Id-UH2

    [Documentation]   Get IVR By Referance Id without login
...
JD-TC-Get_IVR_By_Ref_Id-UH3

    [Documentation]   Get IVR By Referance Id with invalid uid
...
JD-TC-Get_IVR_By_Ref_Id-UH4
    ...
    [Documentation]   Get IVR By Referance Id where Ref id is empty
