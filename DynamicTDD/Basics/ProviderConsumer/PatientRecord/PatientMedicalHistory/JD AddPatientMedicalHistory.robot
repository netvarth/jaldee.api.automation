...
Add Patient Medical History
    ...
    ${resp}=    POST On Session    ynw    provider/mr/medicalHistory    data=${data}    expected_status=any
    [Return]  ${resp}
...
Update Patient Medical History
    ...
    Check And Create YNW Session
    ${data}=  json.dumps  ${data}
    ${resp}=    PUT On Session    ynw    provider/mr/medicalHistory/${medicalHistoryId}    data=${data}     expected_status=any
    [Return]  ${resp}

Delete Patient Medical History

    [Arguments]    ${medicalHistoryId}  
    ${resp}=    DELETE On Session    ynw   /provider/mr/medicalHistory/${medicalHistoryId}        expected_status=any
    [Return]  ${resp}

Get Patient Medical History

    [Arguments]    ${providerConsumerId}  
    ${resp}=    GET On Session    ynw    /provider/mr/medicalHistory/${providerConsumerId}        expected_status=any
    [Return]  ${resp}
