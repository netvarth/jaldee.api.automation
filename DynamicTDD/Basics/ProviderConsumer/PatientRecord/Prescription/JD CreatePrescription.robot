...
JD-TC-Create Prescription-2
    ...
    ${resp1}=  Get Prescription By Filter   providerConsumerId-eq=${cid}   dentalRecordId-eq=${id1}
    Log  ${resp1.content}
    Should Be Equal As Strings  ${resp1.status_code}  200
...
JD-TC-Create Prescription-3
    ...
    ${resp1}=  Get Prescription Count By Filter   providerConsumerId-eq=${cid}   uid-eq=${caseUId}
    Log  ${resp1.content}
    Should Be Equal As Strings  ${resp1.status_code}  200
