...
JD-TC-CreateTemplateConfig-1
    ...
    Should Be Equal As Strings    ${resp.json()[0]['printTemplateType']}   ${printTemplateType}
...
JD-TC-CreateTemplateConfig-2
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${templateHeader}   ${templateContent}   ${templateFooter}   ${printTemplateStatus}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   200
...
JD-TC-CreateTemplateConfig-UH2
    ...
    ${resp}=   Create Template Config   ${EMPTY}     ${bool[0]}      ${templateHeader}   ${templateContent}   ${templateFooter}   ${printTemplateStatus}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
...
JD-TC-CreateTemplateConfig-UH3
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${EMPTY}   ${templateContent}   ${templateFooter}   ${printTemplateStatus}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
...
JD-TC-CreateTemplateConfig-UH4
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${templateHeader}   ${EMPTY}   ${templateFooter}   ${printTemplateStatus}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
...
JD-TC-CreateTemplateConfig-UH5
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${templateHeader}   ${templateContent}   ${EMPTY}   ${printTemplateStatus}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
...
JD-TC-CreateTemplateConfig-UH6
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${templateHeader}   ${templateContent}   ${templateFooter}   ${EMPTY}  ${printTemplateType}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
    Should Be Equal As Strings    ${resp.json()}   ${TEMP_HEADER_REQUIRED}
...
JD-TC-CreateTemplateConfig-UH7
    ...
    ${resp}=   Create Template Config   ${templateName}     ${bool[0]}      ${templateHeader}   ${templateContent}   ${templateFooter}   ${printTemplateStatus}  ${EMPTY}
    Log  ${resp.content}
    Should Be Equal As Strings    ${resp.status_code}   422
    Should Be Equal As Strings    ${resp.json()}   ${TEMP_HEADER_REQUIRED}
